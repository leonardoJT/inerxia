...
DEFINE FRAME F_Restricciones
     ...
     Pro_Creditos.Pla_Maximo AT ROW 5.85 COL 38.43 COLON-ALIGNED
          ...
          SIZE 5.43 BY .81
          BGCOLOR 15 
     Sal_Minimo AT ROW 3.42 COL 74 COLON-ALIGNED NO-LABEL
     "El S.M.L.V a la Fecha es:" VIEW-AS TEXT
          SIZE 18 BY .62 AT ROW 3.42 COL 57
          BGCOLOR 18 FGCOLOR 15 FONT 4
     "y el valor de restricción se calculará automáticamente." VIEW-AS TEXT
          SIZE 40 BY .62 AT ROW 2.62 COL 48
          BGCOLOR 18 FGCOLOR 15 FONT 4
     "Entre el número de S.M.L.V en cada uno de los parámetros" VIEW-AS TEXT
          SIZE 40 BY .62 AT ROW 1.92 COL 48
          BGCOLOR 18 FGCOLOR 15 FONT 4
     RECT-283 AT ROW 5.31 COL 5
     RECT-284 AT ROW 1.65 COL 47
...
/* SETTINGS FOR FILL-IN Sal_Minimo IN FRAME F_Restricciones
   NO-ENABLE                                                            */
...
DO:
  /*SELF:SCREEN-VALUE = STRING(DECIMAL(SELF:SCREEN-VALUE) * W_SMLV).*/
  SELF:SCREEN-VALUE = STRING(ROUND(DECIMAL(SELF:SCREEN-VALUE) * W_SMLV,0)).  
END.
...
------------------------------------------------------------------------------*/
  ...
  IF AVAILABLE Pro_Creditos THEN 
    DISPLAY Pro_Creditos.Id_Montomaximo Pro_Creditos.Val_Montomaximo 
      ...
      WITH FRAME F_Restricciones IN WINDOW wWin.
  ENABLE RECT-283 RECT-284 Pro_Creditos.Id_Montomaximo 
         Pro_Creditos.Val_Montomaximo Pro_Creditos.Id_Montominimo 
         Pro_Creditos.Val_Montominimo Pro_Creditos.Id_Plazo 
         Pro_Creditos.Pla_Minimo Pro_Creditos.Pla_Maximo 
      WITH FRAME F_Restricciones IN WINDOW wWin.
...
DO WITH FRAME F_Creditos:
  VIEW FRAME F_Generales.
  RUN SUPER.
  Sal_Minimo:SCREEN-VALUE IN FRAME F_Restricciones = STRING(W_SMLV,">>,>>>,>>9").
