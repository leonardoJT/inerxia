...
DEFINE TEMP-TABLE TCode
    FIELD TCod AS CHARACTER FORMAT "X(12)"
    FIELD TNit AS CHARACTER FORMAT "X(12)"
    FIELD TCre AS INTEGER.

DEFINE INPUT PARAMETER WDoc AS CHARACTER FORMAT "X(40)".
DEFINE INPUT PARAMETER WNit AS CHARACTER FORMAT "X(12)".
