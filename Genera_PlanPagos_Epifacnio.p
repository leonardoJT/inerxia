...
MESSAGE "Inicio Proceso Generar PlanPagos..., Primero se Borran todos los PlanPagos." SKIP
  ...
  FOR EACH Creditos WHERE  estado = 2 :
      ...
      /* MESSAGE "Creditos.Fec_Desembolso" Creditos.Fec_Desembolso
          VIEW-AS ALERT-BOX INFO BUTTONS OK. */
      ...
      ASSIGN W_FecTra   = xfecini
        ...
        /* Asigna la fecha segun la periodicidad*/

      IF Creditos.Per_Pago EQ 1 THEN        /* semanal */
         ASSIGN W_DiaPdo = 7
                W_PdoLiq = 52.
      ELSE IF Creditos.Per_Pago EQ 2 THEN   /* Decadal 10 dias */
         ASSIGN W_DiaPdo = 10
                W_PdoLiq = 36.
      ELSE IF Creditos.Per_Pago EQ 3 THEN   /* Quincenal */
         ASSIGN W_DiaPdo = 15
                W_PdoLiq = 24.
...
MESSAGE "Generó PlanPagos: " TotReg
  ...
  PROCEDURE CrearPlan:
     ...
     ASSIGN PlanPagos.Agencia      = Creditos.Agencia          
            ...
            PlanPagos.Tasa         = Creditos.Sdo_Anuales[12]             
