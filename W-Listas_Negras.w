...
&Scoped-define FIELDS-IN-QUERY-F_Listas ListaNegra.Nit ListaNegra.Estado ~
ListaNegra.Nombre ListaNegra.Apellido1 ListaNegra.Apellido2 ~
ListaNegra.Fec_Actualizacion ListaNegra.Usuario ListaNegra.Id_HaVenido ~
ListaNegra.Fec_HaVenido ListaNegra.Observacion ListaNegra.Fec_Exclusion 
&Scoped-define ENABLED-FIELDS-IN-QUERY-F_Listas ListaNegra.Nit ~
ListaNegra.Nombre ListaNegra.Apellido1 ListaNegra.Apellido2 ~
ListaNegra.Observacion ListaNegra.Fec_Exclusion 
...
&Scoped-Define ENABLED-OBJECTS RECT-285 Cmb_Limportar BUTTON-129 ~
...
DEFINE VARIABLE cmbAgencias AS CHARACTER FORMAT "X(256)":U INITIAL "00 - Todas las agencias" 
     LABEL "Agencia" 
     VIEW-AS COMBO-BOX INNER-LINES 5
     LIST-ITEMS "00 - Todas las Agencias" 
     DROP-DOWN-LIST
     SIZE 41 BY 1
     BGCOLOR 15  NO-UNDO.
...
DEFINE FRAME F_Listas
     ...
     Cmb_Listas AT ROW 2.08 COL 27 COLON-ALIGNED
     ListaNegra.Nit AT ROW 3.42 COL 27 COLON-ALIGNED
          LABEL "Identificación"
          VIEW-AS FILL-IN 
          SIZE 13.43 BY .81
          BGCOLOR 15 
     ListaNegra.Estado AT ROW 3.42 COL 43 NO-LABEL
...
"Excepción", 3
          SIZE 45 BY .81
     ListaNegra.Nombre AT ROW 4.5 COL 27 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 59 BY .81
          BGCOLOR 15 
     ListaNegra.Apellido1 AT ROW 5.58 COL 27 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 59 BY .81
          BGCOLOR 15 
     ListaNegra.Apellido2 AT ROW 6.65 COL 27 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 59 BY .81
          BGCOLOR 15 
     BUTTON-1 AT ROW 1.54 COL 98
     BUTTON-2 AT ROW 3.15 COL 98
     BUTTON-3 AT ROW 4.77 COL 98
     BUTTON-4 AT ROW 7.19 COL 97
     ListaNegra.Fec_Actualizacion AT ROW 8.27 COL 27 COLON-ALIGNED
          LABEL "Fecha Actualización"
          VIEW-AS FILL-IN 
          SIZE 19 BY .81
          BGCOLOR 18 FGCOLOR 15 
     ListaNegra.Usuario AT ROW 9.35 COL 27 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 8 BY .81
          BGCOLOR 18 FGCOLOR 15 
     NomUsuario AT ROW 9.35 COL 35 COLON-ALIGNED NO-LABEL
     Btn_Salvar AT ROW 10.81 COL 98
     ListaNegra.Id_HaVenido AT ROW 10.42 COL 29
          LABEL "Vinculado."
          VIEW-AS TOGGLE-BOX
          SIZE 28 BY .77
     Btn_Deshacer AT ROW 12.42 COL 98
     ListaNegra.Fec_HaVenido AT ROW 11.23 COL 27 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 19 BY .81
          BGCOLOR 18 FGCOLOR 15 
     ListaNegra.Observacion AT ROW 12.31 COL 12 NO-LABEL
     ...
     ListaNegra.Fec_Exclusion AT ROW 8.27 COL 70 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 16 BY .81
          BGCOLOR 15 FGCOLOR 0 
     BUTTON-132 AT ROW 9.35 COL 97 WIDGET-ID 4
     "Suspendido hasta" VIEW-AS TEXT
          SIZE 17 BY .81 AT ROW 8.27 COL 55 WIDGET-ID 6
     IMAGE-1 AT ROW 3.69 COL 6
     RECT-1 AT ROW 1.27 COL 2
     RECT-2 AT ROW 3.42 COL 4
     RECT-270 AT ROW 10.54 COL 97
     RECT-3 AT ROW 1.27 COL 97
...
DEFINE FRAME F_Progreso
     BUTTON-155 AT ROW 1.27 COL 14
     BUTTON-156 AT ROW 2.62 COL 14
     BUTTON-157 AT ROW 5.58 COL 14
...
DEFINE FRAME F_Imprimir
     BUTTON-130 AT ROW 1.5 COL 54.29
     cmbAgencias AT ROW 1.73 COL 9.14 COLON-ALIGNED WIDGET-ID 4
     BUTTON-131 AT ROW 3.38 COL 54.29
     Cmb_IListas AT ROW 4.73 COL 16 COLON-ALIGNED
     FecIni AT ROW 7.19 COL 29 COLON-ALIGNED
     FecFin AT ROW 8.27 COL 29 COLON-ALIGNED
     " Entre el Rango de Fecha de ingreso a la lista" VIEW-AS TEXT
          SIZE 45 BY .65 AT ROW 6.42 COL 4
          FGCOLOR 7 
     " Seleccione la lista que va a imprimir" VIEW-AS TEXT
          SIZE 32 BY .77 AT ROW 3.65 COL 4
          FGCOLOR 7 
     " Seleccione la lista que va a imprimir" VIEW-AS TEXT
          SIZE 32 BY .77 AT ROW 1 COL 4 WIDGET-ID 8
          FGCOLOR 7 
     RECT-286 AT ROW 4.08 COL 2
     RECT-287 AT ROW 6.69 COL 2
     RECT-288 AT ROW 1.42 COL 2 WIDGET-ID 6
    WITH 1 DOWN KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 7 ROW 9.88
         SIZE 65 BY 10.77
...
ASSIGN FRAME F_Importar:FRAME = FRAME F_Listas:HANDLE
       ...
       FRAME F_Progreso:FRAME = FRAME F_Listas:HANDLE.
...
/* SETTINGS FOR FRAME F_Listas
   Custom                                                               */
/* SETTINGS FOR RADIO-SET ListaNegra.Estado IN FRAME F_Listas
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN ListaNegra.Fec_Actualizacion IN FRAME F_Listas
   NO-ENABLE EXP-LABEL                                                  */
/* SETTINGS FOR FILL-IN ListaNegra.Fec_HaVenido IN FRAME F_Listas
   NO-ENABLE                                                            */
/* SETTINGS FOR TOGGLE-BOX ListaNegra.Id_HaVenido IN FRAME F_Listas
   NO-ENABLE EXP-LABEL                                                  */
/* SETTINGS FOR FILL-IN ListaNegra.Nit IN FRAME F_Listas
   EXP-LABEL                                                            */
/* SETTINGS FOR FILL-IN NomUsuario IN FRAME F_Listas
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN ListaNegra.Usuario IN FRAME F_Listas
   NO-ENABLE                                                            */
    ...
    IF AVAILABLE listaNegra THEN DO:
        ...
        CREATE hoja_vida.
            ASSIGN hoja_vida.tipo = 17
                   ...
                   hoja_vida.fec_limite = DATE(ListaNegra.Fec_Exclusion:SCREEN-VALUE).
        END.
...
DO:
    DO WITH FRAME F_Listas:
        ...
        IF listaNegra.fec_exclusion:SCREEN-VALUE = "" THEN DO:
            MESSAGE "Debe ingresar la fecha en la cual finaliza" SKIP
                    "la suspensión!"
                VIEW-AS ALERT-BOX INFO BUTTONS OK.

            APPLY "entry" TO listaNegra.fec_exclusion.
        END.

        IF DATE(listaNegra.fec_exclusion:SCREEN-VALUE) <= DATE(listaNegra.fec_actualizacion:SCREEN-VALUE) THEN DO:
            MESSAGE "La fecha de fin de suspensión" SKIP
                    "debe  ser mayor a la fecha de" SKIP
                    "hoy. Corrija por favor!"
                VIEW-AS ALERT-BOX INFO BUTTONS OK.
...
/*  FOR EACH Taquilla WHERE 
           Taquilla.Fec_Transaccion       LE W_Fecha AND
           SUBSTRING(Taquilla.Cuenta,1,4) NE "1904"  AND
           SUBSTRING(Taquilla.Cuenta,1,4) NE "2705"
           BREAK BY Taquilla.Fec_Transaccion BY Taquilla.Nit:
           j = j + 1.
           RUN Progreso.

      IF FIRST-OF(Taquilla.Nit) THEN DO:
         FIND Varios WHERE Varios.Tipo EQ 6 AND Varios.Codigo EQ Taquilla.Cod_Segmento NO-LOCK NO-ERROR.
      END.
  END.*/
END.
...
ON CHOOSE OF BUTTON-157 IN FRAME F_Progreso /* Button 157 */
DO:
...
ON CHOOSE OF BUTTON-158 IN FRAME F_Listas /* Verificiación */
DO:
...
DO:
    ...
    RUN C-ListasNegras.r(OUTPUT vRowId).

    ASSIGN WWin:SENSITIVE = TRUE.
    WWin:MOVE-TO-TOP().

    FIND FIRST ListaNegra WHERE ROWID(listaNegra) = vRowId NO-ERROR.
    IF AVAILABLE ListaNegra THEN
...
DO WITH FRAME F_Listas:
    ASSIGN Cmb_Listas:SCREEN-VALUE = Cmb_Listas:ENTRY(1)
           ...
           ListaNegra.Id_HaVenido:SCREEN-VALUE = "NO"
           ListaNegra.Fec_HaVenido:SCREEN-VALUE = ""
           ListaNegra.Observacion:SCREEN-VALUE = ""
           ListaNegra.Usuario:SCREEN-VALUE = W_Usuario
           ListaNegra.Estado:SCREEN-VALUE = "1"
           listaNegra.fec_exclusion:SCREEN-VALUE = "".

    FIND FIRST Usuarios WHERE Usuarios.Usuario EQ W_Usuario NO-ERROR.
    IF AVAILABLE Usuarios THEN
        NomUsuario:SCREEN-VALUE = Usuarios.Nombre.
...
------------------------------------------------------------------------------*/
  ...
  {&OPEN-QUERY-F_Listas}
  GET FIRST F_Listas.
  DISPLAY Cmb_Listas NomUsuario 
      WITH FRAME F_Listas IN WINDOW wWin.
  IF AVAILABLE ListaNegra THEN 
    DISPLAY ListaNegra.Nit ListaNegra.Estado ListaNegra.Nombre 
          ListaNegra.Apellido1 ListaNegra.Apellido2 ListaNegra.Fec_Actualizacion 
          ListaNegra.Usuario ListaNegra.Id_HaVenido ListaNegra.Fec_HaVenido 
          ListaNegra.Observacion ListaNegra.Fec_Exclusion 
      WITH FRAME F_Listas IN WINDOW wWin.
  ENABLE BUTTON-158 Cmb_Listas ListaNegra.Nit ListaNegra.Nombre 
         ...
         BUTTON-4 Btn_Salvar Btn_Deshacer ListaNegra.Observacion Btn_ingresar 
         Btn_Borrar Btn_Cancelar Btn_Salir BUTTON-56 ListaNegra.Fec_Exclusion 
         BUTTON-132 IMAGE-1 RECT-1 RECT-2 RECT-270 RECT-3 
      WITH FRAME F_Listas IN WINDOW wWin.
  {&OPEN-BROWSERS-IN-QUERY-F_Listas}
  DISPLAY cmbAgencias Cmb_IListas FecIni FecFin 
      WITH FRAME F_Imprimir IN WINDOW wWin.
  ENABLE RECT-286 RECT-287 RECT-288 BUTTON-130 cmbAgencias BUTTON-131 
         Cmb_IListas FecIni FecFin 
      WITH FRAME F_Imprimir IN WINDOW wWin.
  {&OPEN-BROWSERS-IN-QUERY-F_Imprimir}
  ENABLE IMAGE-2 R1 R2 R3 R4 R5 R6 R7 R8 R9 BUTTON-155 BUTTON-156 BUTTON-157 
  ...
  ENABLE RECT-285 Cmb_Limportar BUTTON-129 Btn_Archivo Archivo BUTTON-127 
      WITH FRAME F_Importar IN WINDOW wWin.
...
DO WITH FRAME F_Imprimir:
    ASSIGN FecIni:SCREEN-VALUE = STRING(ADD-INTERVAL(w_fecha,-5,"years"),"99/99/9999")
           FecFin:SCREEN-VALUE = STRING(w_fecha,"99/99/9999").
END.
...
DO WITH FRAME F_Listas:
    ...
    ASSIGN ListaNegra.Nit:SCREEN-VALUE = ListaNegra.Nit
           ...
           ListaNegra.Usuario:SCREEN-VALUE = ListaNegra.Usuario
           ListaNegra.Id_HaVenido:SCREEN-VALUE = STRING(ListaNegra.Id_HaVenido)
           ListaNegra.Fec_HaVenido:SCREEN-VALUE = STRING(Fec_HaVenido)
           ListaNegra.Observacion:SCREEN-VALUE = ListaNegra.Observacion
           ListaNegra.Fec_Exclusion:SCREEN-VALUE = STRING(ListaNegra.Fec_Exclusion)
           listaNegra.estado:SCREEN-VALUE = STRING(listaNegra.estado).
        
    listaNegra.estado:SENSITIVE = TRUE.

    FIND FIRST Usuarios WHERE Usuarios.Usuario EQ ListaNegra.Usuario NO-LOCK NO-ERROR.
    IF AVAILABLE Usuarios THEN
        NomUsuario:SCREEN-VALUE = Usuarios.Nombre.
    ELSE
        NomUsuario:SCREEN-VALUE = "No Existe el usuario".
END.
...
DO WITH FRAME F_Listas:
    /*FIND FIRST listaNegra WHERE listaNegra.nit = listaNegra.nit:SCREEN-VALUE
                            AND ListaNegra.Fec_Actualizacion = DATE(ListaNegra.Fec_Actualizacion:SCREEN-VALUE)
                            AND ListaNegra.Fec_Exclusion = DATE(ListaNegra.Fec_Exclusion:SCREEN-VALUE)
                            AND ListaNegra.Codigo = INTEGER(SUBSTRING(Cmb_Listas:SCREEN-VALUE,1,5))
                            AND listaNegra.usuario = listaNegra.usuario:SCREEN-VALUE NO-ERROR.*/
    FIND FIRST listaNegra WHERE ROWID(listaNegra) = vRowId NO-ERROR.
    IF NOT AVAILABLE listaNegra THEN
        CREATE ListaNegra.

    listaNegra.estado = INTEGER(listaNegra.estado:SCREEN-VALUE).
    ...
    ASSIGN ListaNegra.Codigo = INTEGER(SUBSTRING(Cmb_Listas:SCREEN-VALUE,1,5))
           ...
           ListaNegra.Usuario = W_Usuario
           ListaNegra.Fec_Exclusion = DATE(ListaNegra.Fec_Exclusion:SCREEN-VALUE)
           ListaNegra.observacion = listaNegra.observacion:SCREEN-VALUE.
        
    listaNegra.estado:SENSITIVE = FALSE.
    ...
    IF INTEGER(SUBSTRING(Cmb_Listas:SCREEN-VALUE,1,5)) = 4 THEN DO:
        FIND FIRST hoja_vida WHERE hoja_vida.nit = ListaNegra.Nit:SCREEN-VALUE
                               ...
                               AND hoja_vida.fec_grabacion = w_fecha
                               AND hoja_vida.fec_limite = DATE(ListaNegra.Fec_Exclusion:SCREEN-VALUE) NO-LOCK NO-ERROR.
