...
RUN VALUE("p-1001_5005_Arrendamientos_" + STRING(wAno) + ".r") (INPUT 'C',
                                                                INPUT clientes.nit,
                                                                INPUT 0,
                                                                OUTPUT TCer.Bas,
                                                                OUTPUT TCer.Ret).
...
RUN VALUE("p-1001_5003_Comisiones_" + STRING(wAno) + ".r") (INPUT 'C',
                                                            INPUT clientes.nit,
                                                            INPUT 0,
                                                            OUTPUT TCer.Bas,
                                                            OUTPUT TCer.Ret).
...
RUN VALUE("p-1001_5002_Honorarios_" + STRING(wAno) + ".r") (INPUT 'C',
                                                            INPUT clientes.nit,
                                                            INPUT 0,
                                                            OUTPUT TCer.Bas,
                                                            OUTPUT TCer.Ret).
...
RUN VALUE("p-1001_5001_Salarios_" + STRING(wAno) + ".r") (INPUT 'C',
                                                                INPUT clientes.nit,
                                                                INPUT 0,
                                                                OUTPUT TCer.Bas,
                                                                OUTPUT TCer.Ret).
