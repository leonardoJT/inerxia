...
&Scoped-Define ENABLED-FIELDS RowObject.Descrip_PQR 
...
RowObject.Descrip_PQR RowObject.Descrip_Resp 
...
DEFINE FRAME F-Pqr
     RowObject.Nit AT ROW 1.46 COL 61.43 COLON-ALIGNED WIDGET-ID 42
          ...
          SIZE 19.57 BY .92
          BGCOLOR 18 FGCOLOR 15 
     nom_cliente AT ROW 2.54 COL 31 COLON-ALIGNED WIDGET-ID 4
     ...
     RowObject.Clase_Producto AT ROW 4.88 COL 81 COLON-ALIGNED NO-LABEL WIDGET-ID 8
          VIEW-AS FILL-IN 
          SIZE 2.57 BY 1
     ...
     RowObject.Tip_Credito AT ROW 4.88 COL 84 COLON-ALIGNED NO-LABEL WIDGET-ID 92
          VIEW-AS FILL-IN 
          SIZE 2.57 BY 1
     RowObject.Cod_Producto AT ROW 4.88 COL 76 COLON-ALIGNED NO-LABEL WIDGET-ID 90
          VIEW-AS FILL-IN 
          SIZE 4.43 BY 1
     RowObject.Cod_Proceso AT ROW 7.04 COL 22 COLON-ALIGNED HELP
     ...
     RowObject.Descrip_PQR AT ROW 13.08 COL 4 HELP
...
DEFINE FRAME F-Pqr
     ...
     "Descripcion PQR" VIEW-AS TEXT
          SIZE 21 BY .92 TOOLTIP "Descripcion" AT ROW 12.12 COL 4.57 WIDGET-ID 80
...
DO:
  ...
  DO WITH FRAME {&FRAME-NAME}:
    ...
    /*en l tabla varios 01 es captacion y el 2 es colocacion */
   IF RowObject.Cod_Proceso:SCREEN-VALUE = STRING(1,'99999') /*OR */  THEN DO:
    ...
    END.
    ELSE 
    IF RowObject.Cod_Proceso:SCREEN-VALUE = STRING(2,'99999') /*OR */  THEN DO:
    ...
    END.
    ELSE DO:
        IF RowObject.Cod_Proceso:SCREEN-VALUE = STRING(4,'99999') /*OR */  THEN DO:
           FOR EACH pro_Creditos NO-LOCK:
             W_Ok = Cmb_Producto:ADD-LAST(STRING(Pro_Creditos.Cod_Credito,"999") + " - " + Pro_Creditos.Nom_Producto).
             ASSIGN RowObject.Clase_Producto:SCREEN-VALUE = STRING(2). 
           END.
