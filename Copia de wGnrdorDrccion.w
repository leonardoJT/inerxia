...
&Scoped-Define ENABLED-OBJECTS btnAprtdo btnCrcnvlar btnExtrior btnLte ~
btnOriente btnPso btnSlon btnStno btnZnaFrnca RECT-306 RECT-307 RECT-308 ~
RECT-309 btnAlmcen cDrccion BUTTON-BLANCO BUTTON-rtrcso BUTTON-RETURN ~
BUTTON-limpiar BUTTONCE cTxtoABrrar btnAltllo btnBlvar btncal btnCrclar ~
...
------------------------------------------------------------------------------*/
  ...
  ENABLE btnAprtdo btnCrcnvlar btnExtrior btnLte btnOriente btnPso btnSlon 
         btnStno btnZnaFrnca RECT-306 RECT-307 RECT-308 RECT-309 btnAlmcen 
         cDrccion BUTTON-BLANCO BUTTON-rtrcso BUTTON-RETURN BUTTON-limpiar 
         BUTTONCE cTxtoABrrar btnAltllo btnBlvar btncal btnCrclar btnCrrgmiento 
         btnPseo btnSlar btnTrrza btnVrda btnAgrpcion btnCnjntoRsdncial btnGrge 
         btnAdmnstrcion btnAgncia btnAutpsta btnCiuddla btnCrrra btnCrrtra 
         btnDpstoStno btnEste btnFnca btnMncpio btnMnzna btnNrte btnOeste 
         btnPlnta btnPrque btnPrqueadro btnPrtria btnSctor btnTrmnal 
         btnVariante btnAvndaCrrra btnBdga btnBis btnBlque btnClla btnCmno 
         btnCnjnto btnCnsltrio btnCntroCmrcial btnCsa btnDprtmnto btnDpsto 
         btnEntrda btnEsquina btnEtpa btnIntrior btnKlmtro btnOccidnte btnOfcna 
         btnPenthouse btnPrcla btnPrdio btnPsje btnPuente btnPuesto 
         btnSlonCmnal btnSmsctor btnSperMnzna btnSuite btnTrre btnUndad 
         btnUnidadRsdncial btnUrbnzcion btnZna btna btnCero btnCinco btnCuatro 
         btnDos btnG btnGuion btnH btnI btnJ btnK btnL btnM btnN btnNmral 
         btnNueve btnO btnOcho btnP btnQ btnR btnS btnSeis btnSiete btnT 
         btnTres btnU btnUno btnV btnW btnX btnY btnZ btnAprtmnto btnAvnda btnb 
         btnc btnClle btnd btnDiagnal btnE btnEdfcio btnF btnSur btnTrnsvrsal 
      WITH FRAME fMain IN WINDOW wWin.
