...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.Fecha ~
rowObject.FValConsignacion rowObject.FValRetiro rowObject.Descrip 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      rowObject.Descrip FORMAT "X(40)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-AUTO-VALIDATE NO-ROW-MARKERS SEPARATORS SIZE 66 BY 6.65
         TITLE "MOVIMIENTOS DE AHORROS" ROW-HEIGHT-CHARS .62 FIT-LAST-COLUMN.
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   = _<SDO>.rowObject.Fecha
     _FldNameList[2]   = _<SDO>.rowObject.FValConsignacion
     _FldNameList[3]   = _<SDO>.rowObject.FValRetiro
     _FldNameList[4]   = _<SDO>.rowObject.Descrip
...
ON CTRL-END OF br_table IN FRAME F-Main /* MOVIMIENTOS DE AHORROS */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br_table bTableWin
ON CTRL-HOME OF br_table IN FRAME F-Main /* MOVIMIENTOS DE AHORROS */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br_table bTableWin
ON DEFAULT-ACTION OF br_table IN FRAME F-Main /* MOVIMIENTOS DE AHORROS */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br_table bTableWin
ON END OF br_table IN FRAME F-Main /* MOVIMIENTOS DE AHORROS */
DO:
  {src/adm2/brsend.i}
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br_table bTableWin
ON HOME OF br_table IN FRAME F-Main /* MOVIMIENTOS DE AHORROS */
DO:
  {src/adm2/brshome.i}
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br_table bTableWin
ON OFF-END OF br_table IN FRAME F-Main /* MOVIMIENTOS DE AHORROS */
DO:
  {src/adm2/brsoffnd.i}
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br_table bTableWin
ON OFF-HOME OF br_table IN FRAME F-Main /* MOVIMIENTOS DE AHORROS */
DO:
  {src/adm2/brsoffhm.i}
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br_table bTableWin
ON ROW-ENTRY OF br_table IN FRAME F-Main /* MOVIMIENTOS DE AHORROS */
DO:
  {src/adm2/brsentry.i}
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br_table bTableWin
ON ROW-LEAVE OF br_table IN FRAME F-Main /* MOVIMIENTOS DE AHORROS */
DO:
  {src/adm2/brsleave.i}
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br_table bTableWin
ON SCROLL-NOTIFY OF br_table IN FRAME F-Main /* MOVIMIENTOS DE AHORROS */
DO:
  {src/adm2/brsscrol.i}
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br_table bTableWin
ON VALUE-CHANGED OF br_table IN FRAME F-Main /* MOVIMIENTOS DE AHORROS */
DO:
  {src/adm2/brschnge.i}
END.
...
------------------------------------------------------------------------------*/
  ...
  APPLY "MOUSE-SELECT-CLICK":U TO BROWSE br_table.  
