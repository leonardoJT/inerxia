...
OUTPUT TO C:\InfRed\CredEmp11_AntUti.Txt.

DISPLAY "        COOP.BELEN  -  CREDITOS EMPRESA 11" SKIP
        "REINICIADOS A QNAL, Fecha : " + STRING(TODAY,"99/99/9999") FORMAT "X(50)".

DO TRANSACTION ON ERROR UNDO: 

FOR EACH Clientes WHERE Cod_Empresa EQ 11 NO-LOCK BY Clientes.Nit:
