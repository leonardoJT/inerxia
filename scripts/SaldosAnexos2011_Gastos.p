...
OUTPUT TO c:\INFO_Fodun\Leonardo\Gastos2011_Corregido.csv.

FOR EACH anexos13 WHERE (SUBSTRING(anexos13.Cuenta,1,1) = "5" OR
                         SUBSTRING(anexos13.Cuenta,1,1) = "6" OR
                         SUBSTRING(anexos13.Cuenta,1,2) = "13" OR
                         SUBSTRING(anexos13.Cuenta,1,2) = "17" OR
                         SUBSTRING(anexos13.Cuenta,1,2) = "26")
