...
DEFINE VAR vCuenta AS CHARACTER INITIAL "61752001".

FOR EACH sal_cuenta13 WHERE ano = vYear AND cuenta = vCuenta NO-LOCK:
...
OUTPUT TO VALUE("d:\Leonardo\saldos_" + vCuenta + "_" + string(vYear) + ".csv").
EXPORT DELIMITER ";"
    v6.
OUTPUT CLOSE.
