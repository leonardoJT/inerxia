...
fechaDes = creditos.fec_desembolso.
...
IF creditos.sdo_proyectado > creditos.sdo_capital THEN
    creditos.fec_pago = 11/05/2011.
...
PROCEDURE CambiarFecha:
    RUN Halla_FecVcto.R (INPUT /*W_FecIni*/ creditos.fec_pagAnti,
                         W_NroDias,
                         W_FecTra,
                         OUTPUT W_FecTra).
