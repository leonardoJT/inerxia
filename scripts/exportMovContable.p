DEFINE TEMP-TABLE tt
    ...
    FIELD db AS DECIMAL
    FIELD cr AS DECIMAL
    INDEX idx agencia fecha cuenta cliente_id.
...
FOR EACH agencias NO-LOCK:
    FOR EACH mov_contable WHERE mov_contable.agencia = agencias.agencia
                            ...
                            AND mov_contable.fec_contable <= 10/31/2018
        ...
        FIND FIRST tt WHERE tt.agencia = mov_contable.agencia
                        AND tt.fecha = mov_contable.fec_contable
        ...
        IF NOT AVAILABLE tt THEN DO:
            ...
            tt.fecha = mov_contable.fec_contable.
...
OUTPUT TO d:\Leonardo\movs456.csv.
EXPORT DELIMITER ";" "AGENCIA" "FECHA" "CUENTA" "CLIENTE_ID" "DB" "CR".
