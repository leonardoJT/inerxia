DEFINE VARIABLE vSmtpServer AS CHARACTER NO-UNDO 
                               FORMAT "X(50)"
                               LABEL "Smtp Server" 
                               /*INITIAL "smtp.mandrillapp.com".*/
                               INITIAL "127.0.0.1".
 
DEFINE VARIABLE vTo         AS CHARACTER NO-UNDO
                               FORMAT "X(50)"
                               LABEL "To" 
                               INITIAL "leonardo_ie@hotmail.com".
 
DEFINE VARIABLE vFrom       AS CHARACTER NO-UNDO
                               FORMAT "X(50)"
                               LABEL "From" 
                               INITIAL "comunica@fodun.com.co".
...
PROCEDURE sendmail:
    ...
    vstatus = hSocket:CONNECT("-S 25 -H " + vSmtpServer /*+ " -user comunica@fodun.com.co -password EwEuDOVmxARpG7AcwVHdaw"*/) NO-ERROR.
