...
FOR EACH CONTROL_pagos WHERE control_pagos.Nit EQ Creditos.Nit
    ...
    ASSIGN control_pagos.Pagos_IntAcum = ROUND(deuda * ((pTasa / 100) / W_NroPer), 0)
           control_pagos.pagos_capitalAcum = control_pagos.Cuota - ROUND((deuda * ((pTasa / 100) / W_NroPer)),0).
