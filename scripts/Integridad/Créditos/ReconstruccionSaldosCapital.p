...
FOR EACH rep_creditos WHERE rep_creditos.agencia = vAgencia
    ...
    tabla.sdo_ini = tabla.sdo_ini + rep_creditos.sdo_capital.
END.
...
FOR EACH mov_contable WHERE mov_contable.agencia = vAgencia
                        ...
                        AND (SUBSTRING(mov_contable.cuenta,1,4) = "1441" OR
                             SUBSTRING(mov_contable.cuenta,1,4) = "1442")
...
FOR EACH rep_creditos WHERE rep_creditos.agencia = vAgencia
    ...
    tabla.sdo_fin = tabla.sdo_fin + rep_creditos.sdo_capital.
END.
