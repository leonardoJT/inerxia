...
------------------------------------------------------------------------------*/
  ...
  DEFINE VARIABLE ctaprima LIKE creditos.cuota.
...
/*                          (Ahorros.tip_ahorro NE 2 AND Ahorros.Cod_ahorro NE 221) AND /*Gcamacho Abr 12 Ahorro Permanente*/ */
/*                          (Ahorros.tip_ahorro NE 4 AND Ahorros.Cod_ahorro NE 10) AND                                        */
  ...
  FOR EACH Creditos WHERE Creditos.Nit         EQ W_NitCte /*AND
                          (Creditos.FOR_Pago EQ 5 OR Creditos.FOR_Pago EQ 4)*/ AND
                          Creditos.Estado      EQ 2 
                          NO-LOCK BY Creditos.Cod_Credito:
      ctaprima = 0.
      IF creditos.For_pago = 5 THEN ctaprima = creditos.cuota. 
      IF (creditos.sdo_anuales[1] + ctaprima) LE 0  THEN NEXT.
      ...
      ASSIGN TPdctos.Prior    = Pro_Creditos.Prioridad
             ...
             TPdctos.Cuota    = creditos.sdo_anuales[1] + ctaprima
             TPdctos.CuoOrig  = creditos.sdo_anuales[1] + ctaprima
...
------------------------------------------------------------------------------*/
  DISPLAY TOGGLE-1 W_CmbEmp W_CmbOfi Cmb_pagos Tg_Nuevo Rs_Opcrea W_NitCte 
          W_VrRec W_NCuotas W_NroPago W_NomCte txt_contrapartida W_sem W_TotRec 
          W_TotNoD Tg_SemP W_Cont Msaje W_Dist W_PorD 
      WITH FRAME F_Proc IN WINDOW W-Rec_XLibranza.
  ENABLE TOGGLE-1 Btn_BorraPagos W_CmbEmp Cmb_pagos Tg_Nuevo W_NitCte W_VrRec 
         W_NCuotas BUTTON-5 Br_Rec txt_contrapartida W_sem Btn_Imp 
         Btn_Preliminar Btn_Contabilizar Tg_SemP Btn_Done Br_Pdctos 
