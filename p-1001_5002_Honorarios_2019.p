...
FOR EACH anexos WHERE (SUBSTRING(anexos.cuenta,1,6) = "511001" OR
    ...
    IF pOrigen = "E" AND (SUBSTRING(anexos.cuenta,1,8) = "51100104" OR
                          SUBSTRING(anexos.cuenta,1,8) = "51100103") THEN
        NEXT.
...
IF pOrigen = "E" THEN DO:
    ...
    FOR EACH sal_cuenta WHERE (SUBSTRING(sal_cuenta.cuenta,1,8) = "51100101" OR
                               SUBSTRING(sal_cuenta.cuenta,1,8) = "51100102" OR
                               SUBSTRING(sal_cuenta.cuenta,1,8) = "51100103" OR
                               SUBSTRING(sal_cuenta.cuenta,1,8) = "51100106" OR
    ...
    OUTPUT TO VALUE ("C:\INFO_Fodun\F1001_5002-" + STRING(vYear) + ".csv").
