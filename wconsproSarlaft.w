...
DEFINE VARIABLE h_dSARLAFT AS HANDLE NO-UNDO.
...
DEFINE FRAME F_FactSARLAFT
    ...
    WITH 1 DOWN KEEP-TAB-ORDER OVERLAY 
         ...
         SIZE 66 BY 21.62
         BGCOLOR 17 
         TITLE "Consulta Fcatores SARLAFT" WIDGET-ID 100.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW wWin ASSIGN
         HIDDEN             = YES
         TITLE              = "Consulta Factores SARLAFT"
         HEIGHT             = 21.5
         WIDTH              = 62.86
         MAX-HEIGHT         = 28.81
         MAX-WIDTH          = 146.14
...
ON END-ERROR OF wWin /* Consulta Factores SARLAFT */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL wWin wWin
ON WINDOW-CLOSE OF wWin /* Consulta Factores SARLAFT */
DO:
...
OR RETURN OF W_Busca DO:
  ...
  DYNAMIC-FUNCTION('closeQuery':U IN h_dSARLAFT).
  DYNAMIC-FUNCTION('setQueryWhere':U IN h_dSARLAFT,
     INPUT STRING(pro_SARLAFT.cod_Factor,'999999') = W_Busca:SCREEN-VALUE).  
  DYNAMIC-FUNCTION('openQuery':U IN h_dSARLAFT).
...
------------------------------------------------------------------------------*/
  ...
  CASE currentPage: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN addLink ( h_dSARLAFT , 'Data':U , h_dynbrowser ).
       RUN addLink ( h_dynbrowser , 'Update':U , h_dSARLAFT ).
