...
&Scoped-define FIELDS-IN-QUERY-br_table Per_Factura Fec_Inicial Fec_Final ~
Fec_LimPago Estado 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      Per_Factura FORMAT ">>>>>>9":U
      Fec_Inicial FORMAT "99/99/9999":U
      Fec_Final FORMAT "99/99/9999":U
      Fec_LimPago FORMAT "99/99/9999":U
      Estado FORMAT "9":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN NO-AUTO-VALIDATE NO-ROW-MARKERS SEPARATORS SIZE 54 BY 6.65 FIT-LAST-COLUMN.
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   = _<SDO>.rowObject.Per_Factura
     _FldNameList[2]   = _<SDO>.rowObject.Fec_Inicial
     _FldNameList[3]   = _<SDO>.rowObject.Fec_Final
     _FldNameList[4]   = _<SDO>.rowObject.Fec_LimPago
     _FldNameList[5]   > _<SDO>.rowObject.Estado
"Estado" ? ? "integer" ? ? ? ? ? ? no ? no no "11.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
