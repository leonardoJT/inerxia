...
&Scoped-Define DISPLAYED-FIELDS RowObject.FAgencia RowObject.FUsu_reporta ~
RowObject.FInstancia 
...
DEFINE FRAME F-Main
     RowObject.FAgencia AT ROW 1.23 COL 46 COLON-ALIGNED HELP
          "" WIDGET-ID 6
          LABEL "Age." FORMAT "x(40)"
          VIEW-AS FILL-IN NATIVE 
          SIZE 35 BY 1
          BGCOLOR 15 FGCOLOR 7 
     RowObject.FUsu_reporta AT ROW 1.23 COL 87 COLON-ALIGNED HELP
          "" WIDGET-ID 30
          LABEL "Usu." FORMAT "x(40)"
          VIEW-AS FILL-IN NATIVE 
          SIZE 35 BY 1
          BGCOLOR 15 FGCOLOR 7 
     RowObject.FInstancia AT ROW 1.27 COL 5 COLON-ALIGNED HELP
          "" WIDGET-ID 60
          LABEL "Inst." FORMAT "x(35)"
          VIEW-AS FILL-IN NATIVE 
          SIZE 35 BY 1
          BGCOLOR 15 FGCOLOR 7 
