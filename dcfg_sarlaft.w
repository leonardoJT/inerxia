...
DEFINE TEMP-TABLE T1Cfg_Sarlaft NO-UNDO LIKE Cfg_Sarlaft.
DEFINE TEMP-TABLE T2Cfg_Sarlaft NO-UNDO LIKE Cfg_Sarlaft.
...
&Scoped-define INTERNAL-TABLES Cfg_Sarlaft

/* Definitions for QUERY Query-Main                                     */
&Scoped-Define ENABLED-FIELDS  Cfg_Cod Cod_Analisis Cod_Nivel Cod_Probabilidad Cod_Severidad Cod_RASoc~
 Cta_Cr Cta_Db Descripcion Estado Fec_Creacion Fec_Retiro Nombre Tipo~
 Util_Neta Val_Final Val_Inicial Por_dos Por_uno
&Scoped-define ENABLED-FIELDS-IN-Cfg_Sarlaft Cfg_Cod Cod_Analisis Cod_Nivel ~
Cod_Probabilidad Cod_Severidad Cod_RASoc Cta_Cr Cta_Db Descripcion Estado ~
Fec_Creacion Fec_Retiro Nombre Tipo Util_Neta Val_Final Val_Inicial Por_dos ~
Por_uno 
&Scoped-Define DATA-FIELDS  Cfg_Cod Cod_Analisis Cod_Nivel Cod_Probabilidad Cod_Severidad Cod_RASoc~
 Cta_Cr Cta_Db Descripcion Estado Fec_Creacion Fec_Retiro Nombre Tipo~
 Util_Neta Val_Final Val_Inicial Por_dos Por_uno Val_Detallada~
 Val_DetalladaP Cla_Imp FSeveridad FProbabilidad Cfg_Nombre
&Scoped-define DATA-FIELDS-IN-Cfg_Sarlaft Cfg_Cod Cod_Analisis Cod_Nivel ~
Cod_Probabilidad Cod_Severidad Cod_RASoc Cta_Cr Cta_Db Descripcion Estado ~
Fec_Creacion Fec_Retiro Nombre Tipo Util_Neta Val_Final Val_Inicial Por_dos ~
Por_uno 
...
&Scoped-define QUERY-STRING-Query-Main FOR EACH Cfg_Sarlaft NO-LOCK INDEXED-REPOSITION
{&DB-REQUIRED-START}
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH Cfg_Sarlaft NO-LOCK INDEXED-REPOSITION.
{&DB-REQUIRED-END}
&Scoped-define TABLES-IN-QUERY-Query-Main Cfg_Sarlaft
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main Cfg_Sarlaft
...
/* Settings for THIS-PROCEDURE
   ...
   Temp-Tables and Buffers:
      TABLE: T1Cfg_Sarlaft T "?" NO-UNDO bdcentral Cfg_Sarlaft
      TABLE: T2Cfg_Sarlaft T "?" NO-UNDO bdcentral Cfg_Sarlaft
   END-TABLES.
 */
...
/* Query rebuild information for SmartDataObject Query-Main
     _TblList          = "bdcentral.Cfg_Sarlaft"
     _Options          = "NO-LOCK INDEXED-REPOSITION"
     _FldNameList[1]   > bdcentral.Cfg_Sarlaft.Cfg_Cod
"Cfg_Cod" "Cfg_Cod" ? ? "integer" ? ? ? ? ? ? yes ? yes 19.72 yes ?
     _FldNameList[2]   > bdcentral.Cfg_Sarlaft.Cod_Analisis
"Cod_Analisis" "Cod_Analisis" ? ? "character" ? ? ? ? ? ? yes ? no 39.14 yes ?
     _FldNameList[3]   > bdcentral.Cfg_Sarlaft.Cod_Nivel
"Cod_Nivel" "Cod_Nivel" ? ">>9" "integer" ? ? ? ? ? ? yes ? no 4.86 yes ?
     _FldNameList[4]   > bdcentral.Cfg_Sarlaft.Cod_Probabilidad
"Cod_Probabilidad" "Cod_Probabilidad" ? ? "integer" ? ? ? ? ? ? yes ? yes 18.72 yes ?
     _FldNameList[5]   > bdcentral.Cfg_Sarlaft.Cod_Severidad
"Cod_Severidad" "Cod_Severidad" ? ? "integer" ? ? ? ? ? ? yes ? yes 16.43 yes ?
     _FldNameList[6]   > bdcentral.Cfg_Sarlaft.Cod_RASoc
"Cod_RASoc" "Cod_RASoc" ? ? "integer" ? ? ? ? ? ? yes ? no 15.57 yes ?
     _FldNameList[7]   > bdcentral.Cfg_Sarlaft.Cta_Cr
"Cta_Cr" "Cta_Cr" ? ? "character" ? ? ? ? ? ? yes ? no 22 yes ?
     _FldNameList[8]   > bdcentral.Cfg_Sarlaft.Cta_Db
"Cta_Db" "Cta_Db" ? ? "character" ? ? ? ? ? ? yes ? no 22 yes ?
     _FldNameList[9]   > bdcentral.Cfg_Sarlaft.Descripcion
"Descripcion" "Descripcion" "Descripción Detallada" "X(50)" "character" ? ? ? ? ? ? yes ? no 50 yes "Descripción Detallada"
     _FldNameList[10]   > bdcentral.Cfg_Sarlaft.Estado
"Estado" "Estado" ? ? "integer" ? ? ? ? ? ? yes ? yes 6.43 yes ?
     _FldNameList[11]   > bdcentral.Cfg_Sarlaft.Fec_Creacion
"Fec_Creacion" "Fec_Creacion" ? ? "date" ? ? ? ? ? ? yes ? yes 17.14 yes ?
     _FldNameList[12]   > bdcentral.Cfg_Sarlaft.Fec_Retiro
"Fec_Retiro" "Fec_Retiro" ? ? "date" ? ? ? ? ? ? yes ? no 14.57 yes ?
     _FldNameList[13]   > bdcentral.Cfg_Sarlaft.Nombre
"Nombre" "Nombre" ? "X(20)" "character" ? ? ? ? ? ? yes ? no 20 yes ?
     _FldNameList[14]   > bdcentral.Cfg_Sarlaft.Tipo
"Tipo" "Tipo" ? ? "integer" ? ? ? ? ? ? yes ? yes 4 yes ?
     _FldNameList[15]   > bdcentral.Cfg_Sarlaft.Util_Neta
"Util_Neta" "Util_Neta" ? ">>9,99" "decimal" ? ? ? ? ? ? yes ? no 15.86 yes ?
     _FldNameList[16]   > bdcentral.Cfg_Sarlaft.Val_Final
"Val_Final" "Val_Final" ? ">>>,>>>,>>9.99" "decimal" ? ? ? ? ? ? yes ? no 19.14 yes ?
     _FldNameList[17]   > bdcentral.Cfg_Sarlaft.Val_Inicial
"Val_Inicial" "Val_Inicial" ? ">>>,>>>,>>9.99" "decimal" ? ? ? ? ? ? yes ? no 19.14 yes ?
     _FldNameList[18]   > bdcentral.Cfg_Sarlaft.Por_dos
"Por_dos" "Por_dos" ? ? "decimal" ? ? ? ? ? ? yes ? no 12 yes ?
     _FldNameList[19]   > bdcentral.Cfg_Sarlaft.Por_uno
...
------------------------------------------------------------------------------*/
  ...
  FOR EACH rowobjupd WHERE rowobjupd.rowmod = "A" :
     ASSIGN rowobjupd.Cfg_Cod      = NEXT-VALUE(Sec_cfgSarlaft)
...
------------------------------------------------------------------------------*/
  ...
  DEFINE VARIABLE vcDescr AS CHARACTER   NO-UNDO.
    ...
    FIND FIRST Cfg_Sarlaft WHERE Cfg_Sarlaft.tipo = 2 
                          AND Cfg_Sarlaft.Cod_Nivel = piCodigo NO-LOCK NO-ERROR.
    IF AVAILABLE Cfg_Sarlaft THEN 
        ASSIGN vcDescr = STRING(Cfg_Sarlaft.Cod_Nivel,'9') + " " + Cfg_Sarlaft.nombre.
    ELSE
        ASSIGN vcDescr = "N/A".
...
------------------------------------------------------------------------------*/
    ...
    FIND FIRST Cfg_Sarlaft WHERE Cfg_Sarlaft.tipo = 1 
                          AND Cfg_Sarlaft.Cod_Nivel = piCodigo NO-LOCK NO-ERROR.
    IF AVAILABLE Cfg_Sarlaft THEN 
        ASSIGN vcDescr = STRING(Cfg_Sarlaft.Cod_Nivel,'9') + " " + Cfg_Sarlaft.nombre.
    ELSE
