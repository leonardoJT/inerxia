...
DEFINE VARIABLE h_dcfg_Sarlaft5 AS HANDLE NO-UNDO.
...
"Inactivo", 2
     ...
     RowObject.Cod_Analisis AT ROW 5.42 COL 1.14 COLON-ALIGNED HELP
          ...
          LIST-ITEM-PAIRS "Riesgo Inusual","I",
                     "Riesgo Extremo","E"
          DROP-DOWN-LIST
          SIZE 53 BY 1
          BGCOLOR 15 
     v-cod-analisis AT ROW 5.42 COL 62 RIGHT-ALIGNED NO-LABEL WIDGET-ID 340
     ...
     "Estado" VIEW-AS TEXT
          ...
          FONT 5
     "Clasificación Riesgo Sarlaft" VIEW-AS TEXT
...
ASSIGN 
       RowObject.Por_dos:HIDDEN IN FRAME F_Analisis           = TRUE.

/* SETTINGS FOR FILL-IN RowObject.Por_uno IN FRAME F_Analisis
   NO-DISPLAY NO-ENABLE                                                 */
ASSIGN 
       RowObject.Por_uno:HIDDEN IN FRAME F_Analisis           = TRUE.
...
------------------------------------------------------------------------------*/
  ...
  CASE currentPage: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN repositionObject IN h_dcfg_Sarlaft1 ( 3.69 , 82.29 ) NO-ERROR.
       ...
       RUN resizeObject IN h_dynselect ( 0.92 , 36.57 ) NO-ERROR.

       RUN constructObject (
             INPUT  'dcfg_Sarlaft.wDB-AWARE':U ,
             INPUT  FRAME F_Analisis:HANDLE ,
             INPUT  'AppServiceASInfoASUsePrompt?CacheDuration0CheckCurrentChangedyesDestroyStatelessyesDisconnectAppServernoServerOperatingModeNONEShareDatanoUpdateFromSourcenoForeignFieldsObjectNamedcfg_SarlaftOpenOnInityesPromptColumns(NONE)PromptOnDeleteyesRowsToBatch200RebuildOnReposnoToggleDataTargetsyes':U ,
             OUTPUT h_dcfg_Sarlaft5 ).
       RUN repositionObject IN h_dcfg_Sarlaft5 ( 5.58 , 82.29 ) NO-ERROR.
       /* Size in AB:  ( 1.50 , 7.72 ) */
       ...
       RUN resizeObject IN h_dynselect-2 ( 0.92 , 36.29 ) NO-ERROR.
       ...
       RUN addLink ( h_dcfg_Sarlaft1 , 'Data':U , h_dynselect ).

       /* Links to SmartDataField h_dynselect-2. */
       RUN addLink ( h_dcfg_Sarlaft5 , 'Data':U , h_dynselect-2 ).
