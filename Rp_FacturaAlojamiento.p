...
PROCEDURE PageHeader:
    ...
    IF pdf_Page("Spdf") = 1 THEN DO:
        ...
        RUN pdf_text_xy IN h_PDFinc ("Spdf", "Resolución No.320000993214 - Fecha: 2013/03/05",180,710).
        RUN pdf_text_xy IN h_PDFinc ("Spdf", "Facturación autorizada del B-8001 al B-10000",188,700).

        RUN pdf_set_font IN h_PDFinc ("Spdf","Courier-Bold",12).
        RUN pdf_text_color IN h_PDFinc ("Spdf",0.5,0,0).
        RUN pdf_stroke_fill IN h_PDFinc ("Spdf",0.5,0,0).
        RUN pdf_text_boxed_xy IN h_PDFinc ("Spdf", /* Texto */ "", /* Eje X */ 500, /* Eje Y */ 750, /* Ancho */ 120, /* Alto */ 16, /* Justificación */ "Center", /* Ancho de línea */ 1).
