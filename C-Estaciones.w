...
/* Parameters Definitions ---                                           */
  DEFINE OUTPUT PARAMETER W_Cod LIKE Estaciones.Estacion.
  DEFINE OUTPUT PARAMETER W_des LIKE Estaciones.Descripcion.
...
&Scoped-define FIELDS-IN-QUERY-BROWSE-2 Estaciones.Descripcion ~
Estaciones.Estacion Estaciones.Agencia 
&Scoped-define ENABLED-FIELDS-IN-QUERY-BROWSE-2 
&Scoped-define QUERY-STRING-BROWSE-2 FOR EACH Estaciones NO-LOCK
...
&Scoped-Define ENABLED-OBJECTS BROWSE-2 W_Estado RADIO-SET-2 W_Valor ~
BUTTON-48 RECT-143 
...
DEFINE QUERY BROWSE-2 FOR 
      Estaciones
    FIELDS(Estaciones.Descripcion
      Estaciones.Estacion
      Estaciones.Agencia) SCROLLING.
&ANALYZE-RESUME
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-2 Dialog-Frame _STRUCTURED
  QUERY BROWSE-2 DISPLAY
      Estaciones.Descripcion FORMAT "X(50)":U
      Estaciones.Estacion FORMAT "X(10)":U
      Estaciones.Agencia FORMAT "999":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE BROWSE-2
     ...
     _TblOptList       = "USED"
     _FldNameList[1]   = bdcentral.Estaciones.Descripcion
     _FldNameList[2]   = bdcentral.Estaciones.Estacion
     _FldNameList[3]   = bdcentral.Estaciones.Agencia
...
DO:
   ASSIGN W_Cod = Estaciones.Estacion
          W_Des = Estaciones.Descripcion.
...
------------------------------------------------------------------------------*/
  ...
  ENABLE BROWSE-2 W_Estado RADIO-SET-2 W_Valor BUTTON-48 RECT-143 
      WITH FRAME Dialog-Frame.
