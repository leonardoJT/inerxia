...
cfg_creditos.codSuscriptorDatacredito ~
cfg_creditos.montoMinimoRefinanciacion 
&Scoped-define ENABLED-TABLES-IN-QUERY-F-MAIN cfg_creditos
&Scoped-define FIRST-ENABLED-TABLE-IN-QUERY-F-MAIN cfg_creditos
...
&Scoped-Define ENABLED-FIELDS cfg_creditos.codSuscriptorDatacredito ~
cfg_creditos.montoMinimoRefinanciacion 
&Scoped-define ENABLED-TABLES cfg_creditos
&Scoped-define FIRST-ENABLED-TABLE cfg_creditos
...
DO:
    ...
    DO TRANSACTION ON ERROR UNDO Grabando:
        IF cfg_creditos.provisionGeneralCaja:SCREEN-VALUE <> "" AND
           ...
           cfg_creditos.provisionGeneralNomina:SCREEN-VALUE <> ? AND
           cfg_creditos.montoMinimoRefinanciacion:SCREEN-VALUE <> "" AND
           cfg_creditos.montoMinimoRefinanciacion:SCREEN-VALUE <> ? THEN DO:
            ASSIGN FRAME F-MAIN
                ...
                cfg_creditos.montoMinimoRefinanciacion
                cfg_credito.codSuscriptorDatacredito.
...
DO:
    ...
    cfg_creditos.codSuscriptorDatacredito:SENSITIVE = TRUE.
END.
...
------------------------------------------------------------------------------*/
  ...
  ENABLE cfg_creditos.codSuscriptorDatacredito 
         cfg_creditos.montoMinimoRefinanciacion Btn-Cancelar Btn-Salvar 
         Btn_Done btnEditar RECT-325 RECT-2 RECT-326 
      WITH FRAME F-MAIN IN WINDOW C-Win.
...
DO WITH FRAME f-main:
    ...
    cfg_creditos.codSuscriptorDatacredito:SCREEN-VALUE = cfg_creditos.codSuscriptorDatacredito.
    ...
    cfg_creditos.codSuscriptorDatacredito:SENSITIVE = FALSE.
END.
