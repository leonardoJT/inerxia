...
FOR EACH creditos WHERE 
    ...
    agencia EQ 20 AND num_credito = 244211 
...
/*              BREAK BY mov_creditos.Fecha BY mov_creditos.descrip :                           */
     ...
     IF (TemMovCre.cod_operacion = 20102001 AND TemMovCre.descrip BEGINS "COMISION") OR 
        (TemMovCre.cod_operacion = 10302001 AND TemMovCre.descrip BEGINS "COBRO SOBREGIRO") THEN 
