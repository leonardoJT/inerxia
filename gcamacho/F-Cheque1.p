...
IF P_Valor GT 0 AND P_vctipo = "1" THEN  /* Taquilla*/
 DO:
  DISPLAY 
    Ano                        AT ROW 6  COL 34 FORMAT "X(4)"    /* 34 */ /*+26*/   /* 60  */
    STRING(MONTH(TODAY),">9")  AT ROW 6  COL 40 FORMAT "X(2)"    /* 40 */           /* 66  */
    STRING(DAY(TODAY),">9")    AT ROW 6  COL 44 FORMAT "X(2)"    /* 44 */           /* 70  */
    P_Valor                    AT ROW 6  COL 50                  /* 50 */           /* 76  */
    P_Nombre                   AT ROW 8  COL 7                   /* 7  */           /* 33  */
    P_Monto1                   AT ROW 9  COL 7                   /* 7  */           /* 33  */
    P_Monto2                   AT ROW 11 COL 1                   /* 1  */           /* 27  */
  WITH PAGE-TOP FRAME  F-cheqT width 120 NO-LABELS NO-BOX USE-TEXT.  /*120*/        /* 240 */
  ...
  IF P_Valor GT 0 AND P_vctipo NE "1" THEN /* Desembolsos*/
   DO:
    DISPLAY 
      ...
      P_Monto1                   AT ROW 9  COL 7                   /* 7  */           /* 33  */
      P_Monto2                   AT ROW 11 COL 1                   /* 1  */           /* 27  */
       "*"                       AT ROW 16 COL 1                   /* 1  */           /* 27  */
      P_Coment                   AT ROW 26 COL 2                   /* 2  */           /* 28  */
      P_Tit1                     AT ROW 27 COL 2                   /* 2  */           /* 28  */
      P_Nom2                     AT ROW 27 COL 25                  /* 25 */           /* 51  */
      P_Tit2                     AT ROW 28 COL 2                   /* 2  */           /* 28  */
      P_Val2                     AT ROW 28 COL 25                  /* 25 */           /* 51  */
      TODAY                      AT ROW 29 COL 2                   /* 2  */           /* 28  */
    WITH PAGE-TOP FRAME  F-cheq width 120 NO-LABELS NO-BOX USE-TEXT.  /*120*/        /* 240 */
  END.
  ELSE
