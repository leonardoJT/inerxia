...
DEFINE VARIABLE w_mes    AS INTEGER   NO-UNDO INITIAL 4.
DEFINE VARIABLE w_ageini AS INTEGER   NO-UNDO INITIAL 1.
DEFINE VARIABLE w_agefin AS INTEGER   NO-UNDO INITIAL 55.
...
w_FEC1 = DATE(4,01,2008).
w_FEC2 = DATE(4,30,2008).

MESSAGE 'inicio '
    VIEW-AS ALERT-BOX INFO BUTTONS OK.

 FOR EACH sal_cuenta WHERE 
    SAL_cuenta.cuenta EQ xcta  AND
