...
{Incluido\edwin.i "NEW GLOBAL SHARED "}
...
DEFINE FRAME fMain
     FILL-IN-1 AT ROW 1.54 COL 10 COLON-ALIGNED
     BUTTON-1 AT ROW 1.54 COL 28
     BUTTON-2 AT ROW 1.54 COL 44
...
ON LEAVE OF FILL-IN-1 IN FRAME fMain /* Fill 1 */
DO:
  X = SELF:SCREEN-VALUE.
