...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.Cod_Producto ~
rowObject.Dif_CtaFuente 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      rowObject.Cod_Producto FORMAT "999":U COLUMN-FONT 4 LABEL-BGCOLOR 17 LABEL-FONT 4
      rowObject.Dif_CtaFuente FORMAT "X(14)":U COLUMN-FONT 4 LABEL-BGCOLOR 17 LABEL-FONT 4
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN NO-AUTO-VALIDATE NO-ROW-MARKERS SEPARATORS SIZE 22 BY 6.65
         BGCOLOR 15 FONT 5 EXPANDABLE TOOLTIP "Cuentas de Diferidos Registradas.".
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   > _<SDO>.rowObject.Cod_Producto
"rowObject.Cod_Producto" ? ? "integer" ? ? 4 17 ? 4 no ? no no ? yes no no "U" "" ""
     _FldNameList[2]   > _<SDO>.rowObject.Dif_CtaFuente
"rowObject.Dif_CtaFuente" ? ? "character" ? ? 4 17 ? 4 no ? no no ? yes no no "U" "" ""
