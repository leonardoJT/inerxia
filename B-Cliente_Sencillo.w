...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.Agencia rowObject.Nit ~
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      Agencia COLUMN-LABEL "Age" FORMAT "999":U WIDTH 3.43
      Nit FORMAT "X(12)":U
      Nombre FORMAT "X(40)":U WIDTH 19.86
      Apellido1 FORMAT "X(15)":U
      Apellido2 FORMAT "X(15)":U WIDTH 10.29
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
ASSIGN 
       rowObject.Nombre:AUTO-RESIZE IN BROWSE br_table = TRUE.
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   > _<SDO>.rowObject.Agencia
"Agencia" "Age" ? "integer" ? ? ? ? ? ? no ? no no "3.43" yes no no "U" "" ""
     _FldNameList[2]   = _<SDO>.rowObject.Nit
     _FldNameList[3]   > _<SDO>.rowObject.Nombre
"Nombre" ? ? "character" ? ? ? ? ? ? no ? no no "19.86" yes yes no "U" "" ""
     _FldNameList[4]   = _<SDO>.rowObject.Apellido1
     _FldNameList[5]   > _<SDO>.rowObject.Apellido2
"Apellido2" ? ? "character" ? ? ? ? ? ? no ? no no "10.29" yes no no "U" "" ""
