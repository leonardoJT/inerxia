...
/*     creditos.Int_DifCobro   LT 0 OR Creditos.INT_anticipado LT 0:                    */
/*                                                                                      */
...
FOR EACH creditos WHERE 
    (cod_credito EQ 570 OR cod_credito EQ 870) AND estado = 2
/*****************************/
...
zarcEncabezado = "c:\info_utrahuilca\Encabezado_" + STRING(DAY(TODAY),"99") +  STRING(MONTH(TODAY),"99") +  STRING(YEAR(TODAY),"9999") + ".TXT".
...
zarcDetalle = "c:\info_utrahuilca\Detalle_" + STRING(DAY(TODAY),"99") +  STRING(MONTH(TODAY),"99") +  STRING(YEAR(TODAY),"9999") + ".TXT".
...
zarcesta = "c:\info_utrahuilca\Estadisticas_" + STRING(DAY(TODAY),"99") +  STRING(MONTH(TODAY),"99") +  STRING(YEAR(TODAY),"9999") + ".TXT".
