...
/*RUN pdf_new IN h_PDFinc ("Spdf","\\192.168.1.100\Aplicacion\Obj\Reportes\FacturasCupos\" + pNit + ".pdf").*/
...
PROCEDURE PageHeader:
    ...
    IF pdf_Page("Spdf") = 1 THEN DO:
        ...
        RUN pdf_text_xy IN h_PDFinc ("Spdf",STRING(pFecCorte,"99/99/9999"),247,587).
        ...
        RUN pdf_text_xy IN h_PDFinc ("Spdf","DISPONIBLE",266,561).

        RUN pdf_text_boxed_xy IN h_PDFinc ("Spdf", /* Texto */ "", /* Eje X */ 340, /* Eje Y */ 557, /* Ancho */ 80, /* Alto */ 16, /* Justificación */ "Center", /* Ancho de línea */ 1).
        RUN pdf_text_xy IN h_PDFinc ("Spdf","SALDO TOTAL",343,561).

        RUN pdf_text_boxed_xy IN h_PDFinc ("Spdf", /* Texto */ "", /* Eje X */ 420, /* Eje Y */ 557, /* Ancho */ 100, /* Alto */ 16, /* Justificación */ "Center", /* Ancho de línea */ 1).
        RUN pdf_text_xy IN h_PDFinc ("Spdf","PAGAR ANTES DE",423,561).
        ...
        RUN pdf_text_xy IN h_PDFinc ("Spdf",STRING(creditos.monto - creditos.sdo_capital,"$>>>,>>>,>>9"),261,545).

        RUN pdf_text_boxed_xy IN h_PDFinc ("Spdf", /* Texto */ "", /* Eje X */ 340, /* Eje Y */ 541, /* Ancho */ 80, /* Alto */ 16, /* Justificación */ "Center", /* Ancho de línea */ 1).
        RUN pdf_text_xy IN h_PDFinc ("Spdf",STRING(creditos.sdo_capital + creditos.int_corriente + creditos.int_difCobro + creditos.int_morCobrar + creditos.INT_moraDifCob,"$>>>,>>>,>>9"),341,545).
        ...
        RUN pdf_text_boxed_xy IN h_PDFinc ("Spdf", /* Texto */ "", /* Eje X */ 420, /* Eje Y */ 541, /* Ancho */ 100, /* Alto */ 16, /* Justificación */ "Center", /* Ancho de línea */ 1).
        RUN pdf_text_xy IN h_PDFinc ("Spdf", pFecPago,430,545).
