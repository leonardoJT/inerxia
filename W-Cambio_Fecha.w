...
/*PERMITE CAMBIAR LA FECHA DE TRABAJO DEL SISTEMA*/
CREATE WIDGET-POOL.
...
/*variables locales del programa*/
  ...
  DEFINE VARIABLE W_Vent AS WIDGET-HANDLE.
  DEFINE VARIABLE W_Evento AS CHAR INITIAL "SA". 
  DEFINE VARIABLE W_HayError   AS LOGICAL.
...
&Scoped-Define ENABLED-OBJECTS monthimage RECT-148 RECT-16 RECT-17 BInfo ~
b-prevbmonth b-prevyear b-nextmonth b-nextyear BSalvar BtnDone BAyuda 
&Scoped-Define DISPLAYED-OBJECTS C_Fechadeldia C_Fecha ldday styear 
...
DEFINE BUTTON BSalvar 
     ...
     IMAGE-INSENSITIVE FILE "imagenes/disque.jpg":U
     LABEL "Button 50" 
     SIZE 8 BY 1.62.
...
DEFINE VARIABLE C_Fecha AS DATE FORMAT "99/99/9999":U 
     LABEL "Fecha Actual del Sistema" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .81
     BGCOLOR 18 FGCOLOR 15  NO-UNDO.

DEFINE VARIABLE C_Fechadeldia AS DATE FORMAT "99/99/9999":U 
     LABEL "Fecha del Dia" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .81
     BGCOLOR 18 FGCOLOR 15  NO-UNDO.
...
DEFINE FRAME F-Main
     B1 AT ROW 7.19 COL 6
     C_Fechadeldia AT ROW 1.27 COL 23 COLON-ALIGNED
     C_Fecha AT ROW 2.35 COL 23 COLON-ALIGNED
     BInfo AT ROW 4.5 COL 32
     b-prevbmonth AT ROW 4.77 COL 14
     ldday AT ROW 4.77 COL 15 COLON-ALIGNED NO-LABEL
     styear AT ROW 4.77 COL 19.57 COLON-ALIGNED NO-LABEL
     b-prevyear AT ROW 4.77 COL 26.72
     b-nextmonth AT ROW 5.31 COL 14
     b-nextyear AT ROW 5.31 COL 26.72
     b5 AT ROW 7.19 COL 18
     b6 AT ROW 7.19 COL 21
     b7 AT ROW 7.19 COL 24
     BSalvar AT ROW 7.73 COL 32
     b8 AT ROW 8 COL 6
     b9 AT ROW 8 COL 9
     b10 AT ROW 8 COL 12
     b11 AT ROW 8 COL 15
     ...
     b13 AT ROW 8 COL 21
     b14 AT ROW 8 COL 24
     b15 AT ROW 8.81 COL 6
     b16 AT ROW 8.81 COL 9
     b18 AT ROW 8.81 COL 15
     b19 AT ROW 8.81 COL 18
     b20 AT ROW 8.81 COL 21
     b21 AT ROW 8.81 COL 24
     BtnDone AT ROW 9.35 COL 32
     b22 AT ROW 9.62 COL 6
     b23 AT ROW 9.62 COL 9
     b24 AT ROW 9.62 COL 12
     b25 AT ROW 9.62 COL 15
     b26 AT ROW 9.62 COL 18
     b27 AT ROW 9.62 COL 21
     b28 AT ROW 9.62 COL 24
     b29 AT ROW 10.42 COL 6
     b30 AT ROW 10.42 COL 9
     b31 AT ROW 10.42 COL 12
     b32 AT ROW 10.42 COL 15
     b33 AT ROW 10.42 COL 18
     b34 AT ROW 10.42 COL 21
     b35 AT ROW 10.42 COL 24
     b17 AT ROW 8.81 COL 12
     b36 AT ROW 11.23 COL 6
     b37 AT ROW 11.23 COL 9
     b38 AT ROW 11.23 COL 12
     b39 AT ROW 11.23 COL 15
     b40 AT ROW 11.23 COL 18
     b41 AT ROW 11.23 COL 21
     b42 AT ROW 11.23 COL 24
     BAyuda AT ROW 11.23 COL 34
     B2 AT ROW 7.19 COL 9
     B3 AT ROW 7.19 COL 12
     B4 AT ROW 7.19 COL 15
     "Fecha de Trabajo" VIEW-AS TEXT
          SIZE 16 BY .62 AT ROW 3.69 COL 2
          FGCOLOR 7 
     " Do Ln Ma Mi Ju Vi Sa" VIEW-AS TEXT
          SIZE 22 BY .62 AT ROW 6.38 COL 5
          FGCOLOR 7 FONT 2
     monthimage AT ROW 4.96 COL 3
     RECT-148 AT ROW 4.5 COL 2
     RECT-16 AT ROW 6.65 COL 2
     RECT-17 AT ROW 4.5 COL 21
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW wWin ASSIGN
         HIDDEN             = YES
         TITLE              = "SFG - Cambio de la Fecha de Trabajo"
         COLUMN             = 20.57
         ROW                = 6.92
         HEIGHT             = 11.88
         WIDTH              = 41.29
...
/* SETTINGS FOR FILL-IN C_Fecha IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN C_Fechadeldia IN FRAME F-Main
   NO-ENABLE                                                            */
...
ON END-ERROR OF wWin /* SFG - Cambio de la Fecha de Trabajo */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL wWin wWin
ON WINDOW-CLOSE OF wWin /* SFG - Cambio de la Fecha de Trabajo */
DO:
...
ON CHOOSE OF BSalvar IN FRAME F-Main /* Button 50 */
DO:
 ASSIGN FRAME F-Main LDDay.
     IF STRING(newdate) > "" THEN DO:      
        ASSIGN W_Fecha = newdate
               C_Fecha:SCREEN-VALUE IN FRAME F-Main = STRING(newdate).
        RUN P-GraLog IN W_Manija (INPUT STRING(W_fecha) + " " + W_Evento + " Mantenimiento de fechas").
     END.
     ELSE DO:           
        RUN Mostrarmensaje IN W_Manija (INPUT 65, OUTPUT W_Eleccion).
        RETURN NO-APPLY .
     END.
END.
...
DO WITH FRAME {&FRAME-NAME}:
   ...
   RUN Validar_Fecha.
   ASSIGN ldday = string(INTEGER(DAY(newdate)),"z9") /*lday*/
          styear =  string(INTEGER(YEAR(newdate)),"9999"). /*lyear*/
...
------------------------------------------------------------------------------*/
  DISPLAY C_Fechadeldia C_Fecha ldday styear 
      WITH FRAME F-Main IN WINDOW wWin.
  ENABLE monthimage RECT-148 RECT-16 RECT-17 BInfo b-prevbmonth b-prevyear 
         b-nextmonth b-nextyear BSalvar BtnDone BAyuda 
      WITH FRAME F-Main IN WINDOW wWin.
...
RUN SUPER.
  ...
  lyear = YEAR(W_Fecha)
  lday = DAY(W_Fecha)
  C_Fecha:SCREEN-VALUE IN FRAME F-Main = STRING(W_Fecha)
  C_Fechadeldia:SCREEN-VALUE = STRING(TODAY).
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE Validar_Fecha wWin 
PROCEDURE Validar_Fecha :
/*IF newdate > TODAY THEN DO:
    RUN Mostrarmensaje IN W_Manija (INPUT 23, OUTPUT W_Eleccion).
    ASSIGN newdate = TODAY.
    RETURN ERROR.
END.*/

ASSIGN W_HayError = FALSE.

FIND Calendario WHERE Calendario.Agencia EQ W_Agencia
                        AND Calendario.Ano     EQ YEAR(W_Fecnva)
                        AND Calendario.Mes     EQ MONTH(W_Fecnva) 
                        AND Calendario.Dia     EQ DAY(W_Fecnva) NO-ERROR.
      IF AVAILABLE(Calendario) THEN DO:
         IF Calendario.Estado = 2 THEN DO:
            RUN MostrarMensaje IN W_Manija (INPUT 232, OUTPUT W_Eleccion).
            MESSAGE "Desea Abrir el Dia?" VIEW-AS ALERT-BOX QUESTION 
                    BUTTONS YES-NO-CANCEL UPDATE choice AS LOGICAL.
            IF NOT Choice THEN
               ASSIGN W_HayError = TRUE.
            ELSE DO:
              Calendario.Estado = 1.
              FIND ProcDia WHERE ProcDia.Cod_Proceso Eq 1 AND
                                 ProcDia.Fecha_Proc  EQ W_FecNva AND
                                 ProcDia.Agencia     EQ W_Agencia NO-ERROR.
              IF NOT AVAILABLE(ProcDia) THEN DO:
                MESSAGE "Configura este dia como dia de Cierre de Mes?" VIEW-AS ALERT-BOX QUESTION 
                        BUTTONS YES-NO-CANCEL UPDATE choice2 AS LOGICAL.
                IF Choice2 THEN DO:
                   CREATE ProcDia.
                   ASSIGN ProcDia.Cod_Proceso = 1
                          ProcDia.Fecha_Proc  = W_FecNva
                          ProcDia.Agencia     = W_Agencia.
               
                END.
              END.
            END.            
         END.    
         IF Calendario.Habil = No THEN DO:
            RUN MostrarMensaje IN W_Manija (INPUT 80, OUTPUT W_Eleccion).
            ASSIGN W_HayError = TRUE.
         END.
         IF Control_Horas = YES THEN DO:
            IF Calendario.Hora_Inicial > TIME OR Calendario.Hora_Final < TIME THEN DO:
               RUN MostrarMensaje IN W_Manija (INPUT 81, OUTPUT W_Eleccion).
               ASSIGN W_HayError = TRUE.
            END.           
         END.
         IF NOT W_HayError THEN DO:
            BSalvar:SENSITIVE IN FRAME F-Main = TRUE.
            ON RETURN RETURN.
            APPLY "ENTRY" TO BSalvar.
            RETURN ERROR.
         END.
      END.
      ELSE
         STATUS INPUT "Fecha no definida en calendario ".
END PROCEDURE.
