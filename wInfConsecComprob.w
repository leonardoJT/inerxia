...
DEFINE FRAME fMain
     ...
     Btn_Imprimir AT ROW 16 COL 102 WIDGET-ID 70
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW wWin ASSIGN
         HIDDEN             = YES
         TITLE              = "Consecutivos Comprobantes"
         HEIGHT             = 22.5
         WIDTH              = 114.14
         MAX-HEIGHT         = 28.81
         MAX-WIDTH          = 146.14
...
ON END-ERROR OF wWin /* Consecutivos Comprobantes */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL wWin wWin
ON WINDOW-CLOSE OF wWin /* Consecutivos Comprobantes */
DO:
...
DO:
    ...
    IF DATE(F-FecIni:SCREEN-VALUE) NE DATE(F-FecFin:SCREEN-VALUE) THEN DO:
            MESSAGE "El rango de fechas puede generar" SKIP
                    "un archivo demasiado grande." SKIP
                    "Desea Continuar?"
                VIEW-AS ALERT-BOX QUESTION BUTTONS YES-NO TITLE "Rango muy amplio" 
    ...
    IF vlOk THEN  DO:
        RUN wimprime.w ("prConsecComprob.p", "Consec. Comprobantes CONTABLES",
...
/*     CMB-Comprob:SCREEN-VALUE IN FRAME {&FRAME-NAME} = "00 - Todos los Comprobantes".  */
    CMB-Comprob:SCREEN-VALUE IN FRAME {&FRAME-NAME} = "01 - Ingreso".
