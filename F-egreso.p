...
DEFINE VAR W_Enlace AS CHARACTER FORMAT "X(8)". /*10*/

/* oakley */

DEFINE VAR W_NCta AS CHARACTER FORMAT "X(12)". /*15*/
DEFINE VAR W_Enc1 AS CHARACTER FORMAT "X(120)". /*50*/
DEFINE VAR W_Enc2 AS CHARACTER FORMAT "X(120)". /*50*/
DEFINE VAR W_Enc3 AS CHARACTER FORMAT "X(120)". /*50*/
DEFINE VAR W_Enc4 AS CHARACTER FORMAT "X(120)". /*50*/
...
DEFINE FRAME F-Encabezado HEADER
    ...
    "Débito"                      AT COL 87 ROW 12
    "Crédito"                     AT COL 103 ROW 12
