...
/* DEFINE OUTPUT PARAMETER W_Punt AS ROWID.*/
...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.Categoria ~
rowObject.Cod_Producto rowObject.Nom_Producto rowObject.Cuenta_Inversion_DB 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      rowObject.Categoria COLUMN-LABEL "Tipo" FORMAT "9":U WIDTH 4
            LABEL-BGCOLOR 17
      rowObject.Cod_Producto COLUMN-LABEL "Cod" FORMAT "999":U
            WIDTH 5 LABEL-BGCOLOR 17
      rowObject.Nom_Producto FORMAT "X(40)":U WIDTH 45.29 LABEL-BGCOLOR 17
      rowObject.Cuenta_Inversion_DB COLUMN-LABEL "Cta de Inversion" FORMAT "X(14)":U
            WIDTH 10.72 LABEL-BGCOLOR 17
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN NO-AUTO-VALIDATE NO-ROW-MARKERS SEPARATORS SIZE 70 BY 6.19
...
ASSIGN 
       br_table:SEPARATOR-FGCOLOR IN FRAME F-Main      = 17.

ASSIGN 
       rowObject.Cuenta_Inversion_DB:AUTO-RESIZE IN BROWSE br_table = TRUE.
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   > _<SDO>.rowObject.Categoria
"rowObject.Categoria" "Tipo" ? "integer" ? ? ? 17 ? ? no ? no no "4" yes no no "U" "" ""
     _FldNameList[2]   > _<SDO>.rowObject.Cod_Producto
"rowObject.Cod_Producto" "Cod" ? "integer" ? ? ? 17 ? ? no ? no no "5" yes no no "U" "" ""
     _FldNameList[3]   > _<SDO>.rowObject.Nom_Producto
"rowObject.Nom_Producto" ? ? "character" ? ? ? 17 ? ? no ? no no "45.29" yes no no "U" "" ""
     _FldNameList[4]   > _<SDO>.rowObject.Cuenta_Inversion_DB
"rowObject.Cuenta_Inversion_DB" "Cta de Inversion" ? "character" ? ? ? 17 ? ? no "?" no no "10.72" yes yes no "U" "" ""
