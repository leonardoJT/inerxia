...
OUTPUT TO VALUE("c:\Visionamos\LOG_" + STRING(DAY(TODAY),"99") + STRING(MONTH(TODAY),"99") + STRING(YEAR(TODAY),"9999") + "_Input.txt") APPEND.
IF TIME >= 3600 AND TIME < 3720 THEN
    EXPORT DELIMITER ";" "Hora" "cliente_id" "num_cuenta" "tarjeta" "valor" "valor_comision" "grupo_transaccional" "tipoTrans".
...
FOR EACH tt:
    ...
    IF NOT AVAILABLE aplicarVisionamos OR (AVAILABLE aplicarVisionamos AND aplicarVisionamos.estado = 1) THEN DO:
        ...
        EXPORT DELIMITER ";"
            ...
            aplicarVisionamos.valorComisionAplicada / 100
        ...
        vComision = aplicarVisionamos.valorComisionAplicada / 100.
