...
DEFINE VAR facultadTexto AS char.
DEFINE VAR departamentoTexto AS char.
linea = 18.
linea2 = 7.
interlineado = 12.
...
RUN pdf_new IN h_PDFinc ("Spdf","Solicitudes\SolicitudEnBlanco.pdf").
...
/*    RUN pdf_text_xy IN h_PDFinc ("Spdf", pNumSolicitud, 490, 735).*/
    ...
    IF pdf_Page("Spdf") = 1 THEN DO:
        ...
        /*RUN pdf_text_xy IN h_PDFinc ("Spdf", string(Solicitud.Fec_Solicitud, "99/99/9999"), pdf_LeftMargin("Spdf") + 132, pdf_PageHeight("Spdf") - 743 + linea * 36 - interlineado).
        ...
        IF AVAILABLE(facultades) THEN DO:
            ...
            facultadTexto = facultades.nombre.
        END.
        ...
        IF AVAILABLE(facultades) THEN DO:
            ...
            departamentoTexto = facultades.nombre.
        END.
        ...
        RUN pdf_text_xy IN h_PDFinc ("Spdf", "Así mismo, FODUN cuenta con su propio esquema de SARLAFT, por el cual todos las operaciones del Fondo serán revisadas para disminuir el riesgo de LAFT, por lo que entiendo que la información", pdf_LeftMargin("Spdf") + 23, iHeight - 743 + linea2 * 79).
        ...
        /* Tercera página*/
        /*IF Solicitud.FOR_Pago = 2 THEN DO:
            ...
            DO WHILE i < 3:
                ...
                RUN pdf_rect2 IN h_PDFinc ("Spdf", 30, iHeight - 743, iWidth - 2 * 30, linea * 36, 1).
                RUN pdf_stroke_fill IN h_PDFinc ("Spdf",1.0,1.0,1.0).
                RUN pdf_rect IN h_PDFinc ("Spdf", 40, iHeight - 743 + linea * 1, (iWidth - 2 * 30) - 20, linea * 5, 1).
                RUN pdf_rect IN h_PDFinc ("Spdf", 40, iHeight - 743 + linea * 1, (iWidth - 2 * 30) - 190, linea * 5, 1).
                RUN pdf_rect IN h_PDFinc ("Spdf", (iWidth - 2 * 30) - 150, iHeight - 743 + linea * 1, 170, linea + 3, 1).
                RUN pdf_rect IN h_PDFinc ("Spdf", (iWidth - 2 * 30) - 150, iHeight - 743 + linea * 2 + 3, 170, linea + 3, 1).
                RUN pdf_rect IN h_PDFinc ("Spdf", (iWidth - 2 * 30) - 150, iHeight - 743 + linea * 3 + 3, 170, linea + 3, 1).
                
                RUN pdf_rect IN h_PDFinc ("Spdf", 40, iHeight - 743 + linea * 32, (iWidth - 2 * 30) - 20, linea * 3 + 10, 1).
                RUN pdf_rect IN h_PDFinc ("Spdf", 40, iHeight - 743 + linea * 32, (iWidth - 2 * 30) - 200, linea * 3 + 10, 1).
                ...
                RUN pdf_set_font IN h_PDFinc ("Spdf","Futura-bold", 12).
                RUN pdf_text_xy IN h_PDFinc ("Spdf", string(Solicitud.fec_primerPago, "99/99/9999"), pdf_LeftMargin("Spdf") + 395, iHeight - 743 + linea * 33).
                
                IF facultadTexto = "" THEN
                    facultadTexto = "_________________".
                IF departamentoTexto = "" THEN
                    departamentoTexto = "_________________".
        
                IF facultadTexto <> "Pensionados" AND departamentoTexto <> "Pensionado" AND departamentoTexto <> "Pensionados" THEN DO:
                    RUN pdf_set_font IN h_PDFinc ("Spdf","Futura", 12).
                    RUN pdf_text_xy IN h_PDFinc ("Spdf", Agencias.Nombre + ", " + string(NOW, "99-99-9999"), pdf_LeftMargin("Spdf") + 30, iHeight - 743 + linea * 31).
                    RUN pdf_text_xy IN h_PDFinc ("Spdf", "Señor", pdf_LeftMargin("Spdf") + 30, iHeight - 743 + linea * 29).
                    RUN pdf_set_font IN h_PDFinc ("Spdf","Futura-bold", 12).
                    RUN pdf_text_xy IN h_PDFinc ("Spdf", "JEFE SECCIÓN NÓMINA Y REGISTRO", pdf_LeftMargin("Spdf") + 30, iHeight - 743 + linea * 28).
                    RUN pdf_text_xy IN h_PDFinc ("Spdf", "UNIVERSIDAD NACIONAL DE COLOMBIA", pdf_LeftMargin("Spdf") + 30, iHeight - 743 + linea * 27).
                    RUN pdf_set_font IN h_PDFinc ("Spdf","Futura", 12).
                    RUN pdf_text_xy IN h_PDFinc ("Spdf", "Ciudad.", pdf_LeftMargin("Spdf") + 30, iHeight - 743 + linea * 26).
                    RUN pdf_text_xy IN h_PDFinc ("Spdf", "El suscrito " + Clientes.Nombre + " " + clientes.apellido1 + " " + clientes.apellido2 + " identificado con la C.C." + clientes.nit, pdf_LeftMargin("Spdf") + 30, iHeight - 743 + linea * 24).
                    RUN pdf_text_xy IN h_PDFinc ("Spdf", "de la Facultad de " + facultadTexto + " y la escuela o dpto. de " + departamentoTexto + ",", pdf_LeftMargin("Spdf") + 30, iHeight - 743 + linea * 23).
                    RUN pdf_text_xy IN h_PDFinc ("Spdf", "autorizo al señor Pagador General de la Universidad Nacional de Colombia, para que descuente", pdf_LeftMargin("Spdf") + 30, iHeight - 743 + linea * 22).
                    RUN pdf_text_xy IN h_PDFinc ("Spdf", "de mi salario a favor del Fondo de Empleados Docentes de la Universidad Nacional de Colombia", pdf_LeftMargin("Spdf") + 30, iHeight - 743 + linea * 21).
                    RUN pdf_text_xy IN h_PDFinc ("Spdf", "- FODUN, " + string(Solicitud.Plazo / 30) + " cuotas mensuales de $" + string(Solicitud.Cuota, ">>>,>>>,>>9") + " c/u.", pdf_LeftMargin("Spdf") + 30, iHeight - 743 + linea * 20).
                    RUN pdf_text_xy IN h_PDFinc ("Spdf", "Así mismo autorizo al señor Pagador para que en caso de mi retiro definitivo de la Universidad, y", pdf_LeftMargin("Spdf") + 30, iHeight - 743 + linea * 18).
                    RUN pdf_text_xy IN h_PDFinc ("Spdf", "aún tenga salgo insoluto de la referida obligación con FODUN, me efectúe el descuento de dicho", pdf_LeftMargin("Spdf") + 30, iHeight - 743 + linea * 17).
                    RUN pdf_text_xy IN h_PDFinc ("Spdf", "saldo de las Prestaciones Sociales que me sean liquidadas por la Universidad.", pdf_LeftMargin("Spdf") + 30, iHeight - 743 + linea * 16).
                END.
                ELSE DO:
                    RUN pdf_set_font IN h_PDFinc ("Spdf","Futura", 12).
                    RUN pdf_text_xy IN h_PDFinc ("Spdf", "Bogotá D.C., " + string(NOW, "99-99-9999"), pdf_LeftMargin("Spdf") + 30, iHeight - 743 + linea * 31).
                    RUN pdf_text_xy IN h_PDFinc ("Spdf", "Señor", pdf_LeftMargin("Spdf") + 30, iHeight - 743 + linea * 29).
                    RUN pdf_set_font IN h_PDFinc ("Spdf","Futura-bold", 12).
                    RUN pdf_text_xy IN h_PDFinc ("Spdf", "PAGADOR GENERAL", pdf_LeftMargin("Spdf") + 30, iHeight - 743 + linea * 28).
                    RUN pdf_text_xy IN h_PDFinc ("Spdf", "Dirección Nacional del Fondo Pensional de la Universidad Nacional de Colombia", pdf_LeftMargin("Spdf") + 30, iHeight - 743 + linea * 27).
                    RUN pdf_set_font IN h_PDFinc ("Spdf","Futura", 12).
                    RUN pdf_text_xy IN h_PDFinc ("Spdf", "Ciudad.", pdf_LeftMargin("Spdf") + 30, iHeight - 743 + linea * 26).
                    RUN pdf_text_xy IN h_PDFinc ("Spdf", "El suscrito " + Clientes.Nombre + " " + clientes.apellido1 + " " + clientes.apellido2 + " identificado con la C.C." + clientes.nit, pdf_LeftMargin("Spdf") + 30, iHeight - 743 + linea * 22).
                    RUN pdf_text_xy IN h_PDFinc ("Spdf", "autorizo al señor Pagador General de la Dirección Nacional del Fondo Pensional de la Universidad", pdf_LeftMargin("Spdf") + 30, iHeight - 743 + linea * 21).
                    RUN pdf_text_xy IN h_PDFinc ("Spdf", "Nacional de Colombia, para que descuente de mi MESADA PENSIONAL, a favor del Fondo de", pdf_LeftMargin("Spdf") + 30, iHeight - 743 + linea * 20).
                    RUN pdf_text_xy IN h_PDFinc ("Spdf", "Empleados Docentes de la Universidad Nacional de Colombia - FODUN, " + string(Solicitud.Plazo / 30) + " cuotas mensuales", pdf_LeftMargin("Spdf") + 30, iHeight - 743 + linea * 19).
                    RUN pdf_text_xy IN h_PDFinc ("Spdf", "de $" + string(Solicitud.Cuota, ">>>,>>>,>>9") + " c/u.", pdf_LeftMargin("Spdf") + 30, iHeight - 743 + linea * 18).
                END.
        
                RUN pdf_text_xy IN h_PDFinc ("Spdf", "Atentamente,", pdf_LeftMargin("Spdf") + 30, iHeight - 743 + linea * 13).
                RUN pdf_text_xy IN h_PDFinc ("Spdf","_________________________", pdf_LeftMargin("Spdf") + 30, iHeight - 743 + linea * 10).
                RUN pdf_text_xy IN h_PDFinc ("Spdf","Dirección de residencia: " + clientes.dir_residencia, pdf_LeftMargin("Spdf") + 30, iHeight - 743 + linea * 9).
                RUN pdf_text_xy IN h_PDFinc ("Spdf","Teléfonos: " + clientes.celular + " " + clientes.tel_residencia, pdf_LeftMargin("Spdf") + 30, iHeight - 743 + linea * 8).
        
                RUN pdf_text_xy IN h_PDFinc ("Spdf","Observaciones:", pdf_LeftMargin("Spdf") + 40, iHeight - 743 + linea * 5).
                RUN pdf_set_font IN h_PDFinc ("Spdf","Futura-bold", 12).
                RUN pdf_text_xy IN h_PDFinc ("Spdf","NÓMINA Y REGISTRO", pdf_LeftMargin("Spdf") + 415, iHeight - 743 + linea * 5).
                RUN pdf_set_font IN h_PDFinc ("Spdf","Futura", 12).
                RUN pdf_text_xy IN h_PDFinc ("Spdf","Firma", pdf_LeftMargin("Spdf") + 402, iHeight - 743 + linea * 4 - 10).
                RUN pdf_text_xy IN h_PDFinc ("Spdf","Cargo", pdf_LeftMargin("Spdf") + 402, iHeight - 743 + linea * 3 - 10).
                RUN pdf_text_xy IN h_PDFinc ("Spdf","Fecha", pdf_LeftMargin("Spdf") + 402, iHeight - 743 + linea * 2 - 12).
                i = i + 1.
            END.
        END.*/
    END.  
