...
DEFINE INPUT PARAMETER l-file AS CHARACTER.
...
&Scoped-Define ENABLED-OBJECTS btnLoad 
...
DEFINE FRAME DEFAULT-FRAME
     btnLoad AT ROW 24.42 COL 1
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 139.57 BY 24.62.
...
/* SETTINGS FOR FRAME DEFAULT-FRAME
   FRAME-NAME                                                           */
ASSIGN 
       btnLoad:HIDDEN IN FRAME DEFAULT-FRAME           = TRUE.
...
/* CtrlFrame OCXINFO:CREATE-CONTROL from: {CA8A9780-280D-11CF-A24D-444553540000} type: Pdf */
      CtrlFrame:MOVE-BEFORE(btnLoad:HANDLE IN FRAME DEFAULT-FRAME).
...
ON END-ERROR OF C-Win /* Visor PDF */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* Visor PDF */
DO:
...
END.
ELSE MESSAGE "visorPDF.wrx":U SKIP(1)
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE visualizarPDF C-Win 
