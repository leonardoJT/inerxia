...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW wWin ASSIGN
         HIDDEN             = YES
         TITLE              = "Consulta Descripcion Estadisticas Saro"
         HEIGHT             = 21.5
         WIDTH              = 62.86
         MAX-HEIGHT         = 28.81
         MAX-WIDTH          = 146.14
...
ON END-ERROR OF wWin /* Consulta Descripcion Estadisticas Saro */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL wWin wWin
ON WINDOW-CLOSE OF wWin /* Consulta Descripcion Estadisticas Saro */
DO:
  ...
  CASE currentPage: 
    ...
    WHEN 0 THEN DO:
       RUN constructObject (
             ...
             OUTPUT h_dcfg_saro ).
       RUN repositionObject IN h_dcfg_saro ( 1.00 , 56.00 ) NO-ERROR.
       ...
       RUN addLink ( h_dcfg_saro , 'Data':U , h_dynbrowser-2 ).
       RUN addLink ( h_dynbrowser-2 , 'Update':U , h_dcfg_saro ).
...
------------------------------------------------------------------------------*/
    IF LASTKEY = KEYCODE("ENTER") THEN DO:
         CASE R_Busca:
             ...
             DYNAMIC-FUNCTION('closeQuery':U IN h_dcfg_saro).
             DYNAMIC-FUNCTION('setQueryWhere':U IN h_dcfg_saro,
                 INPUT STRING(cfg_saro.Cod_Nivel,'999999') = W_Busca:SCREEN-VALUE IN FRAME {&FRAME-NAME}).  
             DYNAMIC-FUNCTION('openQuery':U IN h_dcfg_saro).
         END.
         WHEN 2 THEN DO:
             /*cerrando los query principal y abriendo uno de la seleccion */
             DYNAMIC-FUNCTION('closeQuery':U IN h_dcfg_saro).
             DYNAMIC-FUNCTION('setQueryWhere':U IN h_dcfg_saro,
                 INPUT Cfg_Saro.Nombre = W_Busca:SCREEN-VALUE IN FRAME {&FRAME-NAME}).  
             DYNAMIC-FUNCTION('openQuery':U IN h_dcfg_saro).  
         END.
         END CASE.
