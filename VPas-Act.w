...
&Scoped-Define DISPLAYED-OBJECTS nom_cliente 
...
DEFINE FRAME F-Main
     RowObject.Nit AT ROW 1.27 COL 8 COLON-ALIGNED WIDGET-ID 2
          VIEW-AS FILL-IN 
          SIZE 34.14 BY .81
          BGCOLOR 17 
     nom_cliente AT ROW 2.31 COL 8.14 COLON-ALIGNED WIDGET-ID 4
     RECT-306 AT ROW 1 COL 1 WIDGET-ID 6
...
/* SETTINGS FOR FILL-IN nom_cliente IN FRAME F-Main
   NO-ENABLE                                                            */
