...
DO:
    ...
    IF AVAILABLE BClientes THEN DO:
        ...
        R_Apellido1 = BClientes.Apellido1.
    ...
    ELSE DO:
        ...
        IF Cmb_Relaciones:SCREEN-VALUE IN FRAME F_Relaciones = "00003 - Rep.Legal Infantil" OR
           R_Relacion:SCREEN-VALUE = "Padre" OR
           R_Relacion:SCREEN-VALUE = "Madre" THEN DO:
            MESSAGE "El número de identificación no ha sido matriculado como Cliente ni Como Asociado"
                VIEW-AS ALERT-BOX.
