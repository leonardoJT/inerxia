...
DEFINE INPUT PARAMETER pCodAporte AS INTEGER.
...
FIND FIRST ahorros WHERE ahorros.nit = pNit
                     AND ahorros.cod_ahorro = pCodAporte
...
IF AVAILABLE ahorros THEN DO:
    ...
    IF NOT AVAILABLE cortoLargo THEN DO:
        MESSAGE "No se encuentra configuración contable para el producto de Aportes." SKIP
