...
END.
ELSE DO:
  IF Empleados.Fec_Ingreso EQ ? THEN DO:
     MESSAGE "Falta configurar la fecha de ingreso para poder" SKIP
             "realizar el calculo de este proceso al empleado: " Empleados.Nit
             VIEW-AS ALERT-BOX.
  END.
  ELSE DO:
