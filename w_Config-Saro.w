...
&Scoped-define FRAME-NAME F_ConfigSaro
...
DEFINE VARIABLE h_dcfg_saro2 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_dcfg_saro3 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_dcontroles_saro AS HANDLE NO-UNDO.
...
DEFINE VARIABLE h_vcontroles_sarowi AS HANDLE NO-UNDO.
DEFINE VARIABLE h_vsaroanalisis-2 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_vsaroprobabilidad AS HANDLE NO-UNDO.
DEFINE VARIABLE h_vsaroseveridad AS HANDLE NO-UNDO.
...
DEFINE FRAME F_ConfigSaro
     ...
     "DESCRIPCION ESTADISTICAS SARO" VIEW-AS TEXT
          SIZE 35 BY .62 AT ROW 1.81 COL 35.14 WIDGET-ID 66
          FONT 1
...
/* SETTINGS FOR FRAME F_ConfigSaro
   FRAME-NAME                                                           */
/* SETTINGS FOR BUTTON BUTTON-155 IN FRAME F_ConfigSaro
   NO-ENABLE                                                            */
...
ON END-ERROR OF wWin /* Configuración Saro */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL wWin wWin
ON WINDOW-CLOSE OF wWin /* Configuración Saro */
DO:
...
ON CHOOSE OF Btn_Consulta IN FRAME F_ConfigSaro /* Button 10 */
DO:
  IF W_Nuevo THEN
     RETURN.
...
ON CHOOSE OF Btn_Imprimir IN FRAME F_ConfigSaro /* Button 8 */
DO:
  DEFINE VAR Listado AS CHARACTER INITIAL "".
  Listado = W_Pathspl + "L-ConfSaro.lst".
...
ON CHOOSE OF Btn_Salir IN FRAME F_ConfigSaro /* Salir */
DO:
...
ON CHOOSE OF BUTTON-1 IN FRAME F_ConfigSaro /* Button 1 */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE currentPage: 
    ...
    WHEN 0 THEN DO:
       RUN constructObject (
             INPUT  'dcontroles_saro.wDB-AWARE':U ,
             INPUT  FRAME F_ConfigSaro:HANDLE ,
             INPUT  'AppServiceASInfoASUsePrompt?CacheDuration0CheckCurrentChangedyesDestroyStatelessyesDisconnectAppServernoServerOperatingModeNONEShareDatanoUpdateFromSourcenoForeignFieldsObjectNamedcontroles_saroOpenOnInityesPromptColumns(NONE)PromptOnDeleteyesRowsToBatch200RebuildOnReposnoToggleDataTargetsyes':U ,
             OUTPUT h_dcontroles_saro ).
       RUN repositionObject IN h_dcontroles_saro ( 1.00 , 79.00 ) NO-ERROR.
       ...
       RUN constructObject (
             ...
             OUTPUT h_dcfg_saro1 ).
       RUN repositionObject IN h_dcfg_saro1 ( 20.65 , 87.00 ) NO-ERROR.
       /* Size in AB:  ( 1.50 , 7.72 ) */
       ...
       RUN constructObject (
             ...
             INPUT  'AppServiceASInfoASUsePrompt?CacheDuration0CheckCurrentChangedyesDestroyStatelessyesDisconnectAppServernoServerOperatingModeNONEShareDatanoUpdateFromSourcenoForeignFieldsObjectNamedcfg_saroOpenOnInityesPromptColumns(NONE)PromptOnDeleteyesRowsToBatch200RebuildOnReposnoToggleDataTargetsyes':U ,
             OUTPUT h_dcfg_saro2 ).
       RUN repositionObject IN h_dcfg_saro2 ( 20.65 , 78.00 ) NO-ERROR.
       /* Size in AB:  ( 1.50 , 7.72 ) */
       ...
       RUN constructObject (
             ...
             INPUT  'AppServiceASInfoASUsePrompt?CacheDuration0CheckCurrentChangedyesDestroyStatelessyesDisconnectAppServernoServerOperatingModeNONEShareDatanoUpdateFromSourcenoForeignFieldsObjectNamedcfg_saroOpenOnInityesPromptColumns(NONE)PromptOnDeleteyesRowsToBatch200RebuildOnReposnoToggleDataTargetsyes':U ,
             OUTPUT h_dcfg_saro3 ).
       RUN repositionObject IN h_dcfg_saro3 ( 20.65 , 69.00 ) NO-ERROR.
       /* Size in AB:  ( 1.50 , 7.72 ) */

       RUN constructObject (
             INPUT  'adm2/folder.w':U ,
             INPUT  FRAME F_ConfigSaro:HANDLE ,
             INPUT  'FolderLabels':U + 'Severidad|Probabilidad|Analisis|Controles' + 'FolderTabWidth22FolderFont-1HideOnInitnoDisableOnInitnoObjectLayout':U ,
             OUTPUT h_folder ).
       ...
       RUN adjustTabOrder ( h_folder ,
             BUTTON-1:HANDLE IN FRAME F_ConfigSaro , 'AFTER':U ).
    END. /* Page 0 */
    WHEN 1 THEN DO:
       RUN constructObject (
             INPUT  'vsaroseveridad.w':U ,
             INPUT  FRAME F_ConfigSaro:HANDLE ,
             INPUT  'EnabledObjFldsToDisable?ModifyFields(All)DataSourceNamesUpdateTargetNamesLogicalObjectNameLogicalObjectNamePhysicalObjectNameDynamicObjectnoRunAttributeHideOnInitnoDisableOnInitnoObjectLayout':U ,
             OUTPUT h_vsaroseveridad ).
       RUN repositionObject IN h_vsaroseveridad ( 4.12 , 3.86 ) NO-ERROR.
       /* Size in AB:  ( 10.35 , 90.43 ) */

       RUN constructObject (
             INPUT  'adm2/dynbrowser.w':U ,
             INPUT  FRAME F_ConfigSaro:HANDLE ,
             INPUT  'DisplayedFieldsCod_Nivel,Nombre,Util_Neta,Val_Detallada,Descripcion,EstadoEnabledFieldsBrowseColumnTypesBrowseColumnItemsBrowseColumnItemPairsBrowseColumnInnerLinesBrowseColumnSortsBrowseColumnMaxCharsBrowseColumnAutoCompletionsBrowseColumnUniqueMatchesBrowseColumnDelimitersScrollRemotenoNumDown0CalcWidthnoMaxWidth80FetchOnReposToEndyesUseSortIndicatoryesSearchFieldDataSourceNamesdcfg_saroUpdateTargetNames?LogicalObjectNameHideOnInitnoDisableOnInitnoObjectLayout':U ,
             OUTPUT h_dynbrowser ).
       ...
       /* Links to SmartDataViewer h_vsaroseveridad. */
       RUN addLink ( h_dcfg_saro1 , 'Data':U , h_vsaroseveridad ).
       RUN addLink ( h_vsaroseveridad , 'Update':U , h_dcfg_saro1 ).
       RUN addLink ( h_pupdsav1 , 'TableIO':U , h_vsaroseveridad ).

       /* Links to SmartDataBrowser h_dynbrowser. */
       RUN addLink ( h_dcfg_saro1 , 'Data':U , h_dynbrowser ).

       /* Adjust the tab order of the smart objects. */
       RUN adjustTabOrder ( h_vsaroseveridad ,
             Btn_Imprimir:HANDLE IN FRAME F_ConfigSaro , 'AFTER':U ).
       RUN adjustTabOrder ( h_pupdsav1 ,
             Btn_Consulta:HANDLE IN FRAME F_ConfigSaro , 'AFTER':U ).
       RUN adjustTabOrder ( h_dynbrowser ,
             h_pupdsav1 , 'AFTER':U ).
    END. /* Page 1 */
    WHEN 2 THEN DO:
       RUN constructObject (
             INPUT  'vsaroprobabilidad.w':U ,
             INPUT  FRAME F_ConfigSaro:HANDLE ,
             INPUT  'EnabledObjFldsToDisable?ModifyFields(All)DataSourceNamesUpdateTargetNamesLogicalObjectNameLogicalObjectNamePhysicalObjectNameDynamicObjectnoRunAttributeHideOnInitnoDisableOnInitnoObjectLayout':U ,
             OUTPUT h_vsaroprobabilidad ).
       RUN repositionObject IN h_vsaroprobabilidad ( 4.12 , 3.86 ) NO-ERROR.
       /* Size in AB:  ( 10.27 , 90.57 ) */
       ...
       /* Links to SmartDataViewer h_vsaroprobabilidad. */
       RUN addLink ( h_dcfg_saro2 , 'Data':U , h_vsaroprobabilidad ).
       RUN addLink ( h_vsaroprobabilidad , 'Update':U , h_dcfg_saro2 ).
       RUN addLink ( h_pupdsav2 , 'TableIO':U , h_vsaroprobabilidad ).

       /* Links to SmartDataBrowser h_dynbrowser-2. */
       RUN addLink ( h_dcfg_saro2 , 'Data':U , h_dynbrowser-2 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjustTabOrder ( h_vsaroprobabilidad ,
             Btn_Imprimir:HANDLE IN FRAME F_ConfigSaro , 'AFTER':U ).
    ...
    WHEN 3 THEN DO:
       RUN constructObject (
             INPUT  'vsaroanalisis.w':U ,
             INPUT  FRAME F_ConfigSaro:HANDLE ,
             INPUT  'EnabledObjFldsToDisable?ModifyFields(All)DataSourceNamesUpdateTargetNamesLogicalObjectNameLogicalObjectNamePhysicalObjectNameDynamicObjectnoRunAttributeHideOnInitnoDisableOnInitnoObjectLayout':U ,
             OUTPUT h_vsaroanalisis-2 ).
       RUN repositionObject IN h_vsaroanalisis-2 ( 4.12 , 3.86 ) NO-ERROR.
       ...
       /* Links to SmartDataViewer h_vsaroanalisis-2. */
       RUN addLink ( h_dcfg_saro3 , 'Data':U , h_vsaroanalisis-2 ).
       RUN addLink ( h_vsaroanalisis-2 , 'Update':U , h_dcfg_saro3 ).
       RUN addLink ( h_pupdsav3 , 'TableIO':U , h_vsaroanalisis-2 ).

       /* Links to SmartDataBrowser h_dynbrowser-3. */
       RUN addLink ( h_dcfg_saro3 , 'Data':U , h_dynbrowser-3 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjustTabOrder ( h_vsaroanalisis-2 ,
             Btn_Imprimir:HANDLE IN FRAME F_ConfigSaro , 'AFTER':U ).
    ...
    WHEN 4 THEN DO:
       RUN constructObject (
             INPUT  'vcontroles_sarowi.w':U ,
             INPUT  FRAME F_ConfigSaro:HANDLE ,
             INPUT  'EnabledObjFldsToDisable?ModifyFields(All)DataSourceNamesUpdateTargetNamesLogicalObjectNameLogicalObjectNamePhysicalObjectNameDynamicObjectnoRunAttributeHideOnInitnoDisableOnInitnoObjectLayout':U ,
             OUTPUT h_vcontroles_sarowi ).
       RUN repositionObject IN h_vcontroles_sarowi ( 4.23 , 4.00 ) NO-ERROR.
       /* Size in AB:  ( 17.12 , 89.72 ) */
       ...
       /* Links to SmartDataViewer h_vcontroles_sarowi. */
       RUN addLink ( h_dcontroles_saro , 'Data':U , h_vcontroles_sarowi ).
       RUN addLink ( h_vcontroles_sarowi , 'Update':U , h_dcontroles_saro ).
       RUN addLink ( h_pupdsav , 'TableIO':U , h_vcontroles_sarowi ).

       /* Adjust the tab order of the smart objects. */
       RUN adjustTabOrder ( h_vcontroles_sarowi ,
             Btn_Imprimir:HANDLE IN FRAME F_ConfigSaro , 'AFTER':U ).
  ...
  IF currentPage eq 0
  THEN RUN selectPage IN THIS-PROCEDURE ( 4 ).
...
------------------------------------------------------------------------------*/
  ENABLE Btn_Salir RECT-2 RECT-291 BUTTON-1 Btn_Imprimir Btn_Consulta 
      WITH FRAME F_ConfigSaro IN WINDOW wWin.
  {&OPEN-BROWSERS-IN-QUERY-F_ConfigSaro}
  VIEW wWin.
END PROCEDURE.
...
chWorkSheet = chExcelApp:Sheets:Item(1).
 ...
 FOR EACH cfg_Saro NO-LOCK:
      E_Fila2     = "".
      E_Fila2     = "003" + STRING(cfg_Saro.Cod_Nivel,"999999")
                  + "005" + STRING(cfg_Saro.Nombre,"x(50)")
                  + "030" + STRING(cfg_Saro.Descripcion,"x(80)").
...
------------------------------------------------------------------------------*/
  ...
  RUN Tipo_Codigo IN h_dcfg_saro1 ( INPUT 1).
  RUN Tipo_Codigo IN h_dcfg_saro2 ( INPUT 2).
  RUN Tipo_Codigo IN h_dcfg_saro3 ( INPUT 3).

  /*cerrando los query principal y abriendo uno por cada pagina*/
  DYNAMIC-FUNCTION('closeQuery':U IN h_dcfg_saro1).
  DYNAMIC-FUNCTION('setQueryWhere':U IN h_dcfg_saro1,INPUT "Tipo = 1").
  DYNAMIC-FUNCTION('openQuery':U IN h_dcfg_saro1).

  DYNAMIC-FUNCTION('closeQuery':U IN h_dcfg_saro2).
  DYNAMIC-FUNCTION('setQueryWhere':U IN h_dcfg_saro2,INPUT "Tipo = 2").
  DYNAMIC-FUNCTION('openQuery':U IN h_dcfg_saro2).

  DYNAMIC-FUNCTION('closeQuery':U IN h_dcfg_saro3).
  DYNAMIC-FUNCTION('setQueryWhere':U IN h_dcfg_saro3,INPUT "Tipo = 3").
  DYNAMIC-FUNCTION('openQuery':U IN h_dcfg_saro3).
...
------------------------------------------------------------------------------*/
  ...
  DEFINE FRAME F-Analisis
   ...
   FOR EACH Cfg_Saro WHERE tipo = 1 NO-LOCK WITH FRAME a:
      IF Cfg_Saro.Estado = 1 THEN
        ASSIGN W_EstadoInf = "Activo".
      ELSE
        ASSIGN W_EstadoInf = "Inactivo". 
            
      DISPLAY Cfg_Saro.Cod_Nivel    
               Cfg_Saro.Nombre      FORMAT "x(15)"  AT 10
               (Cfg_Saro.Util_Neta / 100)           AT 27
               Cfg_Saro.Descripcion FORMAT "x(48)"  AT 80
               W_Estadoinf                          AT 130
   ...
   FOR EACH Cfg_Saro WHERE tipo = 2 NO-LOCK WITH FRAME b:
       IF Cfg_Saro.Estado = 1 THEN
         ASSIGN W_EstadoInf = "Activo".
       ELSE
         ASSIGN W_EstadoInf = "Inactivo". 
       ...
       DISPLAY Cfg_Saro.Cod_Nivel                      
               Cfg_Saro.Nombre      FORMAT "x(15)"    AT 10 
               Cfg_Saro.Descripcion FORMAT "x(40)"    AT 80 
               W_Estadoinf                            AT 130
...
/*    HIDE FRAME F-Probabilidad. */
   ...
   FOR EACH Cfg_Saro WHERE tipo = 3 NO-LOCK WITH FRAME c:
      IF Cfg_Saro.Estado = 1 THEN
        ASSIGN W_EstadoInf = "Activo".
      ELSE
        ASSIGN W_EstadoInf = "Inactivo". 

       DISPLAY Cfg_Saro.Cod_Analisis  
               Cfg_Saro.Nombre        FORMAT "x(30)" AT 80
               W_Estadoinf                           AT 130
