...
PROCEDURE ProcesoImprimir:
    ...
    DISPLAY "ENTIDAD         : FONDO EMPLEADOS DOCENTES UNIVERSIDAD NACIONAL DE COLOMBIA" SKIP
            "INFORME         : INFORME CONSOLIDADO"  SKIP
    ...
    DEFINE FRAME F_Mov
      ...
      DISPLAY SKIP(1)
              "Totales de Control:"
              ROUND(TotIni,0) FORMAT "->>,>>>,>>>,>>>,>>9.99" TO 48
              ROUND(TotDeb,0) FORMAT "->>,>>>,>>>,>>>,>>9.99" TO 70
              ROUND(TotCre,0) FORMAT "->>,>>>,>>>,>>>,>>9.99" TO 92
              ROUND(TotFin,0) FORMAT "->>,>>>,>>>,>>>,>>9.99" TO 117
