...
/* Abre un Excel nuevo y escribe en èl */
...
DEF VAR Columnas    AS CHA FORMAT "X" INIT "ABCDEFGHIJKLMNOPQRST".
   CREATE "Excel.Application" chExcelApp.
/* MANDA ENCABEZADO DE HOJA DE CALCULO*/
   ASSIGN Pos = 1 E_NumFila = 1 E_NumColumn = 4. /* Posicion Inicial, Fila y Nro de Columnas  */
   E_Fila = "010" + "FECHA     "                 /* Ancho de la columna + Contenido */
          + "011" + "COMPROBANTE"      
          + "007" + "AGENCIA"
          + "015" + "VALOR".
   chExcelApp:Visible = TRUE.                /* launch Excel so it is visible to the user */
   chWorkbook = chExcelApp:Workbooks:ADD().  /* create a new Workbook                     */
   ...
   FOR EACH mov_contable NO-LOCK WHERE nit = "55160966".
       ...
       IF E_NumFila EQ 1 THEN DO:
          DO I = 1 TO E_NumColumn BY 1:                          /* 1 TO Numero de Columnas                   */
