...
&Scoped-define BROWSE-NAME BROWSE-Caja

/* Internal Tables (found by Frame, Query & Browse Queries)             */
&Scoped-define INTERNAL-TABLES TTOpcCred TmpAho Asesoria

/* Definitions for BROWSE BROWSE-Caja                                   */
&Scoped-define FIELDS-IN-QUERY-BROWSE-Caja TPlazo TMOpcA /* TMOpcB */   
&Scoped-define ENABLED-FIELDS-IN-QUERY-BROWSE-Caja   
&Scoped-define SELF-NAME BROWSE-Caja
&Scoped-define QUERY-STRING-BROWSE-Caja FOR EACH TTOpcCred
&Scoped-define OPEN-QUERY-BROWSE-Caja OPEN QUERY {&SELF-NAME} FOR EACH TTOpcCred.
&Scoped-define TABLES-IN-QUERY-BROWSE-Caja TTOpcCred
&Scoped-define FIRST-TABLE-IN-QUERY-BROWSE-Caja TTOpcCred


/* Definitions for BROWSE BROWSE-Nomina                                 */
&Scoped-define FIELDS-IN-QUERY-BROWSE-Nomina TPlazo TMOpcA TMOpcB   
&Scoped-define ENABLED-FIELDS-IN-QUERY-BROWSE-Nomina   
&Scoped-define SELF-NAME BROWSE-Nomina
&Scoped-define QUERY-STRING-BROWSE-Nomina FOR EACH TTOpcCred
&Scoped-define OPEN-QUERY-BROWSE-Nomina OPEN QUERY {&SELF-NAME} FOR EACH TTOpcCred.
&Scoped-define TABLES-IN-QUERY-BROWSE-Nomina TTOpcCred
&Scoped-define FIRST-TABLE-IN-QUERY-BROWSE-Nomina TTOpcCred
...
/* Definitions for FRAME FRAME-PreScoring                               */
&Scoped-define FIELDS-IN-QUERY-FRAME-PreScoring Asesoria.Nit Asesoria.Monto ~
Asesoria.Val_IngresosMes 
&Scoped-define ENABLED-FIELDS-IN-QUERY-FRAME-PreScoring Asesoria.Nit ~
Asesoria.Monto 
&Scoped-define ENABLED-TABLES-IN-QUERY-FRAME-PreScoring Asesoria
&Scoped-define FIRST-ENABLED-TABLE-IN-QUERY-FRAME-PreScoring Asesoria
&Scoped-define OPEN-BROWSERS-IN-QUERY-FRAME-PreScoring ~
    ~{&OPEN-QUERY-BROWSE-Caja}~
    ~{&OPEN-QUERY-BROWSE-Nomina}
&Scoped-define QUERY-STRING-FRAME-PreScoring FOR EACH Asesoria SHARE-LOCK
&Scoped-define OPEN-QUERY-FRAME-PreScoring OPEN QUERY FRAME-PreScoring FOR EACH Asesoria SHARE-LOCK.
&Scoped-define TABLES-IN-QUERY-FRAME-PreScoring Asesoria
&Scoped-define FIRST-TABLE-IN-QUERY-FRAME-PreScoring Asesoria
...
&Scoped-Define ENABLED-OBJECTS Fpago BUTTON-1 BUTTON-2 BUTTON-3 Rs_PerPago ~
...
&Scoped-Define DISPLAYED-OBJECTS Fpago W_Telef W_PorEnd W_NomAsesor ~
...
DEFINE BUTTON BUTTON-Calcular 
     ...
     IMAGE-DOWN FILE "imagenes/proceso_g.bmp":U
     LABEL "Calcular" 
     SIZE 11 BY 2.42.

DEFINE VARIABLE FctaMax50 AS INTEGER FORMAT "->,>>>,>>>,>>9":U INITIAL 0 
     VIEW-AS FILL-IN 
     SIZE 18 BY .81
     BGCOLOR 18 FGCOLOR 15  NO-UNDO.

DEFINE VARIABLE FctaMaxSMLV AS INTEGER FORMAT "->,>>>,>>>,>>9":U INITIAL 0 
     VIEW-AS FILL-IN 
     SIZE 18 BY .81
     BGCOLOR 18 FGCOLOR 15  NO-UNDO.

DEFINE VARIABLE FCtaValSol50 AS INTEGER FORMAT "->,>>>,>>>,>>9":U INITIAL 0 
     VIEW-AS FILL-IN 
     SIZE 18 BY .81
     BGCOLOR 18 FGCOLOR 15  NO-UNDO.

DEFINE VARIABLE FEgreCap50 AS INTEGER FORMAT "->,>>>,>>>,>>9":U INITIAL 0 
     LABEL "Capacidad Al 50%" 
     VIEW-AS FILL-IN NATIVE 
     SIZE 18 BY .81
     BGCOLOR 15  NO-UNDO.

DEFINE VARIABLE FEgreCapSMLV AS INTEGER FORMAT "->,>>>,>>>,>>9":U INITIAL 0 
     LABEL "Capacidad Al SMMLV" 
     VIEW-AS FILL-IN NATIVE 
     SIZE 18 BY .81
     BGCOLOR 15  NO-UNDO.

DEFINE VARIABLE FEgreCIFIN AS INTEGER FORMAT ">,>>>,>>>,>>9":U INITIAL 0 
     LABEL "Cuota Cent. Riesgo" 
     VIEW-AS FILL-IN NATIVE 
     SIZE 18 BY .81
     BGCOLOR 15  NO-UNDO.

DEFINE VARIABLE FEgreMes50 AS INTEGER FORMAT "->,>>>,>>>,>>9":U INITIAL 0 
     VIEW-AS FILL-IN 
     SIZE 17 BY .81
     BGCOLOR 18 FGCOLOR 15  NO-UNDO.

DEFINE VARIABLE FEgreMesSMLV AS INTEGER FORMAT "->,>>>,>>>,>>9":U INITIAL 0 
     VIEW-AS FILL-IN 
     SIZE 17 BY .81
     BGCOLOR 18 FGCOLOR 15  NO-UNDO.

DEFINE VARIABLE FEgreNomina AS INTEGER FORMAT ">,>>>,>>>,>>9":U INITIAL 0 
     LABEL "Desc. Nómina" 
     VIEW-AS FILL-IN NATIVE 
     SIZE 18 BY .81
     BGCOLOR 15  NO-UNDO.

DEFINE VARIABLE FEgreSost AS DECIMAL FORMAT "->>,>>>,>>9.99":U INITIAL 0 
     LABEL "Gtos. Sostenimiento" 
     VIEW-AS FILL-IN NATIVE 
     SIZE 18 BY .81
     BGCOLOR 15  NO-UNDO.

DEFINE VARIABLE FEgreVivienda AS INTEGER FORMAT ">,>>>,>>>,>>9":U INITIAL 0 
     LABEL "Cuota Arri./Vivienda" 
     VIEW-AS FILL-IN NATIVE 
     SIZE 18 BY .81
     BGCOLOR 15  NO-UNDO.

DEFINE VARIABLE FIngBruto AS INTEGER FORMAT ">,>>>,>>>,>>9":U INITIAL 0 
     LABEL "Ing. Bruto" 
     VIEW-AS FILL-IN NATIVE 
     SIZE 18 BY .81
     BGCOLOR 15  NO-UNDO.

DEFINE VARIABLE FIngHonorarios AS INTEGER FORMAT ">,>>>,>>>,>>9":U INITIAL 0 
     LABEL "Honorarios" 
     VIEW-AS FILL-IN NATIVE 
     SIZE 18 BY .81
     BGCOLOR 15  NO-UNDO.

DEFINE VARIABLE FIngMes50 AS INTEGER FORMAT "->,>>>,>>>,>>9":U INITIAL 0 
     LABEL "Con Capac. al 50%" 
     VIEW-AS FILL-IN 
     SIZE 17 BY .81
     BGCOLOR 18 FGCOLOR 15  NO-UNDO.

DEFINE VARIABLE FIngMesSMLV AS INTEGER FORMAT "->,>>>,>>>,>>9":U INITIAL 0 
     LABEL "Con Capac. al SMMLV" 
     VIEW-AS FILL-IN 
     SIZE 17 BY .81
     BGCOLOR 18 FGCOLOR 15  NO-UNDO.

DEFINE VARIABLE FIngOtros AS INTEGER FORMAT ">,>>>,>>>,>>9":U INITIAL 0 
     LABEL "Otros Ing." 
     VIEW-AS FILL-IN NATIVE 
     SIZE 18 BY .81
     BGCOLOR 15  NO-UNDO.

DEFINE VARIABLE FPersCargo AS INTEGER FORMAT ">9":U INITIAL 0 
     LABEL "Pers. a Cargo" 
     VIEW-AS FILL-IN NATIVE 
     SIZE 5 BY .81
     BGCOLOR 15  NO-UNDO.

DEFINE VARIABLE FPlazo LIKE Asesoria.Plazo
     LABEL "Plazo" 
     VIEW-AS FILL-IN NATIVE 
     SIZE 6 BY .81
     BGCOLOR 15  NO-UNDO.

DEFINE VARIABLE FTasa AS DECIMAL FORMAT ">>9.9999999" INITIAL 0 
     LABEL "Tasa Nominal" 
     VIEW-AS FILL-IN 
     SIZE 14 BY .81
     BGCOLOR 18 FGCOLOR 15  NO-UNDO.

DEFINE VARIABLE FTEfectiva AS DECIMAL FORMAT "->9.9999999":U INITIAL 0 
     LABEL "Tasa Efec." 
     VIEW-AS FILL-IN 
     SIZE 11 BY .81
     BGCOLOR 18 FGCOLOR 15  NO-UNDO.
...
DEFINE VARIABLE RS-FrmPago AS INTEGER 
...
DEFINE VARIABLE Fpago AS INTEGER 
     VIEW-AS RADIO-SET HORIZONTAL
     RADIO-BUTTONS 
          "Caja", 1,
"Nomina", 2
...
/* Query definitions                                                    */
&ANALYZE-SUSPEND
DEFINE QUERY BROWSE-Caja FOR 
      TTOpcCred SCROLLING.

DEFINE QUERY BROWSE-Nomina FOR 
      TTOpcCred SCROLLING.

DEFINE QUERY B_Proyeccion FOR 
      TmpAho SCROLLING.

DEFINE QUERY FRAME-PreScoring FOR 
      Asesoria SCROLLING.
&ANALYZE-RESUME

/* Browse definitions                                                   */
DEFINE BROWSE BROWSE-Caja
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-Caja wWin _FREEFORM
  QUERY BROWSE-Caja DISPLAY
      TPlazo COLUMN-LABEL "PLAZO"                    FORMAT ">>9"
 TMOpcA COLUMN-LABEL "MONTO SUGERIDO PAGO POR CAJA"    FORMAT "->,>>>,>>>,>>9.99"
/*  TMOpcB COLUMN-LABEL "MONTO SUGERIDO SIN PERSONAS A CARGO"   FORMAT ">,>>>,>>>,>>9.99" */
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS SIZE 95 BY 4.31
         BGCOLOR 15  ROW-HEIGHT-CHARS .54 FIT-LAST-COLUMN.

DEFINE BROWSE BROWSE-Nomina
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-Nomina wWin _FREEFORM
  QUERY BROWSE-Nomina DISPLAY
      TPlazo COLUMN-LABEL "PLAZO"                    FORMAT ">>9"
 TMOpcA COLUMN-LABEL "MONTO SUGERIDO AL 50%"    FORMAT ">,>>>,>>>,>>9.99"
 TMOpcB COLUMN-LABEL "MONTO SUGERIDO AL SMLV"   FORMAT ">,>>>,>>>,>>9.99"
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS SIZE 95 BY 4.31
         BGCOLOR 15  ROW-HEIGHT-CHARS .54 FIT-LAST-COLUMN.
...
DEFINE FRAME F_Asesoria
     Fpago AT ROW 7.73 COL 15 NO-LABEL WIDGET-ID 2
     ...
     Cmb_TipoProductos AT ROW 3.73 COL 38 COLON-ALIGNED
     Cmb_Productos AT ROW 3.73 COL 56 COLON-ALIGNED NO-LABEL
     Asesoria.Nit AT ROW 3.85 COL 10 COLON-ALIGNED
          LABEL "Cédula" FORMAT "X(12)"
          VIEW-AS FILL-IN 
          SIZE 16.43 BY .81
          BGCOLOR 15 
     W_NomTitular AT ROW 5.04 COL 33 COLON-ALIGNED NO-LABEL FORMAT "X(50)":U
          VIEW-AS FILL-IN 
          SIZE 37.72 BY .81
          BGCOLOR 18 FGCOLOR 15 
     Asesoria.Monto AT ROW 5.58 COL 13 COLON-ALIGNED
          LABEL "Monto" FORMAT ">>>>>>,>>>,>>9"
          VIEW-AS FILL-IN 
          SIZE 16.43 BY .81
          BGCOLOR 15 
     Asesoria.Cuota AT ROW 10.15 COL 14 COLON-ALIGNED
          LABEL "Cuota" FORMAT ">>>>>>,>>>,>>9"
          VIEW-AS FILL-IN 
          SIZE 16.43 BY .81
          BGCOLOR 15 
     Rs_PerPago AT ROW 6.92 COL 4 NO-LABEL
     Asesoria.Plazo AT ROW 8.81 COL 19 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 11 BY .81
          BGCOLOR 15 
     Asesoria.For_Liquidacion AT ROW 12.04 COL 37 NO-LABEL
          VIEW-AS RADIO-SET VERTICAL
          RADIO-BUTTONS 
                    "Anticipado", 1,
"Vencido", 2
     ...
     Asesoria.Tasa AT ROW 7.62 COL 83.72 COLON-ALIGNED
          ...
          SIZE 11 BY .81
          BGCOLOR 18 FGCOLOR 15 
     Cmb_PerLiquidacion AT ROW 10.96 COL 34 COLON-ALIGNED
     Interes_PorPagar AT ROW 8.54 COL 83.72 COLON-ALIGNED NO-LABEL
     Btn_Salvar AT ROW 9.65 COL 101.43
     AS_Tasa AT ROW 11.46 COL 14.29 COLON-ALIGNED
...
"PreScoring", 3
     ...
     W_TManual AT ROW 12.23 COL 14.29 COLON-ALIGNED
     W_PromedDD AT ROW 12.85 COL 56 COLON-ALIGNED NO-LABEL
     ...
     "Prom.Ult-Trim.(A la Vista)" VIEW-AS TEXT
          SIZE 12 BY .65 AT ROW 11.23 COL 59
          FGCOLOR 7 
     ...
     RECT-281 AT ROW 11.77 COL 35
     RECT-284 AT ROW 1.27 COL 3.72
     RECT-300 AT ROW 10.92 COL 57
     RECT-301 AT ROW 9.23 COL 100.14
     RECT-316 AT ROW 2.81 COL 43
     RECT-278 AT ROW 5.31 COL 3 WIDGET-ID 6
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 113.14 BY 22.04
...
DEFINE FRAME FRAME-PreScoring
     Asesoria.Val_EgresosMes AT ROW 10.15 COL 8.14 HELP
          "" WIDGET-ID 24
          LABEL "EgresosMes" FORMAT ">>,>>>,>>>,>>9"
          VIEW-AS FILL-IN NATIVE 
          SIZE 3 BY .81
          BGCOLOR 10 FGCOLOR 15 
     RS-FrmPago AT ROW 1.42 COL 18 NO-LABEL WIDGET-ID 18
     FTasa AT ROW 1.46 COL 55 COLON-ALIGNED HELP
          "Ingrese la Tasa del producto al cual se brindo asesoria" WIDGET-ID 30
     Asesoria.Nit AT ROW 2.88 COL 15 COLON-ALIGNED WIDGET-ID 10
          LABEL "Id Asesorado" FORMAT "X(12)"
          VIEW-AS FILL-IN NATIVE 
          SIZE 18 BY .81
          BGCOLOR 15 
     W_NomTitular AT ROW 2.88 COL 34 COLON-ALIGNED NO-LABEL WIDGET-ID 12
     Asesoria.Monto AT ROW 3.81 COL 15 COLON-ALIGNED HELP
          "Ingrese el Monto del Prestamo" WIDGET-ID 32
          LABEL "Monto" FORMAT ">>>,>>>,>>>,>>9"
          VIEW-AS FILL-IN NATIVE 
          SIZE 18 BY .92
          BGCOLOR 15 
     FPlazo AT ROW 3.88 COL 42 COLON-ALIGNED HELP
          "Ingrese el Plazo otorgado al producto asesorado" WIDGET-ID 82
          LABEL "Plazo" FORMAT ">>>9"
          BGCOLOR 15 
     FPersCargo AT ROW 3.88 COL 76.14 COLON-ALIGNED WIDGET-ID 36
     FIngBruto AT ROW 5.85 COL 15 COLON-ALIGNED WIDGET-ID 54
     FIngOtros AT ROW 6.65 COL 15 COLON-ALIGNED WIDGET-ID 56
     FIngHonorarios AT ROW 7.46 COL 15 COLON-ALIGNED WIDGET-ID 58
     Asesoria.Val_IngresosMes AT ROW 8.81 COL 7.86 HELP
          "" WIDGET-ID 26
          LABEL "Ing. Mes" FORMAT ">>,>>>,>>>,>>9"
          VIEW-AS FILL-IN 
          SIZE 18 BY .81
          BGCOLOR 18 FGCOLOR 15 
     FEgreNomina AT ROW 5.85 COL 77 COLON-ALIGNED WIDGET-ID 68
     FEgreCap50 AT ROW 6.65 COL 77 COLON-ALIGNED WIDGET-ID 70
     FEgreCapSMLV AT ROW 7.46 COL 77 COLON-ALIGNED WIDGET-ID 72
     FEgreSost AT ROW 8.27 COL 77 COLON-ALIGNED WIDGET-ID 76
     FEgreVivienda AT ROW 9.08 COL 77 COLON-ALIGNED WIDGET-ID 78
     FEgreCIFIN AT ROW 9.88 COL 77 COLON-ALIGNED WIDGET-ID 80
     BUTTON-Calcular AT ROW 8.27 COL 45 WIDGET-ID 42
     FIngMes50 AT ROW 11.77 COL 22 COLON-ALIGNED WIDGET-ID 86
     FctaMax50 AT ROW 11.77 COL 58 COLON-ALIGNED NO-LABEL WIDGET-ID 90
     FCtaValSol50 AT ROW 11.77 COL 77 COLON-ALIGNED NO-LABEL WIDGET-ID 92
     FEgreMes50 AT ROW 11.81 COL 40 COLON-ALIGNED NO-LABEL WIDGET-ID 44
     FIngMesSMLV AT ROW 12.62 COL 22 COLON-ALIGNED WIDGET-ID 88
     FEgreMesSMLV AT ROW 12.65 COL 40 COLON-ALIGNED NO-LABEL WIDGET-ID 48
     FctaMaxSMLV AT ROW 12.65 COL 58 COLON-ALIGNED NO-LABEL WIDGET-ID 104
     BROWSE-Nomina AT ROW 13.92 COL 2 WIDGET-ID 200
     BROWSE-Caja AT ROW 13.92 COL 2 WIDGET-ID 300
     FTEfectiva AT ROW 1.46 COL 84.43 COLON-ALIGNED WIDGET-ID 106
     "INGRESOS" VIEW-AS TEXT
          SIZE 10 BY .62 AT ROW 5.04 COL 14.57 WIDGET-ID 62
          FGCOLOR 7 
     "EGRESOS" VIEW-AS TEXT
          SIZE 10 BY .62 AT ROW 5.04 COL 74.57 WIDGET-ID 66
          FGCOLOR 7 
     "Forma de Pago:" VIEW-AS TEXT
          SIZE 15 BY .62 AT ROW 1.62 COL 2 WIDGET-ID 22
     "INGR. NETOS            EGRESOS            CUOTA MAXIMA        CUOTA VALOR SOL." VIEW-AS TEXT
          SIZE 73 BY .62 AT ROW 11.08 COL 24.43 WIDGET-ID 94
          FGCOLOR 7 
     "Meses" VIEW-AS TEXT
          SIZE 7 BY .62 AT ROW 3.96 COL 50.43 WIDGET-ID 108
    WITH 1 DOWN KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 5.04
         SIZE 99 BY 17.77
...
/* DEFINE FRAME statement is approaching 4K Bytes.  Breaking it up   */
DEFINE FRAME FRAME-PreScoring
     RECT-318 AT ROW 6.92 COL 1 WIDGET-ID 2
     RECT-319 AT ROW 1.31 COL 17 WIDGET-ID 28
     RECT-320 AT ROW 2.62 COL 2 WIDGET-ID 38
     RECT-321 AT ROW 1.31 COL 41 WIDGET-ID 40
     RECT-322 AT ROW 10.96 COL 2 WIDGET-ID 50
     RECT-323 AT ROW 5.04 COL 2 WIDGET-ID 60
     RECT-324 AT ROW 5.04 COL 58 WIDGET-ID 64
    WITH 1 DOWN KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 5.04
         SIZE 99 BY 17.77
...
/* REPARENT FRAME */
ASSIGN FRAME FRAME-PreScoring:FRAME = FRAME F_Asesoria:HANDLE.

/* SETTINGS FOR FRAME FRAME-PreScoring
   Custom                                                               */
/* BROWSE-TAB BROWSE-Nomina FctaMaxSMLV FRAME-PreScoring */
/* BROWSE-TAB BROWSE-Caja BROWSE-Nomina FRAME-PreScoring */
/* SETTINGS FOR FILL-IN FctaMax50 IN FRAME FRAME-PreScoring
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN FctaMaxSMLV IN FRAME FRAME-PreScoring
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN FCtaValSol50 IN FRAME FRAME-PreScoring
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN FEgreCap50 IN FRAME FRAME-PreScoring
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN FEgreCapSMLV IN FRAME FRAME-PreScoring
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN FEgreMes50 IN FRAME FRAME-PreScoring
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN FEgreMesSMLV IN FRAME FRAME-PreScoring
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN FEgreSost IN FRAME FRAME-PreScoring
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN FIngMes50 IN FRAME FRAME-PreScoring
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN FIngMesSMLV IN FRAME FRAME-PreScoring
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN FPlazo IN FRAME FRAME-PreScoring
   LIKE = bdcentral.Asesoria.Plazo EXP-LABEL EXP-FORMAT EXP-HELP EXP-SIZE */
/* SETTINGS FOR FILL-IN FTasa IN FRAME FRAME-PreScoring
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN FTEfectiva IN FRAME FRAME-PreScoring
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN Asesoria.Monto IN FRAME FRAME-PreScoring
   EXP-LABEL EXP-FORMAT EXP-HELP                                        */
/* SETTINGS FOR FILL-IN Asesoria.Nit IN FRAME FRAME-PreScoring
   EXP-LABEL EXP-FORMAT                                                 */
/* SETTINGS FOR FILL-IN Asesoria.Val_EgresosMes IN FRAME FRAME-PreScoring
   NO-DISPLAY NO-ENABLE ALIGN-L EXP-LABEL EXP-FORMAT EXP-HELP           */
ASSIGN 
       Asesoria.Val_EgresosMes:HIDDEN IN FRAME FRAME-PreScoring           = TRUE.

/* SETTINGS FOR FILL-IN Asesoria.Val_IngresosMes IN FRAME FRAME-PreScoring
   NO-ENABLE ALIGN-L EXP-LABEL EXP-FORMAT EXP-HELP                      */
/* SETTINGS FOR FILL-IN W_NomTitular IN FRAME FRAME-PreScoring
   NO-ENABLE                                                            */
...
ASSIGN XXTABVALXX = FRAME FRAME-PreScoring:MOVE-AFTER-TAB-ITEM (Btn_Ingresar:HANDLE IN FRAME F_Asesoria)
       XXTABVALXX = FRAME FRAME-PreScoring:MOVE-BEFORE-TAB-ITEM (B_Proyeccion:HANDLE IN FRAME F_Asesoria)
/* END-ASSIGN-TABS */.

/* BROWSE-TAB B_Proyeccion FRAME-PreScoring F_Asesoria */
...
&ANALYZE-SUSPEND _QUERY-BLOCK BROWSE BROWSE-Caja
/* Query rebuild information for BROWSE BROWSE-Caja
     _START_FREEFORM
OPEN QUERY {&SELF-NAME} FOR EACH TTOpcCred.
     _END_FREEFORM
     _Query            is OPENED
*/  /* BROWSE BROWSE-Caja */
&ANALYZE-RESUME

&ANALYZE-SUSPEND _QUERY-BLOCK BROWSE BROWSE-Nomina
/* Query rebuild information for BROWSE BROWSE-Nomina
     _START_FREEFORM
OPEN QUERY {&SELF-NAME} FOR EACH TTOpcCred.
     _END_FREEFORM
     _Query            is OPENED
*/  /* BROWSE BROWSE-Nomina */
&ANALYZE-RESUME
...
&ANALYZE-SUSPEND _QUERY-BLOCK FRAME FRAME-PreScoring
/* Query rebuild information for FRAME FRAME-PreScoring
     _TblList          = "bdcentral.Asesoria"
     _Query            is OPENED
*/  /* FRAME FRAME-PreScoring */
&ANALYZE-RESUME
...
&Scoped-define FRAME-NAME FRAME-PreScoring
&Scoped-define SELF-NAME BUTTON-Calcular
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BUTTON-Calcular wWin
ON CHOOSE OF BUTTON-Calcular IN FRAME FRAME-PreScoring /* Calcular */
DO:
    DEFINE VARIABLE viIngBru AS INTEGER     NO-UNDO.    
    DEFINE VARIABLE viCuota  AS INTEGER     NO-UNDO.
    DEFINE VARIABLE viMontoA AS INTEGER     NO-UNDO.
    DEFINE VARIABLE viMontoB AS INTEGER     NO-UNDO.

    /* Validamos que los datos bsaicos se hayan ingresado*/
    FIND FIRST clientes WHERE clientes.nit EQ Asesoria.nit:SCREEN-VALUE IN FRAME FRAME-PreScoring NO-LOCK NO-ERROR.
    IF NOT AVAILABLE(Clientes) THEN DO:
        MESSAGE "Cliente no valido" SKIP
            "Por favor verifique"
            VIEW-AS ALERT-BOX INFO BUTTONS OK.
        APPLY "ENTRY":U TO Asesoria.nit.
        RETURN NO-APPLY.
    END.
    IF INTEGER(Asesoria.monto:SCREEN-VALUE IN FRAME FRAME-PreScoring) LE 0 THEN DO:
        MESSAGE "Por favor Ingrese el monto Solicitado"
            VIEW-AS ALERT-BOX INFO BUTTONS OK.
        APPLY "ENTRY":U TO Asesoria.monto.
        RETURN NO-APPLY.
    END.
    IF INTEGER(FEgreNomina:SCREEN-VALUE IN FRAME FRAME-PreScoring) LE 0 THEN  DO:
        MESSAGE "Por favor Ingrese el descuento de Nómina"
            VIEW-AS ALERT-BOX INFO BUTTONS OK.
        APPLY "ENTRY":U TO FEgreNomina.
        RETURN NO-APPLY.
    END.

    RUN calcEgrePS. /* Calcula ingresos PreScoring*/
    RUN calcIngPSNom. /* Calcula ingresos PreScoring*/
    
    CASE RS-FrmPago:SCREEN-VALUE:
        WHEN "1" THEN DO:
            RUN HCMONTO (INPUT DECIMAL(Asesoria.monto:SCREEN-VALUE IN FRAME FRAME-PreScoring),
                         INPUT DECIMAL(FTasa:SCREEN-VALUE IN FRAME FRAME-PreScoring),
                         INPUT DECIMAL(FPlazo:SCREEN-VALUE IN FRAME FRAME-PreScoring),
                         OUTPUT viCuota
                         ).
            ASSIGN FCtaValSol50:SCREEN-VALUE IN FRAME FRAME-PreScoring = STRING(viCuota).

            EMPTY TEMP-TABLE TTOpcCred.
            DO viCnt = 12 TO 60 BY 12:
                /* Opcion A */
                RUN HMontSug (INPUT DECIMAL(FctaMax50:SCREEN-VALUE IN FRAME FRAME-PreScoring),
                              INPUT DECIMAL(FTasa:SCREEN-VALUE IN FRAME FRAME-PreScoring),
                              INPUT viCnt,
                              OUTPUT viMontoA
                             ).
                /* Opcion B */
                RUN HMontSug (INPUT DECIMAL(FctaMaxSMLV:SCREEN-VALUE IN FRAME FRAME-PreScoring),
                              INPUT DECIMAL(FTasa:SCREEN-VALUE IN FRAME FRAME-PreScoring),
                              INPUT viCnt,
                              OUTPUT viMontoB
                             ).
            ...
            END.
            OPEN QUERY BROWSE-Nomina FOR EACH TTOpcCred.
        END.
        WHEN "2" THEN DO:
            IF INTEGER(FEgreMes50:SCREEN-VALUE IN FRAME FRAME-PreScoring) > 
                INTEGER(Asesoria.Val_IngresosMes:SCREEN-VALUE IN FRAME FRAME-PreScoring) THEN DO:
                MESSAGE "Los Egresos Superan los Ingresos." SKIP
                    "No hay Capacidad de pago." SKIP
                    "Por favor revise los datos."
                    VIEW-AS ALERT-BOX INFO BUTTONS OK TITLE "Capacidad Excedida".
                APPLY "ENTRY":U TO FEgreNomina.
                RETURN NO-APPLY.
            END.
            RUN HCMONTO (INPUT DECIMAL(Asesoria.monto:SCREEN-VALUE IN FRAME FRAME-PreScoring),
            ...
            DO viCnt = 12 TO 60 BY 12:
                ...
                UPDATE  TPlazo = viCnt
                        TMOpcA = viMontoA.
            END.
            OPEN QUERY BROWSE-Caja FOR EACH TTOpcCred.
        END.
    END CASE.
...
DO:
    CASE SELF:SCREEN-VALUE:
        ...
        END.
        OTHERWISE 
            ASSIGN FRAME FRAME-PreScoring:HIDDEN           = TRUE.
    END CASE.
...
ON VALUE-CHANGED OF Cmb_PerLiquidacion IN FRAME F_Asesoria
DO:
...
&Scoped-define FRAME-NAME FRAME-PreScoring
&Scoped-define SELF-NAME FctaMax50
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL FctaMax50 wWin
ON RETURN OF FctaMax50 IN FRAME FRAME-PreScoring
DO:
    APPLY "TAB".
    RETURN NO-APPLY.
END.
...
&Scoped-define SELF-NAME FctaMaxSMLV
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL FctaMaxSMLV wWin
ON RETURN OF FctaMaxSMLV IN FRAME FRAME-PreScoring
DO:
    APPLY "TAB".
    RETURN NO-APPLY.
END.
...
&Scoped-define SELF-NAME FCtaValSol50
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL FCtaValSol50 wWin
ON RETURN OF FCtaValSol50 IN FRAME FRAME-PreScoring
DO:
    APPLY "TAB".
    RETURN NO-APPLY.
END.
...
&Scoped-define SELF-NAME FEgreCap50
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL FEgreCap50 wWin
ON LEAVE OF FEgreCap50 IN FRAME FRAME-PreScoring /* Capacidad Al 50% */
DO:
   RUN calcEgrePS. /* Calcula ingresos PreScoring*/
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL FEgreCap50 wWin
ON RETURN OF FEgreCap50 IN FRAME FRAME-PreScoring /* Capacidad Al 50% */
DO:
    APPLY "TAB".
    RETURN NO-APPLY.
END.
...
&Scoped-define SELF-NAME FEgreCapSMLV
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL FEgreCapSMLV wWin
ON LEAVE OF FEgreCapSMLV IN FRAME FRAME-PreScoring /* Capacidad Al SMMLV */
DO:
   RUN calcEgrePS. /* Calcula ingresos PreScoring*/
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL FEgreCapSMLV wWin
ON RETURN OF FEgreCapSMLV IN FRAME FRAME-PreScoring /* Capacidad Al SMMLV */
DO:
    APPLY "TAB".
    RETURN NO-APPLY.
END.
...
&Scoped-define SELF-NAME FEgreCIFIN
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL FEgreCIFIN wWin
ON LEAVE OF FEgreCIFIN IN FRAME FRAME-PreScoring /* Cuota Cent. Riesgo */
DO:
   RUN calcEgrePS. /* Calcula ingresos PreScoring*/
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL FEgreCIFIN wWin
ON RETURN OF FEgreCIFIN IN FRAME FRAME-PreScoring /* Cuota Cent. Riesgo */
DO:
    APPLY "TAB".
    RETURN NO-APPLY.
END.
...
&Scoped-define SELF-NAME FEgreMes50
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL FEgreMes50 wWin
ON RETURN OF FEgreMes50 IN FRAME FRAME-PreScoring
DO:
    APPLY "TAB".
    RETURN NO-APPLY.
END.
...
&Scoped-define SELF-NAME FEgreMesSMLV
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL FEgreMesSMLV wWin
ON RETURN OF FEgreMesSMLV IN FRAME FRAME-PreScoring
DO:
    APPLY "TAB".
    RETURN NO-APPLY.
END.
...
&Scoped-define SELF-NAME FEgreNomina
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL FEgreNomina wWin
ON LEAVE OF FEgreNomina IN FRAME FRAME-PreScoring /* Desc. Nómina */
DO:
    DEFINE VARIABLE viIngresos AS INTEGER     NO-UNDO.
/*     ASSIGN viIngresos = INTEGER(FIngBruto:SCREEN-VALUE IN FRAME FRAME-PreScoring) + INTEGER(FIngOtros:SCREEN-VALUE IN FRAME FRAME-PreScoring). */
    IF INTEGER(SELF:SCREEN-VALUE IN FRAME FRAME-PreScoring) > INTEGER(FIngBruto:SCREEN-VALUE IN FRAME FRAME-PreScoring) THEN DO:
        MESSAGE "Descuento de Nómina Superior" SKIP
            "al Ingreso bruto." SKIP
            "Por favor verifique."
            VIEW-AS ALERT-BOX INFO BUTTONS OK.
        RETURN NO-APPLY.
    END.

    IF RS-FrmPago:SCREEN-VALUE IN FRAME FRAME-PreScoring EQ "1" THEN DO: /* Pago por Nómina*/
        RUN calcEgrePS. /* Calcula ingresos PreScoring*/
/*         APPLY "ENTRY":U TO BUTTON-Calcular. */
/*         RETURN NO-APPLY.                    */
    END.
    ELSE DO:  /* Pago por Caja*/
        RUN calcIngPSNom. /* Calcula ingresos PreScoring*/
        ASSIGN viIngresos = INTEGER(Asesoria.Val_IngresosMes:SCREEN-VALUE IN FRAME FRAME-PreScoring).
        RUN getPorcenCiudad (INPUT viIngresos, 
                             OUTPUT vdePorcenCiu).
        ASSIGN FEgreSost:SCREEN-VALUE = STRING((INTEGER(Asesoria.Val_IngresosMes:SCREEN-VALUE IN FRAME FRAME-PreScoring) -
                                                INTEGER(SELF:SCREEN-VALUE IN FRAME FRAME-PreScoring)) 
                                               * DECIMAL(vdePorcenCiu / 100)
                                              ).
/*         APPLY "ENTRY":U TO FEgreVivienda. */
/*         RETURN NO-APPLY.                  */
    END.

    RUN calcEgrePS. /* Calcula Egresos PreScoring*/
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL FEgreNomina wWin
ON RETURN OF FEgreNomina IN FRAME FRAME-PreScoring /* Desc. Nómina */
DO:
    APPLY "TAB".
    RETURN NO-APPLY.
END.
...
&Scoped-define SELF-NAME FEgreSost
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL FEgreSost wWin
ON LEAVE OF FEgreSost IN FRAME FRAME-PreScoring /* Gtos. Sostenimiento */
DO:
   RUN calcEgrePS. /* Calcula ingresos PreScoring*/
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL FEgreSost wWin
ON RETURN OF FEgreSost IN FRAME FRAME-PreScoring /* Gtos. Sostenimiento */
DO:
    APPLY "TAB".
    RETURN NO-APPLY.
END.
...
&Scoped-define SELF-NAME FEgreVivienda
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL FEgreVivienda wWin
ON LEAVE OF FEgreVivienda IN FRAME FRAME-PreScoring /* Cuota Arri./Vivienda */
DO:
   RUN calcEgrePS. /* Calcula ingresos PreScoring*/
/*    APPLY "ENTRY":U TO FEgreCIFIN. */
/*    RETURN NO-APPLY.               */
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL FEgreVivienda wWin
ON RETURN OF FEgreVivienda IN FRAME FRAME-PreScoring /* Cuota Arri./Vivienda */
DO:
    APPLY "TAB".
    RETURN NO-APPLY.
END.
...
&Scoped-define SELF-NAME FIngBruto
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL FIngBruto wWin
ON LEAVE OF FIngBruto IN FRAME FRAME-PreScoring /* Ing. Bruto */
DO:
    RUN calcIngPSNom. /* Calcula ingresos PreScoring*/
/*     APPLY "ENTRY":U TO FIngOtros. */
/*     RETURN NO-APPLY.              */
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL FIngBruto wWin
ON RETURN OF FIngBruto IN FRAME FRAME-PreScoring /* Ing. Bruto */
DO:
    APPLY "TAB".
    RETURN NO-APPLY.
END.
...
&Scoped-define SELF-NAME FIngHonorarios
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL FIngHonorarios wWin
ON LEAVE OF FIngHonorarios IN FRAME FRAME-PreScoring /* Honorarios */
DO:
    RUN calcIngPSNom. /* Calcula ingresos PreScoring*/
/*     APPLY "ENTRY":U TO FEgreNomina. */
/*     RETURN NO-APPLY.                */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL FIngHonorarios wWin
ON RETURN OF FIngHonorarios IN FRAME FRAME-PreScoring /* Honorarios */
DO:
    APPLY "TAB".
    RETURN NO-APPLY.
END.
...
&Scoped-define SELF-NAME FIngMes50
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL FIngMes50 wWin
ON RETURN OF FIngMes50 IN FRAME FRAME-PreScoring /* Con Capac. al 50% */
DO:
    APPLY "TAB".
    RETURN NO-APPLY.
END.
...
&Scoped-define SELF-NAME FIngMesSMLV
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL FIngMesSMLV wWin
ON RETURN OF FIngMesSMLV IN FRAME FRAME-PreScoring /* Con Capac. al SMMLV */
DO:
    APPLY "TAB".
    RETURN NO-APPLY.
END.
...
&Scoped-define SELF-NAME FIngOtros
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL FIngOtros wWin
ON LEAVE OF FIngOtros IN FRAME FRAME-PreScoring /* Otros Ing. */
DO:
    RUN calcIngPSNom. /* Calcula ingresos PreScoring*/
/*     APPLY "ENTRY":U TO FIngHonorarios. */
/*     RETURN NO-APPLY.                   */
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL FIngOtros wWin
ON RETURN OF FIngOtros IN FRAME FRAME-PreScoring /* Otros Ing. */
DO:
    APPLY "TAB".
    RETURN NO-APPLY.
END.
...
&Scoped-define SELF-NAME FPersCargo
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL FPersCargo wWin
ON LEAVE OF FPersCargo IN FRAME FRAME-PreScoring /* Pers. a Cargo */
DO:
    IF INTEGER(FEgreNomina:SCREEN-VALUE) <> 0 THEN DO:
        APPLY "LEAVE":U TO FEgreNomina.
    END.
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL FPersCargo wWin
ON RETURN OF FPersCargo IN FRAME FRAME-PreScoring /* Pers. a Cargo */
DO: 
    APPLY "TAB".
    RETURN NO-APPLY.
END.
...
&Scoped-define SELF-NAME FPlazo
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL FPlazo wWin
ON LEAVE OF FPlazo IN FRAME FRAME-PreScoring /* Plazo */
DO:
    IF INTEGER(SELF:SCREEN-VALUE) = 0 THEN DO:
        MESSAGE "El plazo debe ser mayor a 0" SKIP
            "Por favor verifique"
            VIEW-AS ALERT-BOX INFO BUTTONS OK TITLE "Plazo no válido".
        RETURN.
    END.       
    ASSIGN 
        Dias      = INTEG(SELF:SCREEN-VALUE) * 30
        W_DiaCred = 30.
    RUN getIndicador.
END.
...
&Scoped-define SELF-NAME Asesoria.Monto
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL Asesoria.Monto wWin
ON LEAVE OF Asesoria.Monto IN FRAME FRAME-PreScoring /* Monto */
DO:
    IF INTEGER(SELF:SCREEN-VALUE) = 0 THEN DO:
        MESSAGE "El Monto debe ser mayor a 0" SKIP
            "Por favor verifique"
            VIEW-AS ALERT-BOX INFO BUTTONS OK TITLE "Monto no válido".
        RETURN.
    END.
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL Asesoria.Monto wWin
ON RETURN OF Asesoria.Monto IN FRAME FRAME-PreScoring /* Monto */
DO:
    APPLY "TAB".
    RETURN NO-APPLY.
END.
...
ON LEAVE OF Asesoria.Nit IN FRAME FRAME-PreScoring /* Id Asesorado */
DO:
    IF (Asesoria.Clase_Producto:SCREEN-VALUE IN FRAME F_Asesoria EQ "1" AND NOT AVAIL Pro_Ahorros) OR (Asesoria.Clase_Producto:SCREEN-VALUE EQ "2" AND NOT AVAIL Pro_Creditos) 
    THEN DO:
    ...
    THEN ASSIGN W_NomTitular:SCREEN-VALUE   IN FRAME FRAME-PreScoring = CAPS(Clientes.Nombre + " " + Clientes.Apellido1 + " " + Clientes.Apellido2)
                Asesoria.Nit:SCREEN-VALUE   IN FRAME F_asesoria = P_Nit
                W_Nomtitular:SCREEN-VALUE   IN FRAME F_asesoria = CAPS(TRIM(P_Nombre) + " " + P_Apellido)
                FPersCargo:SCREEN-VALUE     IN FRAME FRAME-PreScoring =  STRING(Per_Acargo)
                FIngBruto:SCREEN-VALUE      IN FRAME FRAME-PreScoring =  STRING(Clientes.Salario)
                FIngHonorarios:SCREEN-VALUE IN FRAME FRAME-PreScoring =  STRING(Clientes.Ing_Honorarios) 
                FIngOtros:SCREEN-VALUE      IN FRAME FRAME-PreScoring =  STRING(Clientes.Ing_Otros)
                FEgreSost:SCREEN-VALUE      IN FRAME FRAME-PreScoring =  STRING(Clientes.Gto_Familiar)
                FEgreVivienda:SCREEN-VALUE  IN FRAME FRAME-PreScoring =  STRING(Clientes.Gto_Arriendo)
                FEgreNomina:SCREEN-VALUE    IN FRAME FRAME-PreScoring =  STRING(Clientes.Gto_obligacion)
                FEgreCIFIN:SCREEN-VALUE     IN FRAME FRAME-PreScoring =  STRING(Clientes.GtoFinanc_Indir). 
    ELSE DO:
        ...
        ASSIGN  Asesoria.Nit:SCREEN-VALUE  IN FRAME FRAME-PreScoring = P_Nit
                W_Nomtitular:SCREEN-VALUE  IN FRAME FRAME-PreScoring = CAPS(TRIM(P_Nombre) + " " + P_Apellido)
                Asesoria.Nit:SCREEN-VALUE  IN FRAME F_asesoria = P_Nit
                W_Nomtitular:SCREEN-VALUE  IN FRAME F_asesoria = CAPS(TRIM(P_Nombre) + " " + P_Apellido).
        APPLY "ENTRY" TO SELF.    
    END.
    ASSIGN vcNit = Clientes.nit.
    ...
    FIND FIRST Creditos 
        WHERE 
            Creditos.Nit         EQ Asesoria.Nit:SCREEN-VALUE 
        AND Creditos.Sdo_Capital GT 0 
        AND Creditos.Fec_Pago    LT W_Fecha NO-LOCK NO-ERROR.
    IF AVAIL(Creditos) 
    THEN MESSAGE "El solicitante tiene Crèditos en Mora en la Cooperativa..."
                    VIEW-AS ALERT-BOX TITLE "Alerta por Morosidad".
    IF  AVAIL(Clientes) AND (W_Fecha - Clientes.Fec_Nacimiento) / 364 GT 69 AND (W_Fecha - Clientes.Fec_Asociac) / 364 LT 3 
    THEN MESSAGE "El solicitante no califica como Sujeto de Crèdito..."
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL Asesoria.Nit wWin
ON RETURN OF Asesoria.Nit IN FRAME FRAME-PreScoring /* Id Asesorado */
DO:
    APPLY "TAB".
    RETURN NO-APPLY.
END.
...
&Scoped-define SELF-NAME Asesoria.Nit
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL Asesoria.Nit wWin
ON LEAVE OF Asesoria.Nit IN FRAME F_Asesoria /* Cédula */
DO:
  DO WITH FRAME F_Asesoria:
...
&Scoped-define FRAME-NAME FRAME-PreScoring
&Scoped-define SELF-NAME RS-FrmPago
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL RS-FrmPago wWin
ON ENTRY OF RS-FrmPago IN FRAME FRAME-PreScoring
DO:
    DISABLE Val_ingresosMes WITH FRAME frame-PreScoring.
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL RS-FrmPago wWin
ON VALUE-CHANGED OF RS-FrmPago IN FRAME FRAME-PreScoring
DO:
    
    CASE SELF:SCREEN-VALUE:
        WHEN "1" THEN DO: /* NOMINA */
            DISABLE 
                FPersCargo 
/*                 FEgreSost */
                FEgreVivienda
                FEgreCIFIN
                WITH FRAME frame-PreScoring.
            ASSIGN 
                FPersCargo:SCREEN-VALUE IN FRAME frame-PreScoring = ""
                FPersCargo:SCREEN-VALUE IN FRAME frame-PreScoring = ""
                FEgreSost:SCREEN-VALUE IN FRAME frame-PreScoring = ""    
                FEgreVivienda:SCREEN-VALUE IN FRAME frame-PreScoring = ""
                FEgreCIFIN:SCREEN-VALUE IN FRAME frame-PreScoring = "".
            ASSIGN 
                BROWSE-Nomina:HIDDEN = FALSE
                FIngMesSMLV:HIDDEN = FALSE
                FEgreMesSMLV:HIDDEN = FALSE
                FctaMaxSMLV:HIDDEN = FALSE
                BROWSE-Caja:HIDDEN = TRUE.
            ASSIGN 
                FIngMes50:LABEL = "Con Capac. al 50%"
                FIngMesSMLV:LABEL = "Con Capac. al SMLV".
        END.
        WHEN "2" THEN DO: /* CAJA */
            ENABLE 
                FPersCargo 
/*                 FEgreSost */
                ...
                WITH FRAME frame-PreScoring.
            ASSIGN 
                FEgreCap50:SCREEN-VALUE IN FRAME frame-PreScoring = "" 
                FEgreCapSMLV:SCREEN-VALUE IN FRAME frame-PreScoring = "".
            ASSIGN 
                BROWSE-Nomina:HIDDEN = TRUE
                FIngMesSMLV:HIDDEN = TRUE
                FEgreMesSMLV:HIDDEN = TRUE
                FctaMaxSMLV:HIDDEN = TRUE
                BROWSE-Caja:HIDDEN = FALSE.
            ASSIGN 
                FIngMes50:LABEL = "Con Pagos por Caja".

        END.
    END CASE.
    ASSIGN FIngMes50:SCREEN-VALUE IN FRAME frame-PreScoring = "" 
           FIngMesSMLV:SCREEN-VALUE IN FRAME frame-PreScoring = "" 
           FEgreMes50:SCREEN-VALUE IN FRAME frame-PreScoring = "" 
           FEgreMesSMLV:SCREEN-VALUE IN FRAME frame-PreScoring = "" 
           FctaMax50:SCREEN-VALUE IN FRAME frame-PreScoring = "" 
           FctaMaxSMLV:SCREEN-VALUE IN FRAME frame-PreScoring = "" 
           FCtaValSol50:SCREEN-VALUE IN FRAME frame-PreScoring = "".
    EMPTY TEMP-TABLE TTOpcCred.
    OPEN QUERY BROWSE-Nomina FOR EACH TTOpcCred.
    APPLY "ENTRY":U TO Asesoria.Nit IN FRAME FRAME-PreScoring.
END.
...
------------------------------------------------------------------------------*/
  DISPLAY Fpago W_Telef W_PorEnd W_NomAsesor Cmb_TipoProductos Cmb_Productos 
  ...
  IF AVAILABLE Asesoria THEN 
    DISPLAY Asesoria.Val_IngresosMes Asesoria.Val_EgresosMes Asesoria.Num_Asesoria 
      ...
      WITH FRAME F_Asesoria IN WINDOW wWin.
  ENABLE Fpago Asesoria.Val_IngresosMes Asesoria.Val_EgresosMes 
         Asesoria.Num_Asesoria Asesoria.Fec_Asesoria BUTTON-1 BUTTON-2 BUTTON-3 
         Asesoria.Nit Asesoria.Monto Asesoria.Cuota Rs_PerPago Asesoria.Plazo 
  ...
  {&OPEN-QUERY-FRAME-PreScoring}
  GET FIRST FRAME-PreScoring.
  DISPLAY RS-FrmPago FTasa W_NomTitular FPlazo FPersCargo FIngBruto FIngOtros 
          FIngHonorarios FEgreNomina FEgreCap50 FEgreCapSMLV FEgreSost 
          FEgreVivienda FEgreCIFIN FIngMes50 FctaMax50 FCtaValSol50 FEgreMes50 
          FIngMesSMLV FEgreMesSMLV FctaMaxSMLV FTEfectiva 
      WITH FRAME FRAME-PreScoring IN WINDOW wWin.
  IF AVAILABLE Asesoria THEN 
    DISPLAY Asesoria.Nit Asesoria.Monto Asesoria.Val_IngresosMes 
      WITH FRAME FRAME-PreScoring IN WINDOW wWin.
  ENABLE RS-FrmPago Asesoria.Nit Asesoria.Monto FPlazo FPersCargo FIngBruto 
         FIngOtros FIngHonorarios FEgreNomina FEgreVivienda FEgreCIFIN 
         BUTTON-Calcular BROWSE-Nomina BROWSE-Caja RECT-318 RECT-319 RECT-320 
         RECT-321 RECT-322 RECT-323 RECT-324 
      WITH FRAME FRAME-PreScoring IN WINDOW wWin.
  {&OPEN-BROWSERS-IN-QUERY-FRAME-PreScoring}
...
------------------------------------------------------------------------------*/
  ...
  IF AVAILABLE(Ran_Intereses) THEN DO:
     IF integer(fpago:SCREEN-VALUE) = 1 THEN
          AS_Tasa:SCREEN-VALUE = STRING(Indicadores.Tasa + Ran_Intereses.Puntos_Asoc).
     ELSE AS_Tasa:SCREEN-VALUE = STRING(Indicadores.Tasa + Ran_Intereses.Puntos).
  END.
  ELSE DO: 
    MESSAGE "El Indicador no tiene creado un rango que contemple" SKIP
           "los valores de Plazo y/o Monto digitados por el usuario" SKIP(1)
