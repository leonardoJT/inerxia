...
DEFINE VARIABLE h_dcuentas AS HANDLE NO-UNDO.
...
ON END-ERROR OF wWin /* Reporte - XXXXXXX - (prog.w) */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL wWin wWin
ON WINDOW-CLOSE OF wWin /* Reporte - XXXXXXX - (prog.w) */
DO:
  ...
  CASE currentPage: 
    ...
    WHEN 0 THEN DO:
       RUN constructObject (
             ...
             OUTPUT h_dcuentas ).
       RUN repositionObject IN h_dcuentas ( 7.46 , 101.00 ) NO-ERROR.
