...
FOR EACH anexos WHERE SUBSTRING(anexos.cuenta,1,8) = "61509512"
    ...
    IF FIRST-OF(anexos.nit) THEN DO:
        FIND FIRST F1001 WHERE F1001.nit = anexos.nit
                           AND F1001.concepto = "5003" NO-ERROR.
...
IF pOrigen = "E" THEN DO:
    FOR EACH F1001 WHERE F1001.concepto = "5003" NO-LOCK:
        totalReporte = totalReporte + F1001.pagosCostoDeduccion.
    END.

    FOR EACH sal_cuenta WHERE SUBSTRING(sal_cuenta.cuenta,1,8) = "61509512"
