...
&Scoped-Define ENABLED-OBJECTS Cmb-cedula Cmb-TarjetaDb Btn_Cancelar ~
Btn_Done RECT-338 RECT-337 
...
DEFINE BUTTON Btn_Done DEFAULT 
     ...
     LABEL "&Salir" 
     SIZE 10 BY 1.92 TOOLTIP "Sale de este proceso"
     BGCOLOR 8 .
...
DEFINE FRAME F-Main
     ...
     Tarjetas.Num_Credito AT ROW 8.12 COL 46.14 COLON-ALIGNED WIDGET-ID 70
          ...
          SIZE 14.29 BY .81
          BGCOLOR 18 FGCOLOR 15 
     Btn_Cancelar AT ROW 5.77 COL 87.43 WIDGET-ID 16
     Btn_Salvar AT ROW 5.77 COL 77.43 WIDGET-ID 18
     ...
     Tarjetas.Fec_ActCupo AT ROW 8.08 COL 61 COLON-ALIGNED NO-LABEL WIDGET-ID 82
          ...
          SIZE 12.57 BY .81
          BGCOLOR 18 FGCOLOR 15 
     Btn_Done AT ROW 5.77 COL 97.29 WIDGET-ID 20
     Btn-Visualizar AT ROW 7.73 COL 99 WIDGET-ID 8
     Tarjetas.MontoMaxCaj AT ROW 2.15 COL 64.86 COLON-ALIGNED WIDGET-ID 96
          VIEW-AS FILL-IN 
          SIZE 16 BY .81 TOOLTIP "Monto Máximo a Retirar en Cajeros"
     Tarjetas.OperMaxCaj AT ROW 2.08 COL 98.57 COLON-ALIGNED NO-LABEL WIDGET-ID 40
          VIEW-AS FILL-IN 
          SIZE 5 BY .81 TOOLTIP "Número Máximo de Retiros en Cajeros"
     Tarjetas.MontoMaxPos AT ROW 3.12 COL 64.86 COLON-ALIGNED WIDGET-ID 38
          VIEW-AS FILL-IN 
          SIZE 16.14 BY .81 TOOLTIP "Monto Máximo a Pagar en POS"
     Tarjetas.OperMaxPos AT ROW 3.15 COL 98.57 COLON-ALIGNED NO-LABEL WIDGET-ID 42
          VIEW-AS FILL-IN 
     ...
     " Configuración de Valores" VIEW-AS TEXT
          SIZE 25.14 BY .81 AT ROW 1.27 COL 50.86 WIDGET-ID 52
          FGCOLOR 1 
     "Nro.Oper.Pos:" VIEW-AS TEXT
          SIZE 14 BY .54 AT ROW 3.15 COL 86.86 WIDGET-ID 48
     "Nro.Oper.Cajero:" VIEW-AS TEXT
          SIZE 16.14 BY .81 AT ROW 2.08 COL 84.43 WIDGET-ID 46
     "Cédula" VIEW-AS TEXT
     ...
     RECT-337 AT ROW 1.85 COL 50 WIDGET-ID 50
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 107 BY 8.69 WIDGET-ID 100.
...
DO:
    ...
    ELSE DO:
        ...
        tarjetas.montoMaxCaj:SCREEN-VALUE = STRING(0).
        tarjetas.montoMaxPos:SCREEN-VALUE = STRING(0).
        tarjetas.operMaxCaj:SCREEN-VALUE = STRING(0).
        tarjetas.operMaxPos:SCREEN-VALUE = STRING(0).
    END.
...
------------------------------------------------------------------------------*/
  DISPLAY Cmb-cedula Cmb-TarjetaDb W_NomTitular W_NomAgencia 
  ...
  IF AVAILABLE Tarjetas THEN 
    DISPLAY Tarjetas.Cue_Ahorros Tarjetas.Num_Credito Tarjetas.Fec_Activacion 
      ...
      WITH FRAME F-Main IN WINDOW C-Win.
  ENABLE Cmb-cedula Cmb-TarjetaDb Btn_Cancelar Btn_Done RECT-338 RECT-337 
      WITH FRAME F-Main IN WINDOW C-Win.
