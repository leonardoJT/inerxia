...
REPEAT TRANSACTION ON ERROR UNDO ActFactura, LEAVE ActFactura:
    ...
    OUTPUT TO "c:\info_juriscoop\ErrorProd19Marzo870.txt".
    ...
    FOR EACH mov_contable WHERE 
        ...
        (mov_contable.nit NE "14980108" AND mov_contable.nit NE "5557186" AND 
         mov_contable.nit NE "37885099" AND mov_contable.nit NE "21407341")
        NO-LOCK BREAK
        ...
        FIND FIRST creditos WHERE
            ...
            (creditos.cod_credito EQ 870) /* OR creditos.cod_credito EQ 870)*/
            NO-ERROR.
...
/*                 mov_contable.Doc_Referencia EQ TempMovi.num_credito   AND */
                ...
                mov_contable.cuenta         BEGINS "25957016559505"
                EXCLUSIVE:
        ...
        ELSE
          IF TempMovi.Concepto = "Corrientes" THEN DO:
             FOR EACH mov_contable WHERE
                  ...
                  mov_contable.agencia        EQ TempMovi.agencont       AND      
                  mov_contable.fec_contable   EQ TempMovi.fec_contable  AND
                  mov_contable.cuenta         EQ "259570165518" 
                  EXCLUSIVE:
                  IF mov_contable.Db GT 0 THEN
                     UPDATE mov_contable.Db = TempMovi.Valor.
                  IF mov_contable.Cr GT 0 THEN
...
MESSAGE "Archivo Generado : " "c:\info_juriscoop\ErrorProd19Marzo870.txt"
