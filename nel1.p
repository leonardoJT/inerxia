...
DEFINE VARIABLE xfpro AS DATE.
DEFINE VARIABLE xdiasatr AS DECIMAL.


FOR EACH creditos WHERE nit = "80032299" AND num_credito = 34278:
  ...
  /*  RUN HDA IN W_manfin (INPUT xfec,
                         INPUT creditos.monto,
                         INPUT creditos.cuota,
                         INPUT creditos.monto,
                         INPUT creditos.tasa,
    ...
    /*IF dias_atraso NE xdiasatr THEN DO:*/
         /*DISPLA dias_atraso fec_pago xdiasatr xubica xatr xpro FORMAT "-999,999,999.99".*/
    /*END.*/
    DISPLAY nit num_credito xpro FORMAT "999,999,999"
            xatr FORMAT "999,999,999"
            xubica 
            xfpro
            xdiasatr.
    /*ASSIGN creditos.dias_atraso = xdiasatr
           creditos.val_atraso = xatr
           creditos.sdo_proyectado = xpro
           creditos.fec_pago = xubica.*/
