...
DEFINE VAR W_Linea AS CHARACTER FORMAT "X(121)" INITIAL "".
DEFINE VAR W_Linea2 AS CHARACTER FORMAT "X(121)" INITIAL "".
...
ASSIGN W_Linea = FILL(W_Raya,121)
       W_Linea2 = FILL(W_Raya2,121)
...
DEFINE FRAME F-Encabezado HEADER
    ...
    W_IdReporta   AT 1
    W_Reporte     AT 1
    W_Linea       AT 1 FORMAT "X(121)"
    W_EncColumna  AT 1 FORMAT "X(121)"
    W_Linea2      AT 1 FORMAT "X(121)" WITH DOWN WIDTH 144 USE-TEXT PAGE-TOP FRAME F-Encabezado STREAM-IO.

DEFINE FRAME f-ftr
      HEADER
        "________________________________________" AT 2
        W_PiePagina AT 2
      WITH DOWN WIDTH 143 FRAME f-ftr PAGE-BOTTOM USE-TEXT STREAM-IO.
