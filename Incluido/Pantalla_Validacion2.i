...
DEFINE VARIABLE W_TotCta AS LOGICAL INIT FALSE.

DEFINE VARIABLE W_TotComp AS LOGICAL INIT FALSE.
...
DEFINE VARIABLE W_CB1 AS INTEGER FORMAT "999".
DEFINE VARIABLE W_CB2 AS INTEGER FORMAT "999".
...
DEFINE BUTTON Btn_TotCta LABEL "&Detalle Tot.X Cuenta" SIZE 20 BY 1.58 FONT 5.
DEFINE BUTTON Btn_TotComp LABEL "&Totales por Cuenta" SIZE 20 BY 1.58 FONT 5.
DEFINE BUTTON Btn_Informacion IMAGE-UP FILE  "imagenes\informacion.bmp" SIZE 10 BY 1.58 AUTO-GO.
DEFINE BUTTON Btn_Imprimir IMAGE-UP FILE "imagenes\impresora2.bmp" SIZE 12 BY 1.58 AUTO-GO.
DEFINE BUTTON Btn_Salir AUTO-GO LABEL "&Salir" SIZE 12 BY 1.58 FONT 5.
DEFINE BUTTON Btn_Ayuda IMAGE-UP FILE "imagenes\interrogacion.bmp" SIZE 4 BY 1.08 FONT 4.
DEFINE VARIABLE Cmb_Agencia AS CHARACTER FORMAT "X(40)" VIEW-AS COMBO-BOX INNER-LINES 5 FONT 5 BGCOLOR 15 LABEL "Agencia".
DEFINE VARIABLE Cmb_CenCost AS CHARACTER FORMAT "X(40)" VIEW-AS COMBO-BOX INNER-LINES 5 FONT 5 BGCOLOR 15 LABEL "Centro de Costos".
DEFINE VARIABLE Cmb_Comprob AS CHARACTER FORMAT "X(40)" VIEW-AS COMBO-BOX INNER-LINES 5 FONT 5 BGCOLOR 15 LABEL "Comprobantes".
DEFINE VARIABLE Cmb_Nivel AS INTEGER FORMAT "9" VIEW-AS COMBO-BOX LIST-ITEMS 1, 2, 3, 4, 5, 6, 7, 8 INNER-LINES 5 FONT 5 BGCOLOR 15 LABEL "Nivel" INITIAL 8.
DEFINE VARIABLE W_Usuario1 AS CHARACTER FORMAT "X(18)" LABEL "Usuario          " BGCOLOR 15.
DEFINE VARIABLE W_NomUsuario1 AS CHARACTER FORMAT "X(37)" BGCOLOR 18 FGCOLOR 15.
...
DEFINE VARIABLE W_Fec1 AS DATE FORMAT "99/99/9999" INITIAL TODAY BGCOLOR 15 LABEL "Fecha de Trabajo" VIEW-AS FILL-IN SIZE 10 BY .81.
DEFINE VARIABLE W_Fec2 AS DATE FORMAT "99/99/9999" INITIAL TODAY BGCOLOR 15 LABEL "Fecha Final" VIEW-AS FILL-IN SIZE 10 BY .81.
...
DEFINE VARIABLE W_Base AS DECIMAL FORMAT "->>,>>>,>>>,>>9.99" LABEL "Valor de la Base" BGCOLOR 15 VIEW-AS FILL-IN SIZE 13 BY .81.
DEFINE VARIABLE W_Porcentaje AS DECIMAL FORMAT "->>,>>>,>>>,>>9.99" LABEL "Porcentaje" BGCOLOR 15 VIEW-AS FILL-IN SIZE 13 BY .81.

DEFINE VAR W_Ordenar AS INTEGER
    VIEW-AS RADIO-SET VERTICAL RADIO-BUTTONS
    "Comprobante", 1,
    "Orden de grabación", 2
    SIZE 16 BY 1.4 NO-UNDO.

/* ************************  Frame Definitions  *********************** */

DEFINE FRAME F_Valida
    Cmb_Agencia AT ROW 1.3 COL 24
    Cmb_CenCost AT ROW 2.6 COL 18
    Cmb_Comprob AT ROW 3.9 COL 19.8
    W_Usuario1 AT ROW 05 COL 20
    W_NomUsuario1 AT ROW 05 COL 45 /*34.5*/ NO-LABEL
    W_Usuario2 AT ROW 06 COL 20.6
    W_NomUsuario2 AT ROW 06 COL 34.5 NO-LABEL
    "  Escoja la fecha del Informe  " AT ROW 7 COL 17 FONT 5 FGCOLOR 7
    W_Fec1 AT ROW 8.2 COL 38
    W_Fec2 AT ROW 8.2 COL 63
    W_CuadroFechas AT ROW 7.5 COL 15
    "  Límites de Cuentas y Nits  " AT ROW 10.5 COL 17 FONT 5 FGCOLOR 7
    W_Cuenta1 AT ROW 12 COL 22
    W_NomCuenta1 AT ROW 12 COL 43.5 NO-LABEL
    W_Cuenta2 AT ROW 13 COL 22.5
    W_NomCuenta2 AT ROW 13 COL 43.5 NO-LABEL
    W_Nit1 AT ROW 14.5 COL 25
    W_NomNit1 AT ROW 14.5 COL 43.5 NO-LABEL
    W_Nit2 AT ROW 15.5 COL 25.5
    W_NomNit2 AT ROW 15.5 COL 43.5 NO-LABEL
    W_CuadroLimite AT ROW 10.9 COL 15
    "  Otros Parámetros  " AT ROW 17.5 COL 17 FONT 5 FGCOLOR 7
    W_CuadroOtros AT ROW 18 COL 15
    Cmb_Nivel AT ROW 20.5 COL 60.3
    W_Base AT ROW 18.5 COL 53
    W_Porcentaje AT ROW 19.5 COL 56.6
    W_Ordenar AT ROW 10.1 COL 86 NO-LABEL
    Btn_Informacion AT ROW 04 COL 99 HELP "Confirma la Entrada al Sistema"
    Btn_TotCta AT ROW 12 COL 86
    Btn_TotComp AT ROW 14 COL 86
    Btn_Imprimir AT ROW 16 COL 86
    Btn_Salir AT ROW 18 COL 86 HELP "Cancela la Entrada al Sistema" SKIP(0.5)
    Btn_Ayuda AT ROW 20 COL 97
    WITH SIZE 115 BY 23 SIDE-LABELS THREE-D KEEP-TAB-ORDER FONT 4 BGCOLOR 17 FGCOLOR 0 OVERLAY NO-UNDERLINE SCROLLABLE.

CREATE WINDOW W_Pantalla
    ASSIGN HIDDEN = YES
           TITLE = "Informe: " + W_Informe
           HEIGHT = 23.15 WIDTH = 115
           RESIZE = NO
           SCROLL-BARS = NO
           STATUS-AREA = YES
           MESSAGE-AREA = NO
...
/*inicializacion de variables */
    ...
    END.
    W_Ok = Cmb_Comprob:ADD-LAST("000 - Todos los Comprobantes").
    FOR EACH Comprobantes WHERE Comprobantes.Estado EQ 1 NO-LOCK:
        W_Ok = Cmb_Comprob:ADD-LAST(STRING(Comprobantes.Comprobante,"999") + " - " + Comprobantes.Nombre).
    END.
    Cmb_Comprob:SCREEN-VALUE IN FRAME F_Valida = "000 - Todos los Comprobantes".

    ASSIGN W_Usuario1:SCREEN-VALUE = ""
...
/*fin inicializacion de variables*/
  ...
  DO:
     ...
     END.
     ELSE W_NomUsuario1:SCREEN-VALUE = "Todos los Usuarios".
  END.
