...
/*fin inicializacion de variables*/
  ...
  DO:
     ...
     PUT "AGENCIA  CUENTA         NOMBRE                           SALDO INICIAL          DEBITO         CREDITO     SALDO FINAL NAT" SKIP(0).
     IF W_AG1 = 999 AND w_ag1 = w_ag2 THEN  DO:
        REPEAT zcontador = 1 TO zfin_age:
           ...
           IF AVAILABLE(agencias) THEN DO:
             ASSIGN w_ag1 = zcontador  w_ag2 = zcontador.
     ...
     END.
     OUTPUT CLOSE.
     MESSAGE "El archivo ha quedado en " listado
