  ...
  DEFINE FRAME F-Encabezado
      HEADER
        ...
        W_Nom_Entidad AT ROW 6 COLUMN 2
        "PAGINA:"     AT ROW 6 COLUMN 90 PAGE-NUMBER FORMAT ">>>9"
        W_Ubicacion   AT ROW 7 COLUMN 2
        W_IdEstacion  AT ROW 8 COLUMN 2
        W_IdReporta   AT ROW 9 COLUMN 2
        W_Reporte     AT ROW 10 COLUMN 2
