...
&Scoped-define FIELDS-IN-QUERY-br_table Nit_Adicional Edad Nombre_Adicional ~
Fec_Inicio 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      Nit_Adicional FORMAT "X(12)":U
      Edad FORMAT ">>9":U WIDTH 4.72
      Nombre_Adicional FORMAT "X(40)":U WIDTH 50
      Fec_Inicio FORMAT "99/99/9999":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Settings for THIS-PROCEDURE
   ...
   Data Source: "\\192.168.101.9\desarrollo\prg\sdo_adicionalconv.w"
   Allow: Basic,Browse
   Frames: 1
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   = _<SDO>.rowObject.Nit_Adicional
     _FldNameList[2]   > _<SDO>.rowObject.Edad
"Edad" ? ? "integer" ? ? ? ? ? ? no ? no no "4.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > _<SDO>.rowObject.Nombre_Adicional
"Nombre_Adicional" ? ? "character" ? ? ? ? ? ? no ? no no "50" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   = _<SDO>.rowObject.Fec_Inicio
