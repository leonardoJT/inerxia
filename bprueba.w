...
&Scoped-define FIELDS-IN-QUERY-br_table Nit Cuenta Estado Cod_Operacion ~
Cod_Producto Cod_Segmento Fec_Transaccion FEfeChe FValConsignacion ~
FValRetiro Val_Cheque Val_Efectivo 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      Nit FORMAT "X(12)":U
      Cuenta FORMAT "X(14)":U
      Estado FORMAT "9":U WIDTH 10.14
      Cod_Operacion FORMAT "999999999":U
      Cod_Producto FORMAT "999":U
      Cod_Segmento FORMAT "99999":U
      Fec_Transaccion FORMAT "99/99/9999":U
      FEfeChe FORMAT "x(8)":U
      FValConsignacion FORMAT "->>>,>>>,>>9.99":U
      FValRetiro FORMAT "->>>,>>>,>>9.99":U
      Val_Cheque FORMAT "->>>>>,>>>,>>>,>>9.99":U
      Val_Efectivo FORMAT "->>>>>,>>>,>>>,>>9.99":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
"Estado" ? ? "integer" ? ? ? ? ? ? no ? no no "10.14" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
