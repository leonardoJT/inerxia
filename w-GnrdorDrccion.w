...
&Scoped-Define ENABLED-OBJECTS RECT-306 RECT-307 btnAprtdo RECT-308 ~
RECT-309 cDrccion BUTTON-BLANCO btnCrcnvlar BUTTON-rtrcso BUTTON-RETURN ~
btnprueba BUTTON-limpiar btnExtrior BUTTONCE cTxtoABrrar btnLte btnOriente ~
btnPso btnSlon btnStno btnZnaFrnca btnAlmcen btnAltllo btnBlvar btncal ~
btnCrclar btnCrrgmiento btnPseo btnSlar btnTrrza btnVrda btnAgrpcion ~
btnCnjntoRsdncial btnGrge btnAdmnstrcion btnAgncia btnAutpsta btnCiuddla ~
btnCrrra btnCrrtra btnDpstoStno btnEste btnFnca btnMncpio btnMnzna btnNrte ~
btnOeste btnPlnta btnPrque btnPrqueadro btnPrtria btnSctor btnTrmnal ~
btnVariante btnAvndaCrrra btnBdga btnBis btnBlque btnClla btnCmno btnCnjnto ~
btnCnsltrio btnCntroCmrcial btnCsa btnDprtmnto btnDpsto btnEntrda ~
btnEsquina btnEtpa btnIntrior btnKlmtro btnOccidnte btnOfcna btnPenthouse ~
btnPrcla btnPrdio btnPsje btnPuente btnPuesto btnSlonCmnal btnSmsctor ~
btnSperMnzna btnSuite btnTrre btnUndad btnUnidadRsdncial btnUrbnzcion ~
btnZna btna btnCero btnCinco btnCuatro btnDos btnG btnGuion btnH btnI btnJ ~
btnK btnL btnM btnN btnNmral btnNueve btnO btnOcho btnP btnQ btnR btnS ~
btnSeis btnSiete btnT btnTres btnU btnUno btnV btnW btnX btnY btnZ ~
btnAprtmnto btnAvnda btnb btnc btnClle btnd btnDiagnal btnE btnEdfcio btnF ~
btnSur btnTrnsvrsal 
...
DEFINE BUTTON btnAdmnstrcion  NO-FOCUS
...
DEFINE BUTTON btnAgrpcion  NO-FOCUS
     LABEL "AGRUPACION" 
     SIZE 15 BY 1.12 TOOLTIP "Agrupación"
     FONT 8.

DEFINE BUTTON btnAlmcen  NO-FOCUS
     LABEL "ALMACEN" 
     SIZE 15 BY 1.12 TOOLTIP "Almacén"
     FONT 8.

DEFINE BUTTON btnAltllo  NO-FOCUS
     LABEL "ALTILLO" 
...
DEFINE BUTTON btnBdga  NO-FOCUS
     LABEL "BODEGA" 
...
DEFINE BUTTON btnBlvar  NO-FOCUS
     LABEL "BULEVAR" 
...
DEFINE BUTTON btncal  NO-FOCUS
     LABEL "LOCAL" 
     SIZE 15 BY 1.12 TOOLTIP "Local"
     FONT 8.

DEFINE BUTTON btnCero  NO-FOCUS
     LABEL "0" 
     SIZE 3 BY 1.12 TOOLTIP "0"
     FONT 8.

DEFINE BUTTON btnCinco  NO-FOCUS
     LABEL "5" 
...
DEFINE BUTTON btnClla  NO-FOCUS
     LABEL "CELULA" 
...
DEFINE BUTTON btnCmno  NO-FOCUS
     LABEL "CAMINO" 
...
DEFINE BUTTON btnCnsltrio  NO-FOCUS
     LABEL "CONSULTORIO" 
     SIZE 15 BY 1.12 TOOLTIP "Consultorio"
     FONT 8.

DEFINE BUTTON btnCntroCmrcial  NO-FOCUS
     LABEL "CEN COMERCIAL" 
     SIZE 15 BY 1.12 TOOLTIP "Centro Comercial"
     FONT 15.

DEFINE BUTTON btnCrclar  NO-FOCUS
     LABEL "CIRCULAR" 
     SIZE 15 BY 1.12 TOOLTIP "Circular"
     FONT 8.

DEFINE BUTTON btnCrcnvlar  NO-FOCUS
     LABEL "CIRCUNVALAR" 
     SIZE 15 BY 1.12 TOOLTIP "Circunvalar"
     FONT 8.

DEFINE BUTTON btnCrrgmiento  NO-FOCUS
     LABEL "CORREGIMIENTO" 
...
DEFINE BUTTON btnCrrtra  NO-FOCUS
     LABEL "CARRETERA" 
...
DEFINE BUTTON btnCuatro  NO-FOCUS
     LABEL "4" 
...
DEFINE BUTTON btnDos  NO-FOCUS
     LABEL "2" 
     SIZE 3 BY 1.12 TOOLTIP "2"
     FONT 8.

DEFINE BUTTON btnDprtmnto  NO-FOCUS
     LABEL "DEPARTAMENTO" 
     SIZE 15 BY 1.12 TOOLTIP "Departamento"
     FONT 8.

DEFINE BUTTON btnDpsto  NO-FOCUS
     LABEL "DEPOSITO" 
     SIZE 15 BY 1.12 TOOLTIP "Depósito"
     FONT 8.

DEFINE BUTTON btnDpstoStno  NO-FOCUS
...
DEFINE BUTTON btnEsquina  NO-FOCUS
     LABEL "ESQUINA" 
...
DEFINE BUTTON btnExtrior  NO-FOCUS
     LABEL "EXTERIOR" 
...
DEFINE BUTTON btnFnca  NO-FOCUS
     LABEL "FINCA" 
...
DEFINE BUTTON btnGrge  NO-FOCUS
     LABEL "GARAJE" 
     SIZE 15 BY 1.12 TOOLTIP "GARAJE"
     FONT 8.
...
DEFINE BUTTON btnKlmtro  NO-FOCUS
     LABEL "KILOMETRO" 
...
DEFINE BUTTON btnNueve  NO-FOCUS
     LABEL "9" 
...
DEFINE BUTTON btnOccidnte  NO-FOCUS
     LABEL "OCCIDENTE" 
     SIZE 15 BY 1.12 TOOLTIP "OCCIDENTE"
     FONT 8.

DEFINE BUTTON btnOcho  NO-FOCUS
     LABEL "8" 
...
DEFINE BUTTON btnOriente  NO-FOCUS
     LABEL "ORIENTE" 
...
DEFINE BUTTON btnPlnta  NO-FOCUS
     LABEL "PLANTA" 
     SIZE 15 BY 1.12 TOOLTIP "PLANTA"
     FONT 8.

DEFINE BUTTON btnPrcla  NO-FOCUS
     LABEL "PARCELA" 
     SIZE 15 BY 1.12 TOOLTIP "PARCELA"
     FONT 8.

DEFINE BUTTON btnPrdio  NO-FOCUS
     LABEL "PREDIO" 
     SIZE 15 BY 1.12 TOOLTIP "Predio"
     FONT 8.

DEFINE BUTTON btnPrque  NO-FOCUS
     LABEL "PARQUE" 
     SIZE 15 BY 1.12 TOOLTIP "PARQUE"
     FONT 8.

DEFINE BUTTON btnPrqueadro  NO-FOCUS
     LABEL "PARQUEADERO" 
     SIZE 15 BY 1.12 TOOLTIP "PARQUEADERO"
     FONT 8.

DEFINE BUTTON btnPrtria  NO-FOCUS
     LABEL "PORTERIA" 
     SIZE 15 BY 1.12 TOOLTIP "Portería"
     FONT 8.

DEFINE BUTTON btnprueba 
     LABEL "prueba" 
     SIZE 10 BY .81.
...
DEFINE BUTTON btnPsje  NO-FOCUS
     LABEL "PASAJE" 
...
DEFINE BUTTON btnPuente  NO-FOCUS
     LABEL "PUENTE" 
     SIZE 15 BY 1.12 TOOLTIP "Puente"
     FONT 8.

DEFINE BUTTON btnPuesto  NO-FOCUS
     LABEL "PUESTO" 
...
DEFINE BUTTON btnSeis  NO-FOCUS
     LABEL "6" 
     SIZE 3 BY 1.12 TOOLTIP "6"
     FONT 8.

DEFINE BUTTON btnSiete  NO-FOCUS
     LABEL "7" 
     SIZE 3 BY 1.12 TOOLTIP "7"
     FONT 8.

DEFINE BUTTON btnSlar  NO-FOCUS
     LABEL "SOLAR" 
     SIZE 15 BY 1.12 TOOLTIP "SOLAR"
     FONT 8.

DEFINE BUTTON btnSlon  NO-FOCUS
     LABEL "SALON" 
     SIZE 15 BY 1.12 TOOLTIP "SALON"
     FONT 8.

DEFINE BUTTON btnSlonCmnal  NO-FOCUS
     LABEL "SALON COMUNAL" 
     SIZE 15 BY 1.12 TOOLTIP "Salón Comunal"
     FONT 8.

DEFINE BUTTON btnSmsctor  NO-FOCUS
     LABEL "SEMISECTOR" 
...
DEFINE BUTTON btnStno  NO-FOCUS
     LABEL "SOTANO" 
...
DEFINE BUTTON btnTres  NO-FOCUS
     LABEL "3" 
     SIZE 3 BY 1.12 TOOLTIP "3"
     FONT 8.

DEFINE BUTTON btnTrmnal  NO-FOCUS
     LABEL "TERMINAL" 
...
DEFINE BUTTON btnTrrza  NO-FOCUS
     LABEL "TERRAZA" 
...
DEFINE BUTTON btnVariante  NO-FOCUS
     LABEL "VARIANTE" 
     SIZE 15 BY 1.12 TOOLTIP "Variante"
     FONT 8.

DEFINE BUTTON btnVrda  NO-FOCUS
     LABEL "VEREDA" 
...
DEFINE BUTTON btnZnaFrnca  NO-FOCUS
     LABEL "ZONA FRANCA" 
...
DEFINE FRAME fMain
     ...
     btnprueba AT ROW 19.58 COL 81 WIDGET-ID 280
...
ASSIGN 
       btnprueba:PRIVATE-DATA IN FRAME fMain     = 
                "PRB".
...
ON 'choose':U OF btna ,btnAdmnstrcion ,btnAgncia ,btnAgrpcion ,btnAlmcen ,btnAltllo ,btnAprtdo ,btnAprtmnto ,btnAutpsta ,btnAvnda ,btnAvndaCrrra ,btnb ,btnBdga ,btnBis ,btnBlque ,btnBlvar ,btnc ,btnCero ,btnCinco ,btnCiuddla ,btnClla ,btnClle ,btnCmno ,btnCnjnto ,btnCnjntoRsdncial ,btnCnsltrio ,btnCntroCmrcial ,btnCrclar ,btnCrcnvlar ,btnCrrgmiento ,btnCrrra ,btnCrrtra ,btnCsa ,btnCuatro ,btnd ,btnDiagnal ,btnDos ,btnDprtmnto ,btnDpsto ,btnDpstoStno ,btnE ,btnEdfcio ,btnEntrda ,btnEsquina ,btnEste ,btnEtpa ,btnExtrior ,btnF ,btnFnca ,btnG ,btnGrge ,btnGuion ,btnH ,btnI ,btnJ ,btnK ,btnL ,btnM ,btnMncpio ,btnN ,btnNmral ,btnNrte ,btnNueve ,btnO ,btnOccidnte ,btnOcho ,btnOeste ,btnOfcna ,btnOriente ,btnP ,btnPenthouse ,btnPlnta ,btnPrcla ,btnPrdio ,btnPrque ,btnPrqueadro ,btnPrtria ,btnPseo ,btnPsje ,btnPso ,btnPuente ,btnPuesto ,btnQ ,btnR ,btnS ,btnSctor ,btnSeis ,btnSiete ,btnSlar ,btnSlon ,btnSlonCmnal ,btnSmsctor ,btnSperMnzna ,btnStno ,btnSuite ,btnSur ,btnT ,btnTres ,btnTrmnal ,btnTrnsvrsal ,btnTrre ,btnTrrza ,btnU ,btnUndad ,btnUnidadRsdncial ,btnUno ,btnUrbnzcion ,btnV ,btnVariante ,btnVrda ,btnW ,btnX ,btnY ,btnZ ,btnZna ,btnZnaFrnca,btnIntrior IN FRAME {&FRAME-NAME},
    btnMnzna,btnLte,btnKlmtro,btncal,btnprueba
DO:
    DO WITH FRAME {&FRAME-NAME}:
...
------------------------------------------------------------------------------*/
  ...
  ENABLE RECT-306 RECT-307 btnAprtdo RECT-308 RECT-309 cDrccion BUTTON-BLANCO 
         btnCrcnvlar BUTTON-rtrcso BUTTON-RETURN btnprueba BUTTON-limpiar 
         btnExtrior BUTTONCE cTxtoABrrar btnLte btnOriente btnPso btnSlon 
         btnStno btnZnaFrnca btnAlmcen btnAltllo btnBlvar btncal btnCrclar 
         btnCrrgmiento btnPseo btnSlar btnTrrza btnVrda btnAgrpcion 
         btnCnjntoRsdncial btnGrge btnAdmnstrcion btnAgncia btnAutpsta 
         btnCiuddla btnCrrra btnCrrtra btnDpstoStno btnEste btnFnca btnMncpio 
         btnMnzna btnNrte btnOeste btnPlnta btnPrque btnPrqueadro btnPrtria 
         btnSctor btnTrmnal btnVariante btnAvndaCrrra btnBdga btnBis btnBlque 
         btnClla btnCmno btnCnjnto btnCnsltrio btnCntroCmrcial btnCsa 
         btnDprtmnto btnDpsto btnEntrda btnEsquina btnEtpa btnIntrior btnKlmtro 
         btnOccidnte btnOfcna btnPenthouse btnPrcla btnPrdio btnPsje btnPuente 
         btnPuesto btnSlonCmnal btnSmsctor btnSperMnzna btnSuite btnTrre 
         btnUndad btnUnidadRsdncial btnUrbnzcion btnZna btna btnCero btnCinco 
         btnCuatro btnDos btnG btnGuion btnH btnI btnJ btnK btnL btnM btnN 
         btnNmral btnNueve btnO btnOcho btnP btnQ btnR btnS btnSeis btnSiete 
         btnT btnTres btnU btnUno btnV btnW btnX btnY btnZ btnAprtmnto btnAvnda 
         btnb btnc btnClle btnd btnDiagnal btnE btnEdfcio btnF btnSur 
         btnTrnsvrsal 
      WITH FRAME fMain IN WINDOW wWin.
