  ...
  CASE currentPage: 
    ...
    WHEN 0 THEN DO:
       RUN constructObject (
             ...
             INPUT  'AppServiceASInfoASUsePrompt?CacheDuration0CheckCurrentChangedyesDestroyStatelessyesDisconnectAppServernoServerOperatingModeNONEShareDatanoUpdateFromSourcenoForeignFieldsObjectNamedcreditosOpenOnInityesPromptColumns(NONE)PromptOnDeleteyesRowsToBatch200RebuildOnReposnoToggleDataTargetsyes':U ,
             OUTPUT h_dcreditos ).
       ...
       RUN constructObject (
             ...
             OUTPUT h_wfcreditos ).
       /* Position in AB:  ( 3.19 , 1.00 ) */
       /* Size in AB:  ( 1.88 , 7.72 ) */

       RUN constructObject (
             INPUT  'adm2/dynbrowser.w':U ,
             INPUT  FRAME fMain:HANDLE ,
             INPUT  'DisplayedFieldsNit,FNombre,Num_Credito,FDirResCli,FTelResCli,FDirComCli,FTelComCli,FNomCodA,FDirResCodA,FTelResCodA,FDirComCodA,FTelComCodA,FUbiResCodA,FUbiComCodAEnabledFieldsBrowseColumnTypesBrowseColumnItemsBrowseColumnItemPairsBrowseColumnInnerLinesBrowseColumnSortsBrowseColumnMaxCharsBrowseColumnAutoCompletionsBrowseColumnUniqueMatchesBrowseColumnDelimitersScrollRemotenoNumDown0CalcWidthnoMaxWidth80FetchOnReposToEndyesUseSortIndicatoryesSearchFieldDataSourceNamesdcreditosUpdateTargetNames?LogicalObjectNameHideOnInitnoDisableOnInitnoObjectLayout':U ,
             OUTPUT h_dynbrowser ).
       RUN repositionObject IN h_dynbrowser ( 4.77 , 8.00 ) NO-ERROR.
       RUN resizeObject IN h_dynbrowser ( 7.00 , 114.00 ) NO-ERROR.
       ...
       RUN addLink ( h_dynbrowser , 'Update':U , h_dcreditos ).
