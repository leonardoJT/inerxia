...
INPUT FROM C:\CIFIN\Abril302011\Cruce-Archivos\act_agencia.csv.
REPEAT:                         
    CONT = CONT + 1.
    CREATE CRDT.    
...
OUTPUT TO C:\CIFIN\Abril302011\Cruce-Archivos\salida.csv.
wtitulo = "agencia;NIT;Linea;Num-Credito;Estado".
