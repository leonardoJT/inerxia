...
/* Se debio ejuctar menu.p antes para asignar variasbles de ambiente  */

/*  para un solo credito comentariar anterior 
DEFINE VAR nitCredito AS CHARACTER NO-UNDO.   /* INIT "10232775". */
DEFINE VAR numeroCredito AS INTEGER NO-UNDO.  /* INIT 831.        */
