...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.Grupo rowObject.Subgrupo ~
rowObject.Codigo_CIIU rowObject.Descripcion 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      rowObject.Grupo FORMAT "99":U
      rowObject.Subgrupo FORMAT "99":U
      rowObject.Codigo_CIIU FORMAT "9999":U
      rowObject.Descripcion FORMAT "X(40)":U WIDTH 45.86
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN NO-AUTO-VALIDATE NO-ROW-MARKERS SEPARATORS SIZE 76 BY 11.85
         BGCOLOR 15 FONT 5 ROW-HEIGHT-CHARS .62 EXPANDABLE.
...
ASSIGN 
       br_table:SEPARATOR-FGCOLOR IN FRAME F-Main      = 1.
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   = _<SDO>.rowObject.Grupo
     _FldNameList[2]   = _<SDO>.rowObject.Subgrupo
     _FldNameList[3]   = _<SDO>.rowObject.Codigo_CIIU
     _FldNameList[4]   > _<SDO>.rowObject.Descripcion
"rowObject.Descripcion" ? ? "character" ? ? ? ? ? ? no ? no no "45.86" yes no no "U" "" ""
