...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Rec_XLibranza ASSIGN
         HIDDEN             = YES
         TITLE              = "Distribución Recaudos De aportes"
         HEIGHT             = 19.08
         WIDTH              = 112.43
         MAX-HEIGHT         = 30.46
         MAX-WIDTH          = 164.57
...
ON END-ERROR OF W-Rec_XLibranza /* Distribución Recaudos De aportes */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Rec_XLibranza W-Rec_XLibranza
ON WINDOW-CLOSE OF W-Rec_XLibranza /* Distribución Recaudos De aportes */
DO:
...
DO:
    ...
    MESSAGE "Está seguro de recaudar para el mes" W_sem:SCREEN-VALUE
...
ON LEAVE OF w_anoAplicar IN FRAME F_Proc /* Año: */
DO:
    ASSIGN w_anoAplicar.
END.
...
DO:
    ...
    IF W_NCuotas EQ 99 THEN DO:
        MESSAGE "Número de Cuotas Inferior a 99"
            VIEW-AS ALERT-BOX.
...
/* Cargo el periodo y año a distribuir */
...
IF NOT AVAILABLE(CopMov_Contable) THEN DO:
    ...
    CopMov_Contable.Comentario = "Distribución de Recaudo".
...
/* Contabilidad en la agencia donde se está aplicando la Nómina */
...
IF NOT W_Inf THEN DO:
    IF W_VrADist > 0 THEN
        MESSAGE "El Cliente/Asociado no tiene productos de Ahorro para Abonar el sobrante de la Distribución..." SKIP
                "Revise por favor..."
            VIEW-AS ALERT-BOX.
...
FOR EACH Rec_Tmp BY Rec_Tmp.Cod_Empresa
    ...
    DISPLAY Rec_Tmp.Nit         LABEL "Cédula/Nit"
...
MESSAGE "El archivo plano está en" listado1
    VIEW-AS ALERT-BOX INFO BUTTONS OK.
...
Mov_Ahorros.Descrip = "Consignación por distribución de Nómina".
...
IF W_SiCpte THEN DO:
    MESSAGE "El proceso de distribución ha finalizado con éxito"
        VIEW-AS ALERT-BOX INFO BUTTONS OK.
...
ASSIGN W_Reporte = "Reporte   : Distribución Preliminar de Recaudo      Fecha del Informe: " + STRING(W_Fecha,"99/99/9999") + "      Hora : " + STRING(TIME,"HH:MM:SS")
...
IF W_SiContab THEN DO:
    W_Reporte = "Reporte   : Distribución Contabilizada de Recaudo      Fecha del Informe: " + STRING(W_Fecha,"99/99/9999") + "      Hora : " + STRING(TIME,"HH:MM:SS").
...
DO:
    ...
    IF w_grarema = 0 AND w_totrema = 0 THEN DO:
        ...
        DO WHILE LOCKED(pro_Ahorro):
            MESSAGE "El registro de remanente está siendo usado" SKIP
