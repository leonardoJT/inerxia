...
REPEAT TRANSACTION ON ERROR UNDO TranConta, LEAVE TranConta:
  /* Activo Fijo */
  FOR EACH act_fijo WHERE act_fijo.estado EQ 1 
...
/*      Anexos.agencia = 1 AND */
/*      Anexos.Nit     = "AF002949" AND  */
...
/*         MESSAGE "Entro.." anexos.cuenta vdSdoFinal */
/*             VIEW-AS ALERT-BOX INFO BUTTONS OK.     */
       ...
       IF AVAILABLE(TemActivo) THEN DO:
          ...
          FIND FIRST pro_activo WHERE 
               ...
               SUBSTRING(pro_activo.cta_fuente,1,6) EQ SUBSTRING(Anexos.cuenta,1,6) NO-ERROR.
...
/* PROCEDURE BorraTotDepre:                                                 */
/* FOR EACH TemActivo WHERE TemActivo.TNomcta  EQ "Totalmente Depreciados": */
/* DELETE TemActivo.                                                        */
/* END.                                                                     */
/* END PROCEDURE.                                                           */
