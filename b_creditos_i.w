...
&Scoped-define FIELDS-IN-QUERY-br_table Cod_Credito Num_Credito Monto ~
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      Cod_Credito FORMAT "999":U
      Num_Credito FORMAT "999999999":U
      Monto FORMAT "->>>>>,>>>,>>>,>>9.99":U
      Pagare FORMAT "X(14)":U
      Sdo_Capital FORMAT "->>>>>,>>>,>>>,>>9.99":U
      Fec_Aprobacion FORMAT "99/99/9999":U
      Fec_Desembolso FORMAT "99/99/9999":U
      Fec_UltPago FORMAT "99/99/9999":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Settings for THIS-PROCEDURE
   ...
   Data Source: "\\192.168.101.9\desarrollo\prg\dsdocreditos.w"
   Allow: Basic,Browse
   Frames: 1
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   = _<SDO>.rowObject.Cod_Credito
     _FldNameList[2]   = _<SDO>.rowObject.Num_Credito
     _FldNameList[3]   = _<SDO>.rowObject.Monto
     _FldNameList[4]   = _<SDO>.rowObject.Pagare
     _FldNameList[5]   = _<SDO>.rowObject.Sdo_Capital
     _FldNameList[6]   = _<SDO>.rowObject.Fec_Aprobacion
     _FldNameList[7]   = _<SDO>.rowObject.Fec_Desembolso
     _FldNameList[8]   = _<SDO>.rowObject.Fec_UltPago
