...
/* CtrlFrame OCXINFO:CREATE-CONTROL from: {CA8A9780-280D-11CF-A24D-444553540000} type: Pdf */
      CtrlFrame:MOVE-BEFORE(button-1:HANDLE IN FRAME DEFAULT-FRAME).
...
ON CHOOSE OF button-1 IN FRAME DEFAULT-FRAME /* Load... */
DO:
...
OCXFile = SEARCH( "Visor-FacturaCupoRotativo.wrx":U ).
IF OCXFile = ? THEN
...
END.
ELSE MESSAGE "Visor-FacturaCupoRotativo.wrx":U SKIP(1)
