...
DEFINE FRAME F-Main
     RowObject.Nombre AT ROW 1.35 COL 16.43 COLON-ALIGNED WIDGET-ID 4
          LABEL "Tipo Bien"
          VIEW-AS FILL-IN 
          SIZE 41.43 BY .81
          BGCOLOR 15 
     RowObject.Val_Comercial AT ROW 2.31 COL 16.43 COLON-ALIGNED WIDGET-ID 6
          LABEL "Valor Comercial" FORMAT ">>,>>>,>>>,>>>,>>9.99"
          VIEW-AS FILL-IN 
          SIZE 25.43 BY .81
          BGCOLOR 15 
     RowObject.Detalle AT ROW 3.27 COL 16.43 COLON-ALIGNED WIDGET-ID 2
          VIEW-AS FILL-IN 
          SIZE 26.43 BY .81
          BGCOLOR 15 
...
DO:
    ...
    RETURN.
END.
ON 'leave':U OF  RowObject.Detalle, RowObject.Nombre
DO:
...
END.
ON 'any-printable':U OF  RowObject.Detalle, RowObject.Nombre
DO:
