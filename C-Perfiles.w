...
&Scoped-define FIELDS-IN-QUERY-BROWSE-2 Grupos.Grupo Grupos.Nombre ~
Grupos.Prioridad 
&Scoped-define ENABLED-FIELDS-IN-QUERY-BROWSE-2 
&Scoped-define QUERY-STRING-BROWSE-2 FOR EACH Grupos ~
      WHERE Grupos.Estado EQ W_Estado NO-LOCK
&Scoped-define OPEN-QUERY-BROWSE-2 OPEN QUERY BROWSE-2 FOR EACH Grupos ~
      WHERE Grupos.Estado EQ W_Estado NO-LOCK.
&Scoped-define TABLES-IN-QUERY-BROWSE-2 Grupos
&Scoped-define FIRST-TABLE-IN-QUERY-BROWSE-2 Grupos
...
DEFINE VARIABLE W_Valor AS CHARACTER FORMAT "X(40)":U 
     VIEW-AS FILL-IN 
     SIZE 33 BY 1.08 TOOLTIP "Valor de Selección"
     BGCOLOR 15  NO-UNDO.
...
"Nombre", 2,
"Todos", 3
     SIZE 33 BY .69 TOOLTIP "Opción de Selección" NO-UNDO.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-2 Dialog-Frame _STRUCTURED
  QUERY BROWSE-2 NO-LOCK DISPLAY
      Grupos.Grupo FORMAT "99":U
      Grupos.Nombre FORMAT "X(30)":U
      Grupos.Prioridad FORMAT "9":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS SIZE 49 BY 4.85
...
DEFINE FRAME Dialog-Frame
     ...
     W_Valor AT ROW 8.27 COL 14 COLON-ALIGNED NO-LABEL
     BUTTON-47 AT ROW 10.15 COL 45
...
/* Query rebuild information for BROWSE BROWSE-2
     ...
     _Options          = "NO-LOCK"
     _TblOptList       = "USED"
     _Where[1]         = "Grupos.Estado EQ W_Estado"
...
ON WINDOW-CLOSE OF FRAME Dialog-Frame /* Consulta de Perfiles */
DO:
...
------------------------------------------------------------------------------*/
   IF RADIO-SET-2 EQ 1 THEN
         OPEN QUERY BROWSE-2 FOR EACH Grupos WHERE Grupos.Estado EQ W_Estado
                                               AND Grupos.Grupo  EQ INTEGER(W_Valor) NO-LOCK.
   ELSE
      IF RADIO-SET-2 EQ 2 THEN
         OPEN QUERY BROWSE-2 FOR EACH Grupos WHERE Grupos.Estado EQ W_Estado 
                                               AND Grupos.Nombre CONTAINS W_Valor NO-LOCK.
