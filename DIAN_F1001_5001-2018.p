DEFINE INPUT PARAMETER pOrigen AS CHARACTER. /* 'E' - Exógena / 'C' - Certificado */
...
DEFINE VAR idIni as CHARACTER.
DEFINE VAR idFin AS CHARACTER.
...
FOR EACH anexos WHERE (SUBSTRING(anexos.cuenta,1,6) = "510503" OR
                    ...
                    AND anexos.ano = 2018
                    AND anexos.mes = 0
                    AND anexos.nit >= idIni
                    AND anexos.nit <= idFin NO-LOCK BREAK BY anexos.nit
                                                          BY anexos.cuenta:

    IF FIRST-OF(anexos.nit) THEN DO:
        FIND FIRST F1001 WHERE F1001.nit = anexos.nit
                           AND F1001.concepto = "5001" NO-ERROR.
    ...
    IF LAST-OF(anexos.cuenta) AND (SUBSTRING(anexos.cuenta,1,6) = "510503" OR
        ...
        FOR EACH mov_contable WHERE mov_contable.cuenta = anexos.cuenta
                                ...
                                AND YEAR(mov_contable.fec_contable) = 2018 NO-LOCK BREAK:
            ...
            IF NOT AVAILABLE docs THEN DO:
                ...
                FOR EACH bfrMovContable WHERE bfrMovContable.agencia = docs.agencia
                                          ...
                                          AND (SUBSTRING(bfrMovContable.cuenta,1,6) = "243505")
...
IF pOrigen = 'E' THEN DO:
    FOR EACH F1001 WHERE F1001.concepto = "5001" NO-LOCK:
    ...
    FOR EACH sal_cuenta WHERE (SUBSTRING(sal_cuenta.cuenta,1,6) = "510503" OR
                               ...
                               SUBSTRING(sal_cuenta.cuenta,1,6) = "510516" OR
                               SUBSTRING(sal_cuenta.cuenta,1,6) = "510519" OR
                               SUBSTRING(sal_cuenta.cuenta,1,6) = "510520" OR
                               SUBSTRING(sal_cuenta.cuenta,1,10) = "6140101206" OR
                               SUBSTRING(sal_cuenta.cuenta,1,10) = "6140101215" OR
                               SUBSTRING(sal_cuenta.cuenta,1,10) = "6140101227" OR
                               SUBSTRING(sal_cuenta.cuenta,1,10) = "6140101230" OR
                               SUBSTRING(sal_cuenta.cuenta,1,10) = "6140101233" OR
                               SUBSTRING(sal_cuenta.cuenta,1,10) = "6140101236" OR
                               SUBSTRING(sal_cuenta.cuenta,1,10) = "6140101239" OR
                               SUBSTRING(sal_cuenta.cuenta,1,10) = "6140101248" OR
                               SUBSTRING(sal_cuenta.cuenta,1,10) = "6140101260")
