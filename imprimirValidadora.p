...
/*IF P_AhoVta NE 0 THEN DO:    /*Menos A la Vista, El resto son en esta Tirilla Auditoria*/
       ...
       RETURN.   /*Retorna si fuè por tirilla*/
    END.*/
  ...
  /*Continua solo por Validadora para A la Vista*/
    ...
    MESSAGE "Inserte Documento Para Validar la Operación " SKIP
            ...
            "Para NO Visualizar SALDO teclee..........NO"
             VIEW-AS ALERT-BOX QUESTION BUTTONS YES-NO TITLE "CONFIRMAR IMPRESIÓN"
    ...
    /* PUT CONTROL CHR(27) + "T" + CHR(12).*/   /*tenia CHR(48), Tamaño página*/
