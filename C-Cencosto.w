...
/* ***************************  Definitions  ************************** */
  DEFINE OUTPUT PARAMETER P_Cuenta LIKE Cen_Costos.Cen_costos.
  DEFINE OUTPUT PARAMETER P_Nombre LIKE Cen_Costos.Nombre.
...
&Scoped-define FIELDS-IN-QUERY-BROWSE-2 Cen_Costos.Cen_Costos Cen_Costos.Nombre   
&Scoped-define ENABLED-FIELDS-IN-QUERY-BROWSE-2   
&Scoped-define QUERY-STRING-BROWSE-2 FOR EACH Cen_Costos NO-LOCK INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-BROWSE-2 OPEN QUERY BROWSE-2 FOR EACH Cen_Costos NO-LOCK INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-BROWSE-2 Cen_Costos
&Scoped-define FIRST-TABLE-IN-QUERY-BROWSE-2 Cen_Costos
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-2 W-Win _FREEFORM
  QUERY BROWSE-2 NO-LOCK DISPLAY
      Cen_Costos.Cen_Costos FORMAT "999":U
      Cen_Costos.Nombre FORMAT "X(40)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Consulta de Centros de Costos"
         HEIGHT             = 13.5
         WIDTH              = 62.29
         MAX-HEIGHT         = 22.35
         MAX-WIDTH          = 114.29
...
/* Query rebuild information for BROWSE BROWSE-2
     _TblList          = "bdcentral.Cen_Costos"
     _Options          = "NO-LOCK INDEXED-REPOSITION"
     _FldNameList[1]   = bdcentral.Cen_Costos.Cen_Costos
     _FldNameList[2]   = bdcentral.Cen_Costos.Nombre
     _Query            is OPENED
*/  /* BROWSE BROWSE-2 */
&ANALYZE-RESUME
...
ON WINDOW-CLOSE OF W-Win /* Consulta de Centros de Costos */
DO:
...
DO:
    IF AVAILABLE(Cen_Costos) THEN 
       ASSIGN P_Cuenta =  Cen_Costos.Cen_Costos
              P_Nombre   = Cen_Costos.Nombre.
      ...
      DO:
        ...
        ELSE
          DO:
            ...
            FIND Cen_costos WHERE W_Rowid = ROWID(Cen_costos) NO-LOCK NO-ERROR.
          END.
...
CASE R_Buscar:
      WHEN 1 THEN DO:
           OPEN QUERY BROWSE-2 
           FOR EACH Cen_Costos WHERE 
                Cen_Costos.Cen_costos EQ INTEGER(W_Valor) AND
                Cuentas.Estado  EQ 1 NO-LOCK. 
       END.
       WHEN 2 THEN DO:
           OPEN QUERY BROWSE-2 
           FOR EACH Cen_costos WHERE 
                Cen_Costos.Nombre BEGINS W_Valor AND
                Cen_Costos.Estado  EQ 1 NO-LOCK. 
       END.
       WHEN 3 THEN DO:
           OPEN QUERY BROWSE-2 
           FOR EACH Cen_Costos WHERE Cen_Costos.Estado  EQ 1 NO-LOCK. 
       END.
END CASE.
END PROCEDURE.
