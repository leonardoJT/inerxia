...
Creditos.Fec_Pago Creditos.Fec_ProxLiquidacion Creditos.Int_Corrientes ~
Creditos.Fec_UltPago Creditos.Int_Anticipado Creditos.Fec_UltLiquidacion ~
Creditos.Sdo_Capital Creditos.Int_DifCobro Creditos.Sdo_Proyectado ~
Creditos.Tasa Creditos.Cuo_Pagadas Creditos.Cuota Creditos.Val_Atraso ~
...
&Scoped-Define ENABLED-OBJECTS RECT-296 RECT-297 R_TipCon W_AboInt ~
Btn_Grabar Btn_Salir 
&Scoped-Define DISPLAYED-FIELDS Creditos.Fec_Desembolso Creditos.Fec_Pago ~
Creditos.Fec_ProxLiquidacion Creditos.Int_Corrientes Creditos.Fec_UltPago ~
Creditos.Int_Anticipado Creditos.Fec_UltLiquidacion Creditos.Sdo_Capital ~
Creditos.Int_DifCobro Creditos.Sdo_Proyectado Creditos.Tasa ~
Creditos.Cuo_Pagadas Creditos.Cuota Creditos.Val_Atraso ~
Creditos.Dias_Atraso Creditos.Cuo_Atraso Creditos.Provision ~
Creditos.Fec_Reestructurado 
&Scoped-define DISPLAYED-TABLES Creditos
&Scoped-define FIRST-DISPLAYED-TABLE Creditos
&Scoped-Define DISPLAYED-OBJECTS R_TipCon W_AboInt 
...
DEFINE VARIABLE W_AboInt AS DECIMAL FORMAT ">>>,>>>,>>9":U INITIAL 0 
...
DEFINE FRAME F_Cre
     ...
     Creditos.Fec_ProxLiquidacion AT ROW 3.69 COL 14 COLON-ALIGNED
          ...
          SIZE 11 BY .81
          BGCOLOR 18 FGCOLOR 15 
     Creditos.Int_Corrientes AT ROW 3.69 COL 44 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 12 BY .81
          BGCOLOR 14 FGCOLOR 0 
     W_AboInt AT ROW 3.69 COL 72 COLON-ALIGNED
     Creditos.Fec_UltPago AT ROW 4.5 COL 14 COLON-ALIGNED
          LABEL "Último Pago"
          VIEW-AS FILL-IN 
          SIZE 11 BY .81
          BGCOLOR 18 FGCOLOR 15 
     Creditos.Int_Anticipado AT ROW 4.77 COL 44 COLON-ALIGNED
     ...
     Creditos.Fec_UltLiquidacion AT ROW 5.31 COL 14 COLON-ALIGNED
          ...
          SIZE 11 BY .81
          BGCOLOR 18 FGCOLOR 15 
     Creditos.Sdo_Capital AT ROW 5.85 COL 44 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 12 BY .81
          BGCOLOR 18 FGCOLOR 15 
     ...
     Creditos.Sdo_Proyectado AT ROW 6.92 COL 14 COLON-ALIGNED
          ...
          SIZE 11 BY .81
          BGCOLOR 18 FGCOLOR 15 
     Creditos.Tasa AT ROW 6.92 COL 44 COLON-ALIGNED
          LABEL "Tasa"
          VIEW-AS FILL-IN 
          SIZE 12 BY .81
          BGCOLOR 18 FGCOLOR 15 
...
DO:
    vTime = TIME.
 DO WITH FRAME F_Cre:
   ASSIGN FRAME F_Cre W_AboInt R_TipCon W_NumChe W_NumBan.
...
&Scoped-define SELF-NAME W_AboInt
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W_AboInt Wwin
ON LEAVE OF W_AboInt IN FRAME F_Cre /* Abono a Interés */
DO:
  IF DECIMAL(SELF:SCREEN-VALUE) GT Creditos.INT_Corrientes THEN DO:
    MESSAGE "No se puede abonar mas del Saldo de intereses"
            "corrientes Actual El cual es: $"  Creditos.INT_Corrientes VIEW-AS ALERT-BOX.
    SELF:SCREEN-VALUE = STRING(Creditos.INT_Corrientes).
  END.
END.
...
DEFINE VAR WComentario AS CHARACTER FORMAT "X(30)".
  ...
  ASSIGN Mov_Contable.Agencia        = Taquilla.Agencia
         ...
         Mov_Contable.Comentario     = "Abono a Int.Corriente"
...
FIND CortoLargo WHERE CortoLargo.Agencia        EQ Creditos.Agencia
 ...
 IF AVAILABLE(CortoLargo) THEN DO:
    ...
    IF AVAILABLE Liqui_Int THEN W_CtaCorCre = Liqui_Int.CtaDB_LiqAso.
    IF W_CtaCorCre EQ "" THEN DO:
       MESSAGE "La cuenta para el pago de intereses no esta configurada" SKIP
...
------------------------------------------------------------------------------*/
  ...
  IF AVAILABLE Creditos THEN 
    DISPLAY Creditos.Fec_Desembolso Creditos.Fec_Pago Creditos.Fec_ProxLiquidacion 
          Creditos.Int_Corrientes Creditos.Fec_UltPago Creditos.Int_Anticipado 
          Creditos.Fec_UltLiquidacion Creditos.Sdo_Capital Creditos.Int_DifCobro 
          Creditos.Sdo_Proyectado Creditos.Tasa Creditos.Cuo_Pagadas 
          Creditos.Cuota Creditos.Val_Atraso Creditos.Dias_Atraso 
          Creditos.Cuo_Atraso Creditos.Provision Creditos.Fec_Reestructurado 
      WITH FRAME F_Cre IN WINDOW Wwin.
  ENABLE RECT-296 RECT-297 R_TipCon W_AboInt Btn_Grabar Btn_Salir 
      WITH FRAME F_Cre IN WINDOW Wwin.
...
------------------------------------------------------------------------------*/
   ...
   ASSIGN Taquilla.Autorizo         = T_Autorizo
          ...
          Taquilla.Descripcion      = "Abono a Int.Corrientes".
   RELEASE Taquilla.
END PROCEDURE.
...
IF R_TipCon EQ 2 THEN
   ASSIGN W_ValChe = W_AboInt W_ValEfe = 0.
ELSE ASSIGN W_ValChe = 0 W_ValEfe = W_AboInt.
...
IF Creditos.Agencia EQ W_Agencia THEN
   ...
   IF R_TipCon:SCREEN-VALUE IN FRAME F_Cre EQ "2" THEN 
      RUN Gra_CheTransito(INPUT W_NumBan, INPUT W_NumChe, INPUT Creditos.Cod_Credito,
                           ...
                           INPUT 2,        INPUT W_AboInt,  INPUT W_Canje) NO-ERROR.
...
DO TRANSACTION:
      ...
      ASSIGN Creditos.INT_Corrientes = Creditos.INT_Corrientes - W_AboInt.
