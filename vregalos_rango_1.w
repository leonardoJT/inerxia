...
&Scoped-Define ENABLED-FIELDS RowObject.agencia RowObject.edad_inicial ~
RowObject.edad_final RowObject.fecha_inicial RowObject.fecha_final ~
RowObject.usuario 
&Scoped-define ENABLED-TABLES RowObject
&Scoped-define FIRST-ENABLED-TABLE RowObject
&Scoped-Define ENABLED-OBJECTS RECT-1 RECT-2 
&Scoped-Define DISPLAYED-FIELDS RowObject.agencia RowObject.edad_inicial ~
RowObject.edad_final RowObject.fecha_inicial RowObject.fecha_final ~
RowObject.usuario RowObject.FUsuario 
...
DEFINE FRAME F-Main
     ...
     RowObject.agencia AT ROW 5.58 COL 17 COLON-ALIGNED HELP
          "Código de la Agenica" WIDGET-ID 26
  ...
  CASE currentPage: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN constructObject (
             ...
             OUTPUT h_dynselect ).
       RUN repositionObject IN h_dynselect ( 7.19 , 19.00 ) NO-ERROR.
       ...
       RUN adjustTabOrder ( h_dynselect ,
             RowObject.agencia:HANDLE IN FRAME F-Main , 'AFTER':U ).
    END. /* Page 0 */
