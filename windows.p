...
PROCEDURE GetMenuItemCount EXTERNAL {&USER} :
  DEFINE INPUT  PARAMETER hMenu    AS  {&INT}.
  DEFINE RETURN PARAMETER iCount   AS  {&INT}.
END PROCEDURE.
...
&ELSE
  ...
  PROCEDURE GetUserName{&A} :
    ...
    DEFINE OUTPUT       PARAMETER ReturnValue AS LOG.
    ASSIGN lpBuffer = ""
           ReturnValue = 1.
  END PROCEDURE.
&ENDIF
...
PROCEDURE OpenPrinter{&A} EXTERNAL "winspool.drv":
...
PROCEDURE RegQueryValueExA EXTERNAL "advapi32.dll":
  DEFINE INPUT        PARAMETER hkey         AS LONG.
